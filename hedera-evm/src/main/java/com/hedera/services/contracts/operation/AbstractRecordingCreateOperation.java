...
//
//	protected static final OperationResult INVALID_RESPONSE = new OperationResult(
...
//	}
//
//	static OperationResult haltWith(final OptionalLong optionalCost, final ExceptionalHaltReason reason) {
//		return new OperationResult(optionalCost, Optional.of(reason));
//	}
//
