...
class HederaEvmTransactionProcessingResultTest {
    ...
    private final Address logger = Address.fromHexString("fe3b557e8fb62b89f4916b721be55ceb828dbd73");
    ...
    private final Log log =
            new Log(logger, Bytes.fromHexString("0x0102"), List.of(logTopic, logTopic, logTopic, logTopic));

    private final Address recipient = Address.fromHexString("0x000000000000000000000000000000000000077e");

    @Test
    void assertCorrectDataOnSuccessfulTransaction() {
        var log = new Log(logger, Bytes.fromHexString("0x0102"), List.of(logTopic, logTopic, logTopic, logTopic));
        final var logList = List.of(log);

        var result = HederaEvmTransactionProcessingResult.successful(
    ...
    void assertCorrectDataOnFailedTransaction() {
        ...
        var result = HederaEvmTransactionProcessingResult.failed(
