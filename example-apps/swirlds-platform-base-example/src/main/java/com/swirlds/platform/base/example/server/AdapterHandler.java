...
public class AdapterHandler<T> implements HttpHandlerDefinition {
    private static final Logger logger = LogManager.getLogger(AdapterHandler.class.getName());
    private @NonNull final BaseContext context;
    ...
    public AdapterHandler(
            final @NonNull String path, final @NonNull BaseContext context, CrudService<T> delegatedService) {
