...
dependencies {
    ...
    jmhImplementation("com.swirlds:swirlds-common:0.19.0")
    jmhImplementation("com.swirlds:swirlds-merkle:0.19.0")
    jmhImplementation("com.swirlds:swirlds-virtualmap:0.19.0")
    jmhImplementation("com.swirlds:swirlds-jasperdb:0.19.0")
    jmhImplementation("com.swirlds:swirlds-logging:0.19.0")
