...
//				extractSpecsFromSuiteForEth(ContractTraceabilitySuite::new)
	...
	Collection<DynamicContainer> crypto() {
		return List.of(
//				extractSpecsFromSuite(AutoAccountCreationSuite::new), // TODO Fails BUT SHOULD PASS
//				extractSpecsFromSuite(AutoAccountUpdateSuite::new), // TODO Fails BUT SHOULD PASS
...
//				extractSpecsFromSuite(DeleteFailuresSpec::new),
	...
	// TODO MISSING: NewOpInConstructorSpecs, ChildStorageSpecs, BigArraySpec, SmartContractInlineAssemblySpec, OCTokenSpec, SmartContractFailFirstSpec, SmartContractSelfDestructSpec, DeprecatedContractKeySpecs
