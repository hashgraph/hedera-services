...
contract TokenCreateMixedScenarios is FungibleTokenCreate {
    ...
    function createTokenAndMint(uint64 amountToMint) external {
        address createdToken = super.createTokenWithDefaultKeys(100, 5);
    ...
    function createTokenAndMintAndTransfer(uint64 amountToMint, address receiver) external {
        address createdToken = super.createTokenWithDefaultKeys(200, 5);
