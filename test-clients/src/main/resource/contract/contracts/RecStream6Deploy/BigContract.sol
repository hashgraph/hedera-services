...
/// It is non-normative.
contract BigContract is ExpiryHelper {
  ...
  // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees4(
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees5(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees6(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees7(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees8(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
  ...
  // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees9(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees10(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
        ...
        createdTokenAddress = token;
          ...
          // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees11(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees12(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
        ...
        createdTokenAddress = token;
          ...
          // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees13(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees14(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees15(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees16(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees17(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees18(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees19(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
      ...
      // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees20(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees21(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees22(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees23(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees24(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees25(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees26(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees27(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees28(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees29(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees30(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees31(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees32(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees33(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees34(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
     ...
     // create NFT with royalty fees, contract has the mint and admin key
    function createNonFungibleTokenWithCustomFees35(
        address contractIdKey,
        address feeCollectorAndTreasury,
        address existingTokenAddress,
        address autoRenewAccount,
