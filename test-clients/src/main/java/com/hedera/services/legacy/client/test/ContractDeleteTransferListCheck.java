...
public class ContractDeleteTransferListCheck extends ClientBaseThread {
	...
	public ContractDeleteTransferListCheck(String host, int port, long nodeAccountNumber, boolean useSigMap,
	...
	void demo() throws Exception {
		try {
			...
			try {
				...
				TransactionID txID = createContractOnly(genesisAccount, contractFileId, null, accountDuration, adminKey,
						3000000L);
