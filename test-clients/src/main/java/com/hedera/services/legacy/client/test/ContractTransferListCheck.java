 ...
 */
public class ContractTransferListCheck extends ContractCall {

	private static final Logger log = LogManager.getLogger(ContractTransferListCheck.class);
	 ...
	 */
	public ContractTransferListCheck(String host, int port, long nodeAccountNumber, boolean useSigMap, String[] args,
			int index) {
