...
public class StressLargeData {
	...
	private static final String SCL_WASTEARRAY_ABI = "{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\"," +
			"\"name\":\"_index\",\"type\":\"uint256\"},{\"internalType\":\"uint256[]\",\"name\":\"_array\"," +
			"\"type\":\"uint256[]\"}],\"name\":\"wasteArray\",\"outputs\":[],\"payable\":false," +
