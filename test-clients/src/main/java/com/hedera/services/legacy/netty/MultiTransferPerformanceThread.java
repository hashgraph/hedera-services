...
public class MultiTransferPerformanceThread {

	private String host;
	private int port;
	private static long nodeAccount;
	private static final Logger log = LogManager.getLogger(MultiTransferPerformanceThread.class);
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numThreads; i++) {
			MultiAccountTransferSeqThread perf1 = new MultiAccountTransferSeqThread(port, host, numTransfer,
