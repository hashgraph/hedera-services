...
public class FileFeeTests extends BaseFeeTests {
	...
	public void fileDeleteFeeTest() throws Throwable {
		...
		Transaction FileDeleteRequest = RequestBuilder.getFileDeleteBuilder(payerID.getAccountNum(), 0l, 0l,
				...
				timestamp, CryptoServiceTest.transactionDuration, true, "FileDelete", CryptoServiceTest.signatures,
				fid);
		...
		Transaction txSigned = TransactionSigner.signTransactionComplex(FileDeleteRequest, keys,
				TestHelperComplex.pubKey2privKeyMap);
	...
	public void fileAppendFeeTest() throws Throwable {
		...
		keys.add(payerKey);
		keys.add(waclKey);
		Transaction txSigned = TransactionSigner.signTransactionComplex(fileAppendRequest, keys,
				TestHelperComplex.pubKey2privKeyMap);
