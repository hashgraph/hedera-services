...
public class ERC20Contract extends ClientBaseThread {
	...
	private static final String TOKEN_ERC20_CONSTRUCTOR_ABI = "{\"inputs\":[{\"name\":\"initialSupply\"," +
			"\"type\":\"uint256\"},{\"name\":\"tokenName\",\"type\":\"string\"},{\"name\":\"tokenSymbol\"," +
			"\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}";
	private static final String BALANCE_OF_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}]," +
	...
	private static final String DECIMALS_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"decimals\"," +
			"\"outputs\":[{\"name\":\"\",\"type\":\"uint8\"}],\"payable\":false,\"stateMutability\":\"view\"," +
			"\"type\":\"function\"}";
	private static final String TRANSFER_ABI = "{\"constant\":false,\"inputs\":[{\"name\":\"_to\"," +
			"\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"transfer\",\"outputs\":[]," +
			"\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";
	private static final String APPROVE_ABI = "{\"constant\":false,\"inputs\":[{\"name\":\"_spender\"," +
			"\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"approve\"," +
			"\"outputs\":[{\"name\":\"success\",\"type\":\"bool\"}],\"payable\":false," +
			"\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";
	private static final String TRANSFER_FROM_ABI = "{\"constant\":false,\"inputs\":[{\"name\":\"_from\"," +
			...
			"\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";
	private static final String SYMBOL_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"symbol\"," +
	...
	public long decimals(ContractID contractAddress, AccountID payer) throws Exception {
		...
		byte[] valueOfDecimals = callContractLocalGetResult(payer, contractAddress, dataEncodeDecimals,
				GAS_REQUIRED_GET,
				localCallGas);
	...
	private boolean checkBalances(ContractID contractAddress, Map<AccountID, String> tokenOwners,
		...
		for (AccountID currentTokenOwner : balancePerOwner.keySet()) {
			...
			log.info("accountNum {} has a balance of {} expected {}", currentTokenOwner.getAccountNum(), currBalance,
					expectedBalance);
	...
	public long balanceOf(ContractID contractAddress, String accountAdddressEthFormat,
		...
		byte[] valueOfBalance = callContractLocalGetResult(payer, contractAddress, dataEncodeBalanceOF,
				GAS_REQUIRED_GET,
				localCallGas);
	...
	public String symbol(ContractID contractAddress, AccountID payer) throws Exception {
		...
		byte[] valueOfSymbol = callContractLocalGetResult(payer, contractAddress, dataEncodeSymbol, GAS_REQUIRED_GET,
				localCallGas);
		//decode value from results
