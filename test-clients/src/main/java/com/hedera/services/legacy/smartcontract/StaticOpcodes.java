...
public class StaticOpcodes {
  ...
  private static final String SCZ_ADD_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runAdd\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}";
  private static final String SCZ_BLOCKHASH_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_block\",\"type\":\"uint256\"}],\"name\":\"runBlockhash\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
  private static final String SCZ_COINBASE_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runCoinbase\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
  private static final String SCZ_NUMBER_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runNumber\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
  private static final String SCZ_DIFFICULTY_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runDifficulty\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
  private static final String SCZ_GASLIMIT_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runGaslimit\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
