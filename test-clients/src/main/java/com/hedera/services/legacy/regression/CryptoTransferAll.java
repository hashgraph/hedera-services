	...
	private Transaction createQueryHeaderTransfer(AccountID payer, long transferAmt)
	  ...
	  public void demo() throws Exception {
	    ...
	    log.info("Account created successfully");
			...
			log.info("Don't want Account: " + fromTransfer.getAccountID().getAccountNum() + ", amount: " + fromTransfer.getAmount());
			log.info("Don't want Account: " + toTransfer.getAccountID().getAccountNum() + ", amount: " + toTransfer.getAmount());
