...
public class ContractCallLocal extends ClientBaseThread {
	...
	private final static Logger log = LogManager.getLogger(ContractCallLocal.class);
	...
	public ContractCallLocal(String host, int port, long nodeAccountNumber, boolean useSigMap, String[] args,
			int index) {
		...
		try {
			...
			for (int iteration = 1; iteration <= ITERATIONS; iteration++) {
				...
				try {
					...
					Pair<List<Transaction>, ContractCallLocalResponse> callResult = callContractLocal2(genesisAccount,
