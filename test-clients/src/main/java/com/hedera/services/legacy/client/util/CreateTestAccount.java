...
public class CreateTestAccount extends BaseClient {
	...
	public static TransactionResponse createAccount(CryptoServiceGrpc.CryptoServiceBlockingStub stub,
	...
	public static SmartContractServiceGrpc.SmartContractServiceBlockingStub createSmartContractStub_local(String host,
			int port) throws Exception {
