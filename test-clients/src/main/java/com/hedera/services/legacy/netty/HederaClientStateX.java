...
public class HederaClientStateX implements Serializable {
    ...
    public HederaClientStateX (AccountID accID, long accountBalance, KeyPair keyPair , Timestamp createdTs, byte[] originalTxBytes)
    {
    ...
    public String toString(){
        ...
        }catch(Exception sbx){ sb.append("Invalid Content Err");}
