...
public class BaseClient extends SmartContractServiceTest {
	...
	public SmartContractServiceGrpc.SmartContractServiceBlockingStub createSmartContractStub(String host,
	 ...
	 * @param nodeAccount
	 * @param initBal
	 * @param retrieveTxReceipt
	 * 		whether or not to get receipt
	...
	public AccountID createAccountWithSingelKey(AccountID payerID, AccountID nodeID,
