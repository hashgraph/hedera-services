...
public class NodeCreateAndTransfer {
	...
	public void createAccountsAndTransfer(CryptoServiceGrpc.CryptoServiceBlockingStub stub,
		...
		//get the Start up Account details - This is the Genesis Account and will be used for Accounts creation and
		...
		// create the transaction (here node account will create and transfer , so pater account will be same as
		// nodeAccount)
...
//		  Transaction signTransaction = TransactionSigner.signTransaction(transaction, Collections.singletonList
//		  (nodePrivateKey));
