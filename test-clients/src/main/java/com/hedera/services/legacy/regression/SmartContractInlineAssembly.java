...
public class SmartContractInlineAssembly {
	...
	private static final String SC_GET_CODE_SIZE_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_addr\"," +
			"\"type\":\"address\"}],\"name\":\"getCodeSize\",\"outputs\":[{\"name\":\"_size\",\"type\":\"uint256\"}]," +
			"\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
	private static final String SC_GET_STORE_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"getStore\"," +
			"\"outputs\":[{\"name\":\"\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"view\"," +
			"\"type\":\"function\"}";
	private static final String SC_SET_STORE_ABI = "{\"constant\":false,\"inputs\":[{\"name\":\"inVal\"," +
			"\"type\":\"bytes32\"}],\"name\":\"setStore\",\"outputs\":[],\"payable\":false," +
