...
public class CreateAccountWithParams {
	...
	public static void main(
			String args[]) throws InterruptedException, IOException, URISyntaxException,
			InvalidNodeTransactionPrecheckCode, DecoderException {
	...
	public void demo() throws InterruptedException, IOException, URISyntaxException, InvalidNodeTransactionPrecheckCode
			, DecoderException {
	...
	public Transaction createAccountWallet(AccountID payerAccount, AccountID nodeAccount, String pubKeyStr,
			long initialBalance) throws DecoderException {
