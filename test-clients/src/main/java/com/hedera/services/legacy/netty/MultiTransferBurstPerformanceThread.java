...
public class MultiTransferBurstPerformanceThread {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numThreads; i++) {
			MultiAccountBurstTransferSeqThread perf1 = new MultiAccountBurstTransferSeqThread(port, host, numTransfer,
					retrieveTxReceipt, retrieveRecords, nodeAccount, tpsDesired, numAccountsIterations);
			perf1.start();
		}
