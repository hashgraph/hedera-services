...
//
	...
	public static Transaction createAccountValidateMemo(AccountID payerAccount, AccountID nodeAccount,
		...
		long transactionFee = 100l;
		boolean generateRecord = true;
		String memo = "Create Account Test Create Account Test Create Account Test Create Account Test Create Account " +
				"Test Create Account Test Create Account Test Create Account Test Create Account Test Create Account " +
				"Test Create Account Test Create Account Test Create Account Test Create Account Test Create Account " +
