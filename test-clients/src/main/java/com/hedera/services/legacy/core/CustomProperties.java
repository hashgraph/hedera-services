...
public class CustomProperties {
   ...
   *
   * @param file the properties file to be read, if null, customProperties will be empty.
   ...
   *
   * @param name the key of the property to be retrieved
   * @param defaultValue default value to be returned if the named property does not exist
   ...
   *
   * @param name the key of the property to be retrieved
   * @param defaultValue default value to be returned if the named property does not exist or the
   *     value retrieved is not a parsable integer which results in {@link NumberFormatException}
   ...
   * @param name the key of the property to be retrieved
   * @param defaultValue default value to be returned if the named property does not exist or the
   *     value retrieved is not a parsable long which results in {@link NumberFormatException}
