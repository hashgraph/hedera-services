...
/**
 * Test calling an unpayable smart contract method with a value.  Ensure that the
 * value is not charged to the caller.
 *
 * @author peter
 * Adapted 2018-02-11
 */
public class SmartContractInvalidCallWithValue {
  public static final long INITIAL_PAYER_BALANCE = TestHelper.getContractMaxFee() * 10L;
  public static long GAS_COST;
  private static long DAY_SEC = 24 * 60 * 60; // secs in a day
  private final static long CONTRACT_CREATE_SUCCESS_GAS = 250000L;
  private final Logger log = LogManager.getLogger(SmartContractInvalidCallWithValue.class);
  ...
  public static void main(String args[]) throws Exception {
    ...
    for (int i = 0; i < numberOfReps; i++) {
      SmartContractInvalidCallWithValue scFf = new SmartContractInvalidCallWithValue();
      scFf.demo();
    }
  ...
  public void demo() throws Exception {
    ...
    if (crAccount != null) {
      ...
      creatingAccountBalance = Utilities.getAccountBalance(balanceStub, crAccount,
          genesisAccount, accountKeyPairs.get(genesisAccount), nodeAccount, TestHelper.getContractMaxFee());
      ...
      creatingAccountBalance = Utilities.getAccountBalance(balanceStub, crAccount,
          genesisAccount, accountKeyPairs.get(genesisAccount), nodeAccount, TestHelper.getCryptoMaxFee());
