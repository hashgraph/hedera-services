...
public class DynamicRestartTest extends TestHelperComplex {
	 ...
	 * @throws Throwable
	 */
	public static ResponseCodeEnum freeze(int freezeDuration, int freezeStartTimeOffset, int freezeStartHour,
			int freezeStartMin) throws Throwable {
	...
	private void readGenesisInfo() throws Exception {
		Map<String, List<AccountKeyListObj>> keyFromFile = TestHelper.getKeyFromFile(
				CryptoServiceTest.INITIAL_ACCOUNTS_FILE);
	...
	private static Transaction getSignedTransferTx(AccountID payerAccountID,
		...
		Transaction paymentTx = CryptoServiceTest.getUnSignedTransferTx(payerAccountID, nodeAccountID, fromAccountID,
	...
	public static FileGetInfoResponse.FileInfo createFileAndGetInfo(AccountID payerAccount, AccountID nodeAccount,
			int size, long durationSeconds) throws Throwable {
	...
	public static FileGetInfoResponse.FileInfo getFileInfo(FileID fid) throws Exception {
		...
		Transaction paymentTxSigned = getSignedTransferTx(genesisAccountID, nodeID, genesisAccountID, nodeID,
				TestHelper.getCryptoMaxFee(), "GetFileInfo");
	...
	protected static Response getAccountInfo(AccountID accountID) throws Exception {
		Transaction paymentTxSigned = getSignedTransferTx(genesisAccountID, nodeID, genesisAccountID, nodeID,
				TestHelper.getCryptoMaxFee(), "GetAccountInfo");
	...
	protected static Response getContractInfo(ContractID contractID) throws Exception {
		Transaction paymentTx = getSignedTransferTx(genesisAccountID, nodeID, genesisAccountID, nodeID,
				TestHelper.getContractMaxFee(), "GetContractInfo");
