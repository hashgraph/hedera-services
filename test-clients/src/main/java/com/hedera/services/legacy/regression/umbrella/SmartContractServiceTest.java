...
public class SmartContractServiceTest extends FileServiceTest {
	...
	public ContractInfo getContractInfo(AccountID payerAccount, ContractID contractId,
		...
		Transaction paymentTx = getQueryPaymentSignedWithFee(payerAccount, nodeAccount, "getContractInfo",
				contractInfoCost);
	...
	private long getContractInfoCost(AccountID payerAccount, ContractID contractId,
			AccountID nodeAccount) throws Exception {
	...
	private long getTransactionRecordCost(TransactionID transactionId, AccountID payerAccount,
			AccountID nodeAccount) throws Exception {
	...
	public String getContractByteCode(AccountID payerAccount,
		...
		Transaction paymentTx = getQueryPaymentSignedWithFee(payerAccount, nodeAccount, "getContractByteCode",
				getContractByteCodeCost);
	...
	private long getContractBytecodeCost(AccountID payerAccount, ContractID contractId,
			AccountID nodeAccount) throws Exception {
	...
	private long getTxRecordByContractIDCost(AccountID payerID, ContractID contractId,
			AccountID nodeID) throws Exception {
