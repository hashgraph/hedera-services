...
public class FreezeServiceTest extends TestHelperComplex {
	...
	public void setUp() throws Throwable {
		...
		Transaction transferTx = getSignedTransferTx(
				genesisAccountID, nodeID, genesisAccountID, freezeAccount, 300000,
				"Transfer from 2 to " + freezeAccountID);
	...
	private static Transaction getSignedFreezeTx(Transaction unSignedTransferTx) throws Exception {
		TransactionBody txBody = com.hedera.services.legacy.proto.utils.CommonUtils.extractTransactionBody(
				unSignedTransferTx);
