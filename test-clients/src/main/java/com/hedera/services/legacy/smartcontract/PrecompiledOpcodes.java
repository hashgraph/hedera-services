...
public class PrecompiledOpcodes {
	...
	private static final String SCZ_ADDMOD_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runAddmod\"," +
			"\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\"," +
			"\"type\":\"function\"}";
	private static final String SCZ_MULMOD_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"runMulmod\"," +
			"\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\"," +
			"\"type\":\"function\"}";
	private static final String SCZ_RIPEMD160_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_value\"," +
			"\"type\":\"string\"}],\"name\":\"runRipemd160\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"bytes20\"}]," +
			"\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}";
	private static final String SCZ_SHA256_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_value\"," +
			"\"type\":\"string\"}],\"name\":\"runSha256\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"bytes32\"}]," +
			"\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}";
	private static final String SCZ_SHA3_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_value\"," +
			"\"type\":\"string\"}],\"name\":\"runSha3\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"bytes32\"}]," +
			"\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}";
	private static final String SCZ_KECCAK256_ABI = "{\"constant\":true,\"inputs\":[{\"name\":\"_value\"," +
			"\"type\":\"string\"}],\"name\":\"runKeccak256\",\"outputs\":[{\"name\":\"_resp\",\"type\":\"bytes32\"}]," +
			"\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}";
