...
/**
 * Transfer to contract with no method call making sure that payable fallback function is invoked
 *
 * @author Constantin
 */
public class SmartContractPayReceivable {
  ...
  public static void main(String args[]) throws Exception {
    ...
    for (int i = 0; i < numberOfReps; i++) {
      SmartContractPayReceivable scSs = new SmartContractPayReceivable();
      scSs.demo();
    }
  ...
  public void demo() throws Exception {
    ...
    String fileName = "PayReceivable.bin";
    if (crAccount != null) {
      ...
      if (simpleStorageFileId != null) {
        ...
        for (int i = 0; i < 10; i++) {
          ...
          transferToContract(crAccount, payTestContractId, currValueToDeposit);
          //Thread.sleep(10000);
          ...
          Assert.assertEquals(currentBalanceAfterUpdate,
              currentBalanceBeforeUpdate + currValueToDeposit);
