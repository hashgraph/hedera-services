...
public class SmartContractAggregatedTests {
  ...
  private static final List<LegacySmartContractTest> SCTests =
      List.of(new SmartContractTestBitcarbon());
  ...
  public static void main(String[] args) throws Exception {
    ...
    nodeAccount = RequestBuilder.getAccountIdBuild(nodeAccountNum, 0l, 0l);
