...
public class CryptoTransferSuite extends HapiApiSuite {
    ...
    private HapiApiSpec canUseEip1014AliasesForXfers() {
        ...
        return defaultHapiSpec("CanUseEip1014AliasesForXfers")
                .given(
                        ...
                        contractCreate(contract).adminKey(multiKey).payingWith(GENESIS),
        ...
        return defaultHapiSpec("AllowanceTransfersWithComplexTransfersWork")
                ...
                .when(
                        ...
                        cryptoTransfer(
                                ...
                                movingUnique(nonFungibleToken, 3, 4)
                                        .between(TOKEN_TREASURY, otherOwner)),
                        cryptoApproveAllowance()
                                .payingWith(owner)
                                .addCryptoAllowance(owner, spender, 10 * ONE_HBAR)
                                .addTokenAllowance(owner, fungibleToken, spender, 500)
                                .addNftAllowance(
                                        owner, nonFungibleToken, spender, false, List.of(1L, 2L))
                                .fee(ONE_HUNDRED_HBARS),
                        cryptoApproveAllowance()
                                ...
                                .addNftAllowance(
                                        otherOwner, nonFungibleToken, spender, true, List.of(3L))
                                .fee(ONE_HUNDRED_HBARS))
                .then(
                        cryptoTransfer(
                                        movingHbar(ONE_HBAR).between(spender, receiver),
                                        movingHbar(ONE_HBAR)
                                                .between(otherReceiver, anotherReceiver),
                                        ...
                                        movingHbarWithAllowance(ONE_HBAR)
                                                .between(otherOwner, receiver),
                                        moving(50, fungibleToken)
                                                .between(receiver, anotherReceiver),
                                        ...
                                        movingWithAllowance(10, fungibleToken)
                                                .between(otherOwner, receiver),
                                        movingWithAllowance(5, fungibleToken)
                                                .between(otherOwner, owner),
                                        movingUnique(nonFungibleToken, 1L).between(owner, receiver),
                                        movingUniqueWithAllowance(nonFungibleToken, 2L)
                                                .between(owner, receiver),
                                        movingUniqueWithAllowance(nonFungibleToken, 4L)
                                                .between(otherOwner, receiver),
                                        movingUniqueWithAllowance(nonFungibleToken, 3L)
                                                .between(otherOwner, receiver))
                                .payingWith(spender)
                        ...
                        getAccountDetails(otherOwner)
                                ...
                                .has(
                                        AccountDetailsAsserts.accountWith()
                                                ...
                                                .tokenAllowancesContaining(
                                                        fungibleToken, spender, 85)
                                                .nftApprovedAllowancesContaining(
                                                        nonFungibleToken, spender)),
    ...
    private HapiApiSpec allowanceTransfersWorkAsExpected() {
        return defaultHapiSpec("AllowanceTransfersWorkAsExpected")
                ...
                .when(
                        ...
                        tokenAssociate(
                                receiver, fungibleToken, nonFungibleToken, tokenWithCustomFee),
                        grantTokenKyc(fungibleToken, owner),
                        grantTokenKyc(fungibleToken, receiver),
                        cryptoTransfer(
                                moving(1000, fungibleToken).between(TOKEN_TREASURY, owner),
                                moving(15, tokenWithCustomFee).between(TOKEN_TREASURY, owner),
                                movingUnique(nonFungibleToken, 1L, 2L, 3L, 4L, 5L, 6L)
                ...
                .then(
                        cryptoTransfer(
                                        movingWithAllowance(10, tokenWithCustomFee)
                                                .between(owner, receiver))
                                .payingWith(spender)
                                .signedBy(spender)
                                .fee(ONE_HBAR)
                        ...
                        cryptoTransfer(
                                        movingWithAllowance(100, fungibleToken)
                                                .between(owner, owner))
                                .payingWith(spender)
                                .signedBy(spender)
                        ...
                        cryptoTransfer(
                                        movingUniqueWithAllowance(nonFungibleToken, 3)
                                                .between(owner, otherReceiver))
                                .payingWith(spender)
                                .signedBy(spender),
                        cryptoTransfer(
                                        movingWithAllowance(100, fungibleToken)
                        ...
                        cryptoTransfer(
                                        movingUniqueWithAllowance(nonFungibleToken, 4)
                                                .between(owner, otherReceiver))
                                .payingWith(spender)
                                .signedBy(spender)
                                .hasKnownStatus(INVALID_SIGNATURE),
                        ...
                        cryptoTransfer(
                                        movingUniqueWithAllowance(nonFungibleToken, 6)
                                                .between(owner, receiver))
                                .payingWith(spender)
                                .signedBy(spender)
                        ...
                        cryptoTransfer(
                                        movingWithAllowance(1100, fungibleToken)
                                                .between(owner, otherReceiver))
                                .payingWith(spender)
                                .signedBy(spender, otherReceiver)
                        ...
                        cryptoTransfer(
                                        movingWithAllowance(50, fungibleToken)
                                                .between(owner, receiver),
                        ...
                        cryptoTransfer(
                                        movingWithAllowance(50, fungibleToken)
                                                .between(owner, receiver),
                                        movingUniqueWithAllowance(nonFungibleToken, 5)
                                                .between(owner, receiver))
                                .payingWith(spender)
                                .signedBy(spender)
                                .hasKnownStatus(SPENDER_DOES_NOT_HAVE_ALLOWANCE),
                        ...
                        cryptoTransfer(
                                        movingUniqueWithAllowance(nonFungibleToken, 2L)
                                                .between(owner, receiver),
                                        movingWithAllowance(1451, fungibleToken)
                                                .between(owner, receiver))
                                .payingWith(spender)
                                .signedBy(spender)
                                .hasKnownStatus(AMOUNT_EXCEEDS_ALLOWANCE),
    ...
    private HapiApiSpec checksExpectedDecimalsForFungibleTokenTransferList() {
        ...
        return defaultHapiSpec("checksExpectedDecimalsForFungibleTokenTransferList")
                .given(
                        ...
                        cryptoTransfer(moving(100, fungibleType).between(TOKEN_TREASURY, party))
                                .via("initialXfer"),
                        getTxnRecord("initialXfer").hasNewTokenAssociation(fungibleType, party))
                .when(
                        getAccountInfo(party).savingSnapshot(party),
                        cryptoTransfer(
                                        movingWithDecimals(10, fungibleType, 4)
                                ...
                                .via("failedTxn"),
                        cryptoTransfer(
                                        movingWithDecimals(20, fungibleType, 2)
                                                .betweenWithDecimals(TOKEN_TREASURY, party))
                                .signedBy(DEFAULT_PAYER, party, TOKEN_TREASURY)
        ...
        return defaultHapiSpec("HbarAndFungibleSelfTransfersRejectedBothInPrecheckAndHandle")
                .given(
                        ...
                        tokenCreate(fungibleType)
                                ...
                                .initialSupply(1234),
                        cryptoTransfer(
                                moving(100, fungibleType).between(TOKEN_TREASURY, owningParty)))
                .when(
                        getAccountInfo(owningParty).savingSnapshot(owningParty),
                                ...
                                (spec, opLog) -> {
                                    ...
                                    opLog.info(
                                            "\n"
                                                ...
                                                + "1 tokens involved,\n"
                                                + "  2 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
                                                + "  3 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
                                                + "  4 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
                                                + "  5 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
                                                + "  6 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
                                                + "2 tokens involved,\n"
                                                + "  4 account adjustments: {} tb, ${} (~{}x pure"
                                                + " crypto)\n"
    ...
    private HapiApiSpec transferWithMissingAccountGetsInvalidAccountId() {
        return defaultHapiSpec("TransferWithMissingAccount")
                .given(cryptoCreate("payeeSigReq").receiverSigRequired(true))
                .when(
                        cryptoTransfer(tinyBarsFromTo("1.2.3", "payeeSigReq", 1_000L))
