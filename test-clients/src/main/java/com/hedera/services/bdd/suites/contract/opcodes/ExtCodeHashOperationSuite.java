...
public class ExtCodeHashOperationSuite extends HapiApiSuite {
    ...
    HapiApiSpec verifiesExistence() {
        ...
        final var EXPECTED_ACCOUNT_HASH =
                ...
                .then(
                        ...
                        withOpContext(
                                (spec, opLog) -> {
                                    ...
                                    final var call =
                                            contractCall(contract, "hashOf", accountSolidityAddress)
                                                    .via("callRecord");
                                    ...
                                    final var contractCodeHash =
                                            contractCallLocal(contract, "hashOf", contractAddress)
                                    ...
                                    Assertions.assertArrayEquals(
                                            EXPECTED_ACCOUNT_HASH.toByteArray(), accountCodeHash);
                                    Assertions.assertArrayEquals(
