    ...
    registerProvider(
        (spec, o) -> {
          ...
          Assertions.assertEquals(
              spec.registry().getContractId(contract), actual.getContractID(), "Bad contract id!");
          Assertions.assertEquals(
              TxnUtils.equivAccount(spec.registry().getContractId(contract)),
              actual.getAccountID(),
              "Bad account id!");
          Assertions.assertEquals(
              spec.registry().getKey(contract), actual.getAdminKey(), "Bad admin key!");
          ...
          Assertions.assertEquals(otherExpectedInfo.getMemo(), actual.getMemo(), "Bad memo!");
        });
    return this;
  }
  ...
  public ContractInfoAsserts propertiesInheritedFrom(String contract) {
    registerProvider(
        (spec, o) -> {
          ...
          Assertions.assertEquals(
              expected.getExpirationTime(), actual.getExpirationTime(), "Bad expiry time!");
          Assertions.assertEquals(
              expected.getAutoRenewPeriod(), actual.getAutoRenewPeriod(), "Bad auto renew period!");
          Assertions.assertEquals(expected.getAdminKey(), actual.getAdminKey(), "Bad admin key!");
          Assertions.assertEquals(expected.getMemo(), actual.getMemo(), "Bad memo!");
        });
    return this;
  }
