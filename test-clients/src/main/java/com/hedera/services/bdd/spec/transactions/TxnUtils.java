...
public class TxnUtils {
	...
	public static TransactionID asTransactionID(final HapiApiSpec spec, final Optional<String> payer) {
		final var payerID = spec.registry().getAccountID(payer.orElse(spec.setup().defaultPayerName()));
	...
	public static Timestamp currExpiry(final String file, final HapiApiSpec spec, final String payer)
			throws Throwable {
	...
	public static Timestamp currContractExpiry(final String contract, final HapiApiSpec spec) throws Throwable {
