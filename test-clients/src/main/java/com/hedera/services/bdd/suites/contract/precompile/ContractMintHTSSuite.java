...
public class ContractMintHTSSuite extends HapiApiSuite {
    ...
    private HapiApiSpec helloWorldNftMint() {
        ...
        return defaultHapiSpec("HelloWorldNftMint")
                ...
                .when(
                        ...
                        contractCall(HELLO_WORLD_MINT, "mint").via(secondMintTxn).gas(GAS_TO_OFFER),
                        getTxnRecord(secondMintTxn).andAllChildRecords().logged())
                .then(
        ...
        return defaultHapiSpec("NonFungibleMint")
                ...
                .then(
                        ...
                        getAccountBalance(TOKEN_TREASURY)
                                .hasTokenBalance(nonFungibleToken, totalSupply),
                        childRecordsCheck(
                                firstMintTxn,
                                SUCCESS,
                                recordWith()
                                                                ...
                                                                DELEGATE_CONTRACT_KEY_SHAPE
                                                                        .signedWith(
                                                                                sigs(
                                                                                        ON,
                                                                                        NESTED_MINT_CONTRACT))),
                                                cryptoUpdate(TOKEN_TREASURY)
                                                        .key(DELEGATE_CONTRACT_KEY_NAME),
    ...
    private HapiApiSpec rollbackOnFailedMintAfterFungibleTransfer() {
        ...
        return defaultHapiSpec("RollbackOnFailedMintAfterFungibleTransfer")
                .given(
                        ...
                        cryptoTransfer(
                                moving(200, fungibleToken).between(TOKEN_TREASURY, theAccount)),
    ...
    private HapiApiSpec fungibleTokenMintFailure() {
        ...
        return defaultHapiSpec("FungibleMintFailure")
                ...
                .when(
                        ...
                        sourcing(
                                () ->
                                        contractCreate(theContract, fungibleNum.get())
                                ...
                                (spec, opLog) -> {
                                    ...
                                    final var baselineGas =
                                            baselineCostLookup
                                                    ...
                                                    .getGasUsed();
                                    expectedInsufficientGas.set(
                                            baselineGas - expectedPrecompileGas);
                                }),
                        sourcing(
                                () ->
                                        contractCall(theContract, "mintFungibleToken", amount)
    ...
    @NotNull
    private CustomSpecAssert assertTxnRecordHasNoTraceabilityEnrichedContractFnResult(
        ...
        return assertionsHold(
                (spec, log) -> {
                    ...
                    final var contractCallResult = record.getContractCallResult();
                    assertEquals(
                            0L,
