        ...
        return defaultHapiSpec("canAutoCreateWithHTSTransfers")
                ...
                .when(
                        ...
                        cryptoTransfer(
                                        ...
                                        moving(10, B_TOKEN).between(treasury, alias1))
                                .via(TRANSFER_TXN)
                                .payingWith(civilian)
                                .signedBy(civilian, autoCreateSponsor, alias1, treasury)
                                .logged())
                .then(
