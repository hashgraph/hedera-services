                        ...
                        sourcing(
                                () ->
                                        contractCall(
                                                        ercContract,
                                                        "ownerOf",
                                                        convertAliasToAddress(nftAddress.get()),
                                ...
                                () ->
                                        contractCallWithFunctionAbi(
                                                        ...
                                                        getABIFor(
                                                                ...
                                                                "mintNftViaDelegate",
                                                                userContract),
                                                        convertAliasToAddress(hexedNftType.get()),
                                ...
                                () ->
                                        contractCallWithFunctionAbi(
                                                        ...
                                                        getABIFor(
                                                                ...
                                                                "relinquishFundsTo",
                                                                donorContract),
                                                        convertAliasToAddress(donorAliasAddr.get()))
                        ...
                        sourcing(
                                () ->
                                        contractCallLocal(
                                                        contract,
                                                        CALL_RETURNER,
                                                        convertAliasToAddress(mirrorAddr.get()))
                        ...
                        sourcing(
                                () ->
                                        contractCallLocal(
                                                        contract,
                                                        CALL_RETURNER,
                                                        convertAliasToAddress(aliasAddr.get()))
                                                .payingWith(GENESIS)
                                                .exposingTypedResultsTo(
                                                        results -> {
                                                            LOG.info(
