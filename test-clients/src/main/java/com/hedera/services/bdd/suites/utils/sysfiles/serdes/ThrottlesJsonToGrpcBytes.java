...
public class ThrottlesJsonToGrpcBytes implements SysFileSerde<String> {
    ...
    public String fromRawFile(byte[] bytes) {
        try {
            ...
            var pojo =
                    com.hedera.services.hapi.utils.sysfiles.domain.throttling.ThrottleDefinitions.fromProto(
                            defs);
    ...
    private com.hedera.services.hapi.utils.sysfiles.domain.throttling.ThrottleDefinitions toPojo(
            String styledFile) {
        try {
            return mapper.readValue(
                    styledFile,
                    com.hedera.services.hapi.utils.sysfiles.domain.throttling.ThrottleDefinitions.class);
        } catch (Exception e) {
