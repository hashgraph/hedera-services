...
public class LoadTest extends HapiApiSuite {
  ...
  public static RunLoadTest defaultLoadTest(
    ...
    return runLoadTest(opSource)
        ...
        .setTotalTestTopics(
            totalTestTopics.isPresent() ? totalTestTopics::getAsInt : settings::getTotalTopics)
        .setTotalTestTokens(
            totalTestTokens.isPresent() ? totalTestTokens::getAsInt : settings::getTotalTokens)
        ...
        .setTotalTestTopics(
            totalTestTopics.isPresent() ? totalTestTopics::getAsInt : settings::getTotalTopics)
        .setTotalScheduled(
            totalScheduled.isPresent() ? totalScheduled::getAsInt : settings::getTotalScheduled)
