...
public class EncryptionUtils {
   ...
   *
   * @param ed25519PrivateKey given Ed25519 private key
   * @return a key pair built from the given private key
   */
  public static KeyPair buildKeyPairFromMainnetPrivateKey(
   ...
   *
   * @param priKeyEncHex private key string in its encoded hex format
  ...
  private static KeyPair buildKeyPairFromMainnetPriKeyEncHex(final String priKeyEncHex) {
    ...
    publicKey = new EdDSAPublicKey(new EdDSAPublicKeySpec(privateKey.getAbyte(), spec));
