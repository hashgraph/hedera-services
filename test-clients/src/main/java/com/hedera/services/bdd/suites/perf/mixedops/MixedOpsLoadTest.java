  ...
  protected HapiApiSpec runMixedOps() {
    ...
    Supplier<HapiSpecOperation[]> mixedOpsBurst =
        () ->
            new HapiSpecOperation[] {
              ...
              r.nextInt(100) > 5
                  ? cryptoTransfer(
                          moving(1, token + r.nextInt(NUM_SUBMISSIONS)).between(sender, receiver))
                      .payingWith(sender)
                      .signedBy(GENESIS)
    ...
    return defaultHapiSpec("RunMixedOps")
        .given(
            ...
            cryptoCreate("treasury").hasRetryPrecheckFrom(permissiblePrechecks).key(GENESIS))
        .when(
            ...
            cryptoCreate(sender)
                ...
                .rechargeWindow(3)
                .hasRetryPrecheckFrom(permissiblePrechecks),
            cryptoCreate(receiver).hasRetryPrecheckFrom(permissiblePrechecks).key(GENESIS),
