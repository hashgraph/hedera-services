...
public class TopicCreateSuite extends HapiApiSuite {
  ...
  private HapiApiSpec memoValidations() {
    ...
    return defaultHapiSpec("MemoValidations")
        ...
        .when()
        .then(
            createTopic("testTopic").topicMemo(longMemo).hasKnownStatus(MEMO_TOO_LONG),
  ...
  private HapiApiSpec noAutoRenewPeriod() {
    return defaultHapiSpec("noAutoRenewPeriod")
        ...
        .when()
        .then(
            createTopic("testTopic").clearAutoRenewPeriod().hasKnownStatus(INVALID_RENEWAL_PERIOD));
  }
  ...
  private HapiApiSpec signingRequirementsEnforced() {
    ...
    return defaultHapiSpec("SigningRequirementsEnforced")
        ...
        .then(
            ...
            getTopicInfo("explicitAdminKeyNoAutoRenewAccount").hasAdminKey("adminKey").logged(),
