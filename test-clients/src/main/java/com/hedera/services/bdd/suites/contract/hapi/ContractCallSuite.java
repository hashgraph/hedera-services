...
public class ContractCallSuite extends HapiApiSuite {
                ...
                .when(
                        assertionsHold(
                                (spec, ctxLog) -> {
                                    ...
                                    final var subop5 =
                                            contractCallLocal(
                                                            contract, "balanceOf", issuerEthAddress)
                                                    .gas(250_000L)
                                    ...
                                    // long decimals = getLongValueFromRegistry(spec, "decimals",
                                    // function);
                                    ...
                                    final var subop9 =
                                            contractCallLocal(
                                                            contract, "balanceOf", aliceEthAddress)
                                                    .gas(250_000L)
                                                    .saveResultTo("aliceTokenBalance");

                                    final var subop10 =
                                            contractCallLocal(
                                                            contract, "balanceOf", carolEthAddress)
                                                    .gas(250_000L)
                                                    .saveResultTo("carolTokenBalance");

                                    final var subop11 =
                                            contractCallLocal(contract, "balanceOf", bobEthAddress)
                                                    .gas(250_000L)
                                    ...
                                    final var subop17 =
                                            contractCallLocal(contract, "balanceOf", daveEthAddress)
                                                    .gas(250_000L)
                ...
                .then(
                        assertionsHold(
                                (spec, ctxLog) -> {
                                    ...
                                    final var funcJson =
                                            getABIFor(FUNCTION, "getCodeSize", inlineTestContract)
                                                    .replaceAll("'", "\"");
                                    final var function =
    ...
    HapiApiSpec payableSuccess() {
        return defaultHapiSpec("PayableSuccess")
                ...
                .when(contractCall(PAY_RECEIVABLE_CONTRACT).via("payTxn").sending(depositAmount))
                .then(
                        getTxnRecord("payTxn")
                                .hasPriority(
                                        recordWith()
    ...
    private HapiApiSpec resultSizeAffectsFees() {
        ...
        BiConsumer<TransactionRecord, Logger> RESULT_SIZE_FORMATTER =
                (record, txnLog) -> {
                    final var result = record.getContractCallResult();
                    txnLog.info(
                            "Contract call result FeeBuilder size = "
                                    + FeeBuilder.getContractFunctionSize(result)
                                    + ", fee = "
                                    + record.getTransactionFee()
                                    + ", result is [self-reported size = "
                                ...
                                (spec, assertLog) -> {
                                    HapiGetTxnRecord noLogsLookup =
                                            QueryVerbs.getTxnRecord("noLogsCallTxn")
                                                    .loggedWith(RESULT_SIZE_FORMATTER);
                ...
                .when(
                        withOpContext(
                                (spec, opLog) -> {
                                    ...
                                    final var subop2 =
                                            contractCall(contract, "getBalance")
                                                    .payingWith("payer")
                                                    .gas(300_000L)
                                                    .via("getBalance");
                                    ...
                                    final var subop4 =
                                            contractCall(contract, "killMe", 999_999L)
                                                    .payingWith("payer")
                                                    .gas(300_000L)
    ...
    private HapiApiSpec contractTransferToSigReqAccountWithKeySucceeds() {
        return defaultHapiSpec("ContractTransferToSigReqAccountWithKeySucceeds")
                .given(
                        ...
                        getAccountInfo("receivableSigReqAccount")
                                .savingSnapshot("receivableSigReqAccountInfo"),
                        ...
                        withOpContext(
                                (spec, opLog) -> {
                                    final var accountAddress =
                                            spec.registry()
                                                    .getAccountInfo("receivableSigReqAccountInfo")
                                                    .getContractAccountID();
                ...
                .then(
                        withOpContext(
                                (spec, ignore) -> {
                                    final var subop01 =
                                            getTxnRecord("callTX")
                                                    .saveTxnRecordToRegistry("callTXRec");
                                    allRunFor(spec, subop01);

                                    final var gasUsed =
                                            spec.registry()
                                                    .getTransactionRecord("callTXRec")
    ...
    private HapiApiSpec HSCS_EVM_006_ContractHBarTransferToAccount() {
        ...
        return defaultHapiSpec("HSCS_EVM_006_ContractHBarTransferToAccount")
                ...
                .then(getAccountBalance("receiver").hasTinyBars(10_000 + 10));
    }
        ...
        return defaultHapiSpec("HSCS_EVM_005_TransfersWithSubLevelCallsBetweenContracts")
                ...
                .then(
                        ...
                        getAccountBalance(topLevelContract)
                                .hasTinyBars(INITIAL_CONTRACT_BALANCE + 10),
                        contractCall(topLevelContract, "topLevelTransferCall")
                                .sending(10)
                                .payingWith(ACCOUNT),
                        getAccountBalance(topLevelContract)
                                .hasTinyBars(INITIAL_CONTRACT_BALANCE + 20),
                        ...
                        getAccountBalance(topLevelContract)
                                .hasTinyBars(20 + INITIAL_CONTRACT_BALANCE),
                ...
                .when(
                        withOpContext(
                                (spec, log) -> {
                                    var receiver1Addr =
                                            spec.registry()
                                                    .getAccountInfo("receiver1Info")
                                                    .getContractAccountID();
                                    var receiver2Addr =
                                            spec.registry()
                                                    .getAccountInfo("receiver2Info")
                                                    .getContractAccountID();
                                    var receiver3Addr =
                                            spec.registry()
                                                    .getAccountInfo("receiver3Info")
                                                    .getContractAccountID();
    ...
    private HapiApiSpec sendHbarsFromDifferentAddressessToAddress() {
        ...
        return defaultHapiSpec("sendHbarsFromDifferentAddressessToAddress")
                .given(
                        ...
                        contractCustomCreate(NESTED_CONTRACT, "1")
                                .balance(10_000L)
                                .payingWith(ACCOUNT),
                        contractCustomCreate(NESTED_CONTRACT, "2")
                                .balance(10_000L)
                                .payingWith(ACCOUNT),
                        getAccountInfo("receiver").savingSnapshot("receiverInfo"))
                .when(
                                ...
                                (spec, log) -> {
                                    ...
                                    allRunFor(
                                            ...
                                            contractCreate(
                                                            ...
                                                            getNestedContractAddress(
                                                                    NESTED_CONTRACT + "1", spec),
                                                            getNestedContractAddress(
                                                                    NESTED_CONTRACT + "2", spec))
                                                    .balance(10_000L)
                                                    .payingWith(ACCOUNT),
                                            contractCall(
                                                            NESTED_TRANSFERRING_CONTRACT,
                ...
                .then(
                        ...
                        sourcing(
                                () ->
                                        getContractInfo(NESTED_CONTRACT + "1")
                                                .has(contractWith().balance(10_000L - 20L))),
                        sourcing(
                                () ->
                                        getContractInfo(NESTED_CONTRACT + "2")
                                                .has(contractWith().balance(10_000L - 20L))));
    }
                        ...
                        withOpContext(
                                (spec, log) -> {
                                    ...
                                    final var nestedTransferringUpload =
                                            uploadInitCode(
                                                    NESTED_TRANSFERRING_CONTRACT, NESTED_CONTRACT);
                                ...
                                (spec, log) -> {
                                    allRunFor(
                                            ...
                                            getTxnRecord(transferTxn)
                                                    ...
                                                    .payingWith(GENESIS),
                                            getAccountInfo(DEFAULT_CONTRACT_RECEIVER)
                                                    .savingSnapshot("accountInfoAfterCall")
                                                    .payingWith(GENESIS));
                                }))
                .then(
                        assertionsHold(
                                (spec, opLog) -> {
                                    ...
                                    final var accountBalanceAfterCall =
                                            spec.registry()
                                                    .getAccountInfo("accountInfoAfterCall")
                                                    .getBalance();
