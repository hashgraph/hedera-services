...
public class ScheduleLongTermExecutionSpecs extends HapiApiSuite {
    ...
    private HapiApiSpec executionWithCustomPayerWorks() {
        return defaultHapiSpec("ExecutionAtExpiryWithCustomPayerWorks")
                ...
                .then(
                        ...
                        getScheduleInfo("basicXfer").hasCostAnswerPrecheck(INVALID_SCHEDULE_ID),
                        withOpContext(
                                (spec, opLog) -> {
        ...
        return defaultHapiSpec("ExecutionWithContractCallWorksAtExpiry")
                .given(
                        ...
                        cryptoCreate("payingAccount")
                                ...
                                .via("payingAccountTxn"))
                .when(
                        scheduleCreate(
                                        "basicXfer",
                                        contractCall("SimpleUpdate", "set", 5, 42).gas(300000L))
                                .waitForExpiry()
                ...
                .then(
                        ...
                        getAccountBalance("payingAccount")
                                .hasTinyBars(
                                        spec ->
                                                bal ->
                                                        bal < 1000000000000L
    ...
    public HapiApiSpec executionWithInvalidAccountAmountsFails() {
        ...
        return defaultHapiSpec("ExecutionAtExpiryWithInvalidAccountAmountsFails")
                ...
                .then(
                        ...
                        sleepFor(9000),
                        cryptoCreate("foo").via("triggeringTxn"),
                        getScheduleInfo("failedXfer").hasCostAnswerPrecheck(INVALID_SCHEDULE_ID),
    ...
    private HapiApiSpec scheduledFreezeWorksAsExpected() {
        ...
        return defaultHapiSpec("ScheduledFreezeWorksAsExpectedAtExpiry")
                ...
                .then(
                        ...
                        sleepFor(9000),
                        cryptoCreate("foo").via("triggeringTxn"),
                        getScheduleInfo("validSchedule").hasCostAnswerPrecheck(INVALID_SCHEDULE_ID),
    ...
    private HapiApiSpec failsWithExpiryInPast() {
        return defaultHapiSpec("FailsWithExpiryInPast")
                .given(cryptoCreate("sender").via("senderTxn"))
                .when(
                        scheduleCreate(
                                        "validSchedule",
    ...
    private HapiApiSpec failsWithExpiryInFarFuture() {
        return defaultHapiSpec("FailsWithExpiryInFarFuture")
                .given(cryptoCreate("sender").balance(ONE_MILLION_HBARS).via("senderTxn"))
                .when(
                        scheduleCreate(
                                        "validSchedule",
                                        cryptoTransfer(tinyBarsFromTo("sender", GENESIS, 1)))
                ...
                .then(
                        ...
                        withOpContext(
                                (spec, opLog) -> {
                                    ...
                                    var scheduledTx =
                                            getTxnRecord("pricyCallScheduled").scheduled();
                                    ...
                                    var priceScheduled =
                                            scheduledTx.getResponseRecord().getTransactionFee();
                                    var priceRegular =
                                            regularTx.getResponseRecord().getTransactionFee();
                                    ...
                                    Assertions.assertEquals(
                                            ...
                                            0.1,
                                            "no multiplier should be in affect for execution at"
                                                    + " expiry!");
                                }));
    }
        ...
        return defaultHapiSpec("FutureThrottlesAreRespected")
                ...
                .then(
                        overriding(
                                ...
                                HapiSpecSetup.getDefaultNodeProps()
                                        .get("scheduling.maxTxnPerSecond")),
                        fileUpdate(THROTTLE_DEFS)
                                .fee(ONE_HUNDRED_HBARS)
                                .payingWith(EXCHANGE_RATE_CONTROL)
                                .contents(defaultThrottles.toByteArray()),
        ...
        return defaultHapiSpec("EnableLongTermScheduledTransactions")
                ...
                .then(
                        fileUpdate(APP_PROPERTIES)
                                ...
                                .overridingProps(Map.of("scheduling.longTermEnabled", "true")));
    }
    ...
    public static HapiApiSpec disableLongTermScheduledTransactions() {
        return defaultHapiSpec("DisableLongTermScheduledTransactions")
                ...
                .then(
                        fileUpdate(APP_PROPERTIES)
                                .payingWith(ADDRESS_BOOK_CONTROL)
                                .overridingProps(Map.of("scheduling.longTermEnabled", "false")));
    }
                        ...
                        fileUpdate(APP_PROPERTIES)
                                ...
                                .overridingProps(
                                        Map.of(
                                                ...
                                                defaultLongTermEnabled)));
    }

    public static List<HapiApiSpec> withAndWithoutLongTermEnabled(
            Supplier<List<HapiApiSpec>> getSpecs) {
    ...
    public static List<HapiApiSpec> withAndWithoutLongTermEnabled(
            Function<Boolean, List<HapiApiSpec>> getSpecs) {
        List<HapiApiSpec> list = new ArrayList<>();
        list.add(disableLongTermScheduledTransactions());
