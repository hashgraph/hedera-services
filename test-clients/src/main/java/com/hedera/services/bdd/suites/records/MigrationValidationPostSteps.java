...
public class MigrationValidationPostSteps extends HapiApiSuite {
	...
	final String SC_GET_ABI = "{\"constant\":true,\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"name\":\"\"," +
			"\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
	final String SC_SET_ABI = "{\"constant\":false,\"inputs\":[{\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"set\"," +
	...
	private HapiSpecOperation[] verifySmartContractActions() {
		return new HapiSpecOperation[] {
				...
				sleepFor(2_000L),
				QueryVerbs.getTxnRecord(SC_getValue).hasPriority(
						TransactionRecordAsserts.recordWith().contractCallResult(
								ContractFnResultAsserts.resultWith().resultThruAbi(SC_GET_ABI,
