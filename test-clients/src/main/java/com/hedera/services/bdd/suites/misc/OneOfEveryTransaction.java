...
public class OneOfEveryTransaction extends HapiApiSuite {
  ...
  private HapiApiSpec doThings() {
    ...
    return defaultHapiSpec("DoThings")
        .given(
            /* Crypto resources */
        ...
        .when(
            /* Crypto txns */
            cryptoCreate("tbd").receiveThreshold(1_000L).balance(1_234L).key("firstKey"),
            ...
            /* File txns */
            fileCreate("fileTbd").key("fileFirstKey").contents("abcdefghijklm"),
            ...
            updateTopic("topicTbd").signedBy(GENESIS, "topicKey").submitKey(EMPTY_KEY),
            submitMessageTo("topicTbd").signedBy(GENESIS),
            ...
            contractCreate("contractTbd")
                ...
                .balance(1),
            contractCall("contractTbd").sending(1L),
            contractCallLocal("contractTbd", ContractResources.LUCKY_NO_LOOKUP_ABI),
            contractUpdate("contractTbd").newKey("contractSecondKey"),
