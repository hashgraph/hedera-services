...
public class DynamicGasCostSuite extends HapiApiSuite {
    ...
    public static final String MAX_REFUND_PERCENT_OF_GAS_LIMIT =
    ...
    private HapiApiSpec eip1014AliasIsPriorityInErcOwnerPrecompile() {
        ...
        return defaultHapiSpec("Eip1014AliasIsPriorityInErcOwnerPrecompile")
                .given(
                        ...
                        contractCreate(pc2User).adminKey(multiKey).payingWith(GENESIS),
        ...
        return defaultHapiSpec("PriorityAddressIsCreate2ForStaticHapiCalls")
                .given(
                        ...
                        contractCall(contract, "createReturner", salt)
                                ...
                                .gas(4_000_000L)
                                .via(creation2),
                        captureOneChildCreate2MetaFor("Returner", creation2, mirrorAddr, aliasAddr))
                .when(
                        sourcing(
                                () ->
                                        contractCallLocalWithFunctionAbi(
    ...
    private HapiApiSpec canInternallyCallAliasedAddressesOnlyViaCreate2Address() {
        ...
        return defaultHapiSpec("CanInternallyCallAliasedAddressesOnlyViaCreate2Address")
                ...
                .when(
                        ...
                        sourcing(
                                () ->
                                        contractCallLocal(contract, "callReturner", aliasAddr.get())
                                                .payingWith(GENESIS)
                                                .exposingTypedResultsTo(
                                                        results -> {
                                                            log.info(
                        ...
                        sourcing(
                                () ->
                                        contractCall(contract, "callReturner", aliasAddr.get())
                                                .payingWith(GENESIS)
                                                .via(aliasCall)),
                        sourcing(
                                () ->
                                        contractCall(contract, "callReturner", mirrorAddr.get())
                                                .hasKnownStatus(INVALID_SOLIDITY_ADDRESS)
                                                .payingWith(GENESIS)
                                                .via(mirrorCall)))
                .then(
        ...
        return defaultHapiSpec("MintDynamicGasCostPrecompile")
                .given(
                        ...
                        tokenCreate(VANILLA_TOKEN)
                                ...
                                .supplyKey(MULTI_KEY)
                                .exposingCreatedIdTo(
                                        id -> vanillaTokenID.set(HapiPropertySource.asToken(id))),
                                ...
                                (spec, opLog) ->
                                        allRunFor(
                                                ...
                                                UtilVerbs.overriding(
                                                        HTS_DEFAULT_GAS_COST, ZERO_GAS_COST),
                                                UtilVerbs.overriding(
                                                ...
                                                UtilVerbs.overriding(
                                                        HTS_DEFAULT_GAS_COST, DEFAULT_GAS_COST),
                                                contractCall(
                                                                SAFE_OPERATIONS_CONTRACT,
                                                                "safeTokenMint",
                                                                asAddress(vanillaTokenID.get()),
                ...
                .then(
                        withOpContext(
                                (spec, ignore) -> {
                                    ...
                                    assertEquals(
                                            10_000L,
                                            gasUsedForDefaultCostTxn - gasUsedForZeroCostTxn);
                                }));
    }
        ...
        return defaultHapiSpec("MultipleAssociateDynamicGasCostPrecompile")
                .given(
                        ...
                        tokenCreate(KNOWABLE_TOKEN)
                                ...
                                .initialSupply(10L)
                                .exposingCreatedIdTo(
                                        id -> knowableTokenID.set(HapiPropertySource.asToken(id))),
                        uploadInitCode(SAFE_OPERATIONS_CONTRACT),
                        contractCreate(SAFE_OPERATIONS_CONTRACT).gas(100_000))
                .when(
                        withOpContext(
                                (spec, opLog) ->
                                        allRunFor(
                                                ...
                                                UtilVerbs.overriding(
                                                        HTS_DEFAULT_GAS_COST, DEFAULT_GAS_COST),
                                                tokenDissociate(
                                                        ACCOUNT, VANILLA_TOKEN, KNOWABLE_TOKEN),
                                                contractCall(
                                                                SAFE_OPERATIONS_CONTRACT,
                                                                "safeTokensAssociate",
                                                                asAddress(accountID.get()),
        ...
        return withOpContext(
                (spec, opLog) -> {
                    ...
                    if (numRecords == numExpectedChildren + 1) {
                        ...
                        if (TxnUtils.isEndOfStakingPeriodRecord(
