    ...
    return customHapiSpec("SchedulesExpiryDuringReconnect")
        ...
        .given(
            ...
            scheduleCreate(
                    ...
                    cryptoTransfer(tinyBarsFromTo(GENESIS, FUNDING, 1)).fee(ONE_HBAR))
        ...
        .when(
            ...
            scheduleCreate(
                    longLastingSchedule,
                    cryptoTransfer(tinyBarsFromTo(GENESIS, FUNDING, 2)).fee(ONE_HBAR))
                .fee(ONE_HUNDRED_HBARS)
                .hasPrecheckFrom(STANDARD_PERMISSIBLE_PRECHECKS)
                .hasAnyKnownStatus()
                .deferStatusResolution()
            ...
            scheduleCreate(
                    oneOtherSchedule,
                    cryptoTransfer(tinyBarsFromTo(GENESIS, FUNDING, 3)).fee(ONE_HBAR))
                .signedBy(DEFAULT_PAYER)
                .fee(ONE_HUNDRED_HBARS)
                .hasPrecheckFrom(STANDARD_PERMISSIBLE_PRECHECKS)
                .hasAnyKnownStatus()
