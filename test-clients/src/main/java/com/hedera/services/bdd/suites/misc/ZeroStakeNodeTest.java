...
public class ZeroStakeNodeTest extends HapiApiSuite {
  ...
  /**
   * This test has to be run with nodes in spec-defaults set as the full list of ipAddresses and
    ...
    return defaultHapiSpec("zeroStakeBehavesAsExpectedJRS")
        .given(
            ...
            contractUpdate("multi")
                ...
                .newMemo("Oops!")
                .hasPrecheck(INVALID_NODE_ACCOUNT),
            contractDelete("multi").setNode("0.0.7").hasPrecheck(INVALID_NODE_ACCOUNT),
            contractCall("multi").setNode("0.0.8").sending(1L).hasPrecheck(INVALID_NODE_ACCOUNT))
        .when(
        ...
        .then(
            ...
            getAccountInfo("beneficiary")
                ...
                .nodePayment(0L)
                .logged(),
            getFileInfo("bytecode").setNode("0.0.8").payingWith("sponsor").nodePayment(0L).logged(),
