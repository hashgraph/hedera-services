...
public class AccountInfoAsserts extends BaseErroringAssertsProvider<AccountInfo> {
  ...
  public AccountInfoAsserts solidityId(String cid) {
    registerProvider(
        (spec, o) -> {
          ...
          Assertions.assertEquals(
              solidityId, ((AccountInfo) o).getContractAccountID(), "Bad Solidity contract Id!");
        });
    return this;
  }
  ...
  public AccountInfoAsserts receiverSigReq(Boolean isReq) {
    registerProvider(
        (spec, o) -> {
          Assertions.assertEquals(
              isReq, ((AccountInfo) o).getReceiverSigRequired(), "Bad receiver sig requirement!");
        });
    return this;
  }
  ...
  public AccountInfoAsserts sendThreshold(long amount) {
    registerProvider(
        (spec, o) -> {
          Assertions.assertEquals(
              amount, ((AccountInfo) o).getGenerateSendRecordThreshold(), "Bad send threshold!");
        });
    return this;
  }
    ...
    registerProvider(
        (spec, o) -> {
          ...
          Assertions.assertTrue(
              ...
              String.format(
                  "Expiry %d not in [%d, %d]!", approxTime, expiry - epsilon, expiry + epsilon));
        });
    return this;
  }
  ...
  public AccountInfoAsserts expiry(String registryEntry, long delta) {
    registerProvider(
        (spec, o) -> {
          long expiry = ((AccountInfo) o).getExpirationTime().getSeconds();
          long expected =
              spec.registry().getAccountInfo(registryEntry).getExpirationTime().getSeconds()
                  + delta;
