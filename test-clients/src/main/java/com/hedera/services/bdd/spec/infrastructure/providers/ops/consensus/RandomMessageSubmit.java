...
public class RandomMessageSubmit implements OpProvider {
  ...
  private final ResponseCodeEnum[] permissibleOutcomes =
      standardOutcomesAnd(
          TOPIC_EXPIRED, INVALID_TOPIC_ID, INVALID_CHUNK_NUMBER, INVALID_CHUNK_TRANSACTION_ID);
  ...
  public static Set<String> stableTopics(int n) {
    return IntStream.range(0, n).mapToObj(i -> String.format("stable-topic%d", i)).collect(toSet());
  }
