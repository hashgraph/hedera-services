...
public class FeeBasePriceCommand implements Callable<Integer> {
  @CommandLine.ParentCommand FeesCommand feesCommand;

  @CommandLine.Parameters(
      arity = "1..*",
      paramLabel = "<services>",
      description =
          "services ('crypto', 'consensus', 'token', 'file', 'contract', 'scheduled')  \n"
  ...
  public Integer call() throws Exception {
    ...
    var delegate =
        new CostOfEveryThingSuite(config.asSpecConfig(), feeTableSB, serviceBorder, services);
