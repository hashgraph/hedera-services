  ...
  HapiApiSpec canonicalContractOps() {
    return HapiApiSpec.customHapiSpec(String.format("canonicalContractOps"))
        ...
        .when(
            ...
            getContractInfo("testContract").payingWith("payer").via("canonicalGetContractInfo"),
            ...
            getContractRecords("testContract").logged().via("canonicalGetContractRecords"),
        ...
        .then(
            ...
            getTransactionFee(
                "canonicalGetContractByteCode", feeTableBuilder, "getContractByteCode"),
  ...
  HapiApiSpec canonicalTopicOps() {
    return HapiApiSpec.customHapiSpec(String.format("canonicalTopicOps"))
        ...
        .when(
            ...
            getTopicInfo("testTopic").payingWith("payer").via("canonicalGetTopicInfo"),
  ...
  HapiApiSpec canonicalTokenOps() {
    return HapiApiSpec.customHapiSpec(String.format("canonicalTokenOps"))
        ...
        .given(
            ...
            cryptoCreate("autoRenewAccount").key("adminKey").balance(0L),
            cryptoCreate("testAccountA").key("adminKey"))
        .when(
            tokenCreate("primary")
                .entityMemo("")
                .blankMemo()
  ...
  HapiApiSpec canonicalCryptoOps() {
    ...
    return HapiApiSpec.customHapiSpec(String.format("canonicalCryptoOps"))
        ...
        .when(
            ...
            getAccountRecords("canonicalAccount").via("canonicalGetRecords"),
            getAccountInfo("canonicalAccount").via("canonicalGetAccountInfo"),
            cryptoCreate("canonicalAccountTBD").blankMemo().entityMemo("").payingWith("payer"),
  ...
  HapiApiSpec canonicalScheduleOps() {
    return HapiApiSpec.customHapiSpec(String.format("canonicalScheduleOps"))
        ...
        .when(
            ...
            getScheduleInfo("canonicalSchedule").payingWith("payingSender"),
