...
public record DirectiveLine(
        @NotNull String directive, @NotNull String operand, @NotNull String comment)
        implements Assembly.Line {

    public DirectiveLine(@NotNull String directive) {
        this(directive, "", "");
    }

    public DirectiveLine(@NotNull String directive, @NotNull String operand) {
        this(directive, operand, "");
    }
