...
// We need the ProtoBuf Schema files for HAPI API, clone a given branch or tag from HAPI GitHub
// repository
gitRepositories {
...
dependencyResolutionManagement {
  ...
  versionCatalogs {
    ...
    create("libs") {
      ...
      version("framework-version", "1.3.2")
      ...
      bundle("helidon", listOf("helidon-server", "helidon-grpc-server"))
      ...
      library("dagger-spi", "com.google.dagger", "dagger-compiler").versionRef("dagger-version")
      library("eddsa", "net.i2p.crypto", "eddsa").versionRef("eddsa-version")
      library("io-grpc-api", "io.grpc", "grpc-api").versionRef("grpc-version")
      library("io-grpc-core", "io.grpc", "grpc-core").versionRef("grpc-version")
      library("io-grpc-netty", "io.grpc", "grpc-netty").versionRef("grpc-version")
      library("io-grpc-services", "io.grpc", "grpc-services").versionRef("grpc-version")
      library("io-grpc-stub", "io.grpc", "grpc-stub").versionRef("grpc-version")
      library("io-grpc-protobuf", "io.grpc", "grpc-protobuf").versionRef("grpc-version")
      library("io-grpc-protobuf-lite", "io.grpc", "grpc-protobuf-lite").versionRef("grpc-version")
      ...
      library("framework", "org.connid", "framework").versionRef("framework-version")
    ...
    create("testLibs") {
      ...
      library("bytebuddy", "net.bytebuddy", "byte-buddy").versionRef("byte-buddy")
      library("bytebuddy-agent", "net.bytebuddy", "byte-buddy-agent").versionRef("byte-buddy")
