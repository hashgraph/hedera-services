...
// We need the ProtoBuf Schema files for HAPI API, clone a given branch or tag from HAPI GitHub repository
gitRepositories {
...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("dagger-spi", "com.google.dagger", "dagger-compiler")
                .versionRef("dagger-version")
