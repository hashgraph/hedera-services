...
dependencyResolutionManagement {
  ...
  versionCatalogs {
    ...
    create("libs") {
      ...
      version("auto-service-version", "1.0.1")
      ...
      library("swirlds-config-api", "com.swirlds", "swirlds-config-api")
      ...
      library("auto-service-annotations", "com.google.auto.service", "auto-service-annotations")
          .versionRef("auto-service-version")
      library("auto-service", "com.google.auto.service", "auto-service")
          .versionRef("auto-service-version")
    }
