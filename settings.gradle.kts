...
gitRepositories {
    ...
    include("hedera-protobufs") {
        uri.set("https://github.com/LimeChain/hedera-protobufs.git") // TODO: Temporary override for Limechain fork, revert when https://github.com/hashgraph/hedera-protobufs/pull/304 is merged
        // HAPI repo version
