...
import com.hedera.services.stream.v7.proto.BlockSignature;
import com.hedera.services.stream.v7.proto.BlockStateProof;
...
public class BlockNodeFileWatcherService {
    ...
    private String publicKey = "";
            ...
            public void onFileCreate(File file) {
                ...
                try {
                    ...
                    // If it's a .gz file, unzip and parse it as before
                        ...
                        List<BlockStateProof> stateProof = block.getItemsList().stream()
                                .filter(BlockItem::hasStateProof)
                                .map(BlockItem::getStateProof)
                                .toList();
                        stateProof.stream()
                                .flatMap(state -> state.getBlockSignaturesList().stream().map(
                                        blockSignature -> verifySignatures(blockSignature)
    ...
    private BlockSignature verifySignatures(BlockSignature signature) {
