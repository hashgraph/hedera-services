        ...
        try {
            ...
            for (int i = 0; i < args.length; ++i) {
                ...
                if (args[i].equals("-db") && i + 1 < args.length) {
                    String db = args[i + 1];
                    logger.debug("DB directory set to [{}]", db);
                ...
                if (args[i].equals("-listen") && i + 1 < args.length) {
                    ...
                    logger.debug("Listen port set to [{}]", port);
                ...
                if (args[i].startsWith("-connect") && i + 1 < args.length) {
                    ...
                    logger.debug("Connect URI set to [{}]", connectStr);
                ...
                if (args[i].equals("-reset") && i + 1 < args.length) {
                    ...
                    logger.debug("Resetting db set to [{}]", resetStr);
