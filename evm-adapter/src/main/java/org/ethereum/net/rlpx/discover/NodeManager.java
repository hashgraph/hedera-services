...
public class NodeManager implements Functional.Consumer<DiscoveryEvent>{
    ...
    private void dbRead() {
        if(logger.isDebugEnabled())
            logger.debug("Reading Node statistics from DB: " + peerSource.getNodes().size() + " nodes.");
    ...
    private void dbWrite() {
        ...
        if(logger.isDebugEnabled())
            logger.debug("Write Node statistics to DB: " + peerSource.getNodes().size() + " nodes.");
    }
    ...
    public void close() {
        ...
        try {
            if(logger.isDebugEnabled())
                logger.debug("Cancelling pongTimer");
