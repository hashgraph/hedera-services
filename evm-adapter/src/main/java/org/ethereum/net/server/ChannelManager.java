...
public class ChannelManager {
    ...
    private void processNewPeers() {
        ...
        if (addCnt > 0) {
            logger.debug("New peers processed: " + processed + ", active peers added: " + addCnt + ", total active peers: " + activePeers.size());
        }
