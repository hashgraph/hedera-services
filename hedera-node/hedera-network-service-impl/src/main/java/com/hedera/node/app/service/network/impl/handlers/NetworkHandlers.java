...
public class NetworkHandlers {
    ...
    public NetworkHandlers(
        ...
        this.networkGetAccountDetailsHandler = requireNonNull(networkGetAccountDetailsHandler,
                "networkGetAccountDetailsHandler must not be null");
        this.networkGetByKeyHandler = requireNonNull(networkGetByKeyHandler,
                "networkGetByKeyHandler must not be null");
        this.networkGetExecutionTimeHandler = requireNonNull(networkGetExecutionTimeHandler,
                "networkGetExecutionTimeHandler must not be null");
        this.networkGetVersionInfoHandler = requireNonNull(networkGetVersionInfoHandler,
                "networkGetVersionInfoHandler must not be null");
        this.networkTransactionGetReceiptHandler = requireNonNull(networkTransactionGetReceiptHandler,
                "networkTransactionGetReceiptHandler must not be null");
        this.networkTransactionGetRecordHandler = requireNonNull(networkTransactionGetRecordHandler,
                "networkTransactionGetRecordHandler must not be null");
        this.networkUncheckedSubmitHandler = requireNonNull(networkUncheckedSubmitHandler,
                "networkUncheckedSubmitHandler must not be null");
    }
