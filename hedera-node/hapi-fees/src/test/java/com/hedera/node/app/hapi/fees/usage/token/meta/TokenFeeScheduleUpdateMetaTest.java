...
class TokenFeeScheduleUpdateMetaTest {
    @Test
    void assertEqualsWork() {
        // when:
        final var subject = new TokenFeeScheduleUpdateMeta(1_234_567L, 22);
        final var subject2 = new TokenFeeScheduleUpdateMeta(1_234_567L, 22);
