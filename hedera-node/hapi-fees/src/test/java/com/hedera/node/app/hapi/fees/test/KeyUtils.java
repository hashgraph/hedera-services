...
public class KeyUtils {
    ...
    public static Key A_THRESHOLD_KEY =
            Key.newBuilder()
                    .setThresholdKey(
                                                    ...
                                                    .setEd25519(
                                                            ByteString.copyFrom(
                                                                    "cccccccccccccccccccccccccccccccc"
                                                                            .getBytes()))))
                    .build();
    public static Key A_COMPLEX_KEY =
            Key.newBuilder()
                    .setThresholdKey(
                            ThresholdKey.newBuilder()
                                    .setThreshold(2)
                    ...
                    .build();
    public static Key B_COMPLEX_KEY =
            Key.newBuilder()
                    .setThresholdKey(
                            ThresholdKey.newBuilder()
                                    .setThreshold(2)
                    ...
                    .build();
    public static Key C_COMPLEX_KEY =
            Key.newBuilder()
                    .setThresholdKey(
                            ThresholdKey.newBuilder()
                                    .setThreshold(2)
