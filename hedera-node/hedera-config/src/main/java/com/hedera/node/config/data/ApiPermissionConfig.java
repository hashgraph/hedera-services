...
public record ApiPermissionConfig(
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange createAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange cryptoTransfer,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange updateAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange cryptoGetBalance,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getAccountInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange cryptoDelete,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getAccountRecords,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getTxRecordByTxID,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getTransactionReceipts,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange approveAllowances,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange deleteAllowances,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange utilPrng,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange createFile,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange updateFile,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange deleteFile,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange appendContent,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getFileContent,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getFileInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange createContract,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange updateContract,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange contractCallMethod,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getContractInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange contractCallLocalMethod,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange contractGetBytecode,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getTxRecordByContractID,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange deleteContract,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange createTopic,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange updateTopic,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange deleteTopic,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange submitMessage,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getTopicInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange ethereumTransaction,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange scheduleCreate,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange scheduleSign,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange scheduleDelete,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange scheduleGetInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenCreate,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenFreezeAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenUnfreezeAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenGrantKycToAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenRevokeKycFromAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenDelete,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenMint,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenBurn,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenAccountWipe,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenUpdate,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenGetInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenAssociateToAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenDissociateFromAccount,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenGetNftInfo,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenGetNftInfos,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenGetAccountNftInfos,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenFeeScheduleUpdate,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenPause,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange tokenUnpause,
        @ConfigProperty(defaultValue = "0-*") @NetworkProperty PermissionedAccountsRange getVersionInfo,
        @ConfigProperty(defaultValue = "2-50") @NetworkProperty PermissionedAccountsRange networkGetExecutionTime,
        @ConfigProperty(defaultValue = "2-59") @NetworkProperty PermissionedAccountsRange systemDelete,
        @ConfigProperty(defaultValue = "2-60") @NetworkProperty PermissionedAccountsRange systemUndelete,
        @ConfigProperty(defaultValue = "2-58") @NetworkProperty PermissionedAccountsRange freeze,
        @ConfigProperty(defaultValue = "2-50") @NetworkProperty PermissionedAccountsRange getAccountDetails) {
