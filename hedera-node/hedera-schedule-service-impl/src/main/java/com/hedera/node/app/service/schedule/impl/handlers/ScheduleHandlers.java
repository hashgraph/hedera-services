...
public class ScheduleHandlers {
    ...
    public ScheduleHandlers(
        ...
        this.scheduleCreateHandler = requireNonNull(scheduleCreateHandler,
                "scheduleCreateHandler must not be null");
        this.scheduleDeleteHandler = requireNonNull(scheduleDeleteHandler,
                "scheduleDeleteHandler must not be null");
        this.scheduleGetInfoHandler = requireNonNull(scheduleGetInfoHandler,
                "scheduleGetInfoHandler must not be null");
        this.scheduleSignHandler = requireNonNull(scheduleSignHandler,
                "scheduleSignHandler must not be null");
    }
