...
public final class ScheduleUtility {
    ...
    static TransactionBody asOrdinary(@NonNull final Schedule scheduleInState) {
        ...
        final SchedulableTransactionBody scheduledTransaction = scheduleInState.scheduledTransactionOrThrow();
     ...
     */
    @NonNull
    public static Schedule markExecuted(@NonNull final Schedule schedule, @NonNull final Instant consensusTime) {
    ...
    @NonNull
    static ScheduleID toPbj(@NonNull com.hederahashgraph.api.proto.java.ScheduleID valueToConvert) {
    ...
    static Schedule createProvisionalSchedule(
        ...
        if (currentTransaction == null) throw new HandleException(ResponseCodeEnum.EMPTY_TRANSACTION_BODY);
        if (currentConsensusTime == null) throw new HandleException(ResponseCodeEnum.SERIALIZATION_FAILED);
    ...
    private static Instant calculateExpirationInstant(
            @Nullable final Timestamp givenExpiration,
            @NonNull final Instant currentConsensusTime,
            final long maxLifeMilliseconds) {
        if (givenExpiration != null) {
            return Instant.ofEpochSecond(givenExpiration.seconds(), givenExpiration.nanos());
        } else {
            return currentConsensusTime.plusMillis(maxLifeMilliseconds);
        }
    }
