...
class ScheduleServiceStateTranslatorTest {
    ...
    private final long expirationSeconds = 2281580449L;
    private final long calculatedExpirationSeconds = 2281580449L;
    ...
    private Schedule getValidSchedule() {
        ...
        return Schedule.newBuilder()
                ...
                .providedExpirationSeconds(expirationSeconds)
                .calculatedExpirationSeconds(calculatedExpirationSeconds)
    ...
    private TransactionBody originalCreateTransaction(
        ...
        final ScheduleCreateTransactionBody.Builder builder = ScheduleCreateTransactionBody.newBuilder()
                ...
                .payerAccountID(payer)
                .waitForExpiry(true)
                .expirationTime(Timestamp.newBuilder().seconds(expirationSeconds))
                .adminKey(adminKey)
                .memo(memo);
