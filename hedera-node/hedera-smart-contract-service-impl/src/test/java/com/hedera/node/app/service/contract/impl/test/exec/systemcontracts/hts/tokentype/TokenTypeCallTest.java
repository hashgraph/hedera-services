...
class TokenTypeCallTest extends HtsCallTestBase {
    ...
    void returnsTokenTypeForPresentToken() {
        final var subject = new TokenTypeCall(frame, gasCalculator, mockEnhancement(), false, FUNGIBLE_TOKEN);
    ...
    void returnsTokenTypeForMissingToken() {
        final var subject = new TokenTypeCall(frame, gasCalculator, mockEnhancement(), false, null);
    ...
    void returnsTokenTypeForMissingTokenStaticCall() {
        final var subject = new TokenTypeCall(frame, gasCalculator, mockEnhancement(), true, null);
