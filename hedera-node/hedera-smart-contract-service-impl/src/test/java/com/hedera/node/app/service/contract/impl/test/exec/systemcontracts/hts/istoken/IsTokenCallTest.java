...
class IsTokenCallTest extends HtsCallTestBase {
    ...
    void returnsIsTokenForPresentToken() {
        final var subject = new IsTokenCall(frame, gasCalculator, mockEnhancement(), false, FUNGIBLE_TOKEN);
    ...
    void returnsIsTokenForMissingToken() {
        final var subject = new IsTokenCall(frame, gasCalculator, mockEnhancement(), false, null);
    ...
    void returnsIsTokenForMissingTokenStaticCall() {
        final var subject = new IsTokenCall(frame, gasCalculator, mockEnhancement(), true, null);
