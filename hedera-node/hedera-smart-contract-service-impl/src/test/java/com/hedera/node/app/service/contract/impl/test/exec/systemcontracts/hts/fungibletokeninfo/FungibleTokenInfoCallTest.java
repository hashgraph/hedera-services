...
class FungibleTokenInfoCallTest extends HtsCallTestBase {
    ...
    void returnsFungibleTokenInfoStatusForMissingToken() {
        ...
        final var subject =
                new FungibleTokenInfoCall(mockMessageFrame(), gasCalculator, mockEnhancement(), false, null, config);
    ...
    void returnsFungibleTokenInfoStatusForMissingTokenStaticCall() {
        ...
        final var subject =
                new FungibleTokenInfoCall(mockMessageFrame(), gasCalculator, mockEnhancement(), true, null, config);
