...
class TokenCustomFeesCallTest extends HtsCallTestBase {
    ...
    void returnsTokenCustomFeesStatusForPresentToken() {
        final var subject = new TokenCustomFeesCall(
                mockMessageFrame(), gasCalculator, mockEnhancement(), false, FUNGIBLE_EVERYTHING_TOKEN);
    ...
    void returnsTokenCustomFeesStatusForMissingToken() {
        final var subject = new TokenCustomFeesCall(mockMessageFrame(), gasCalculator, mockEnhancement(), false, null);
    ...
    void returnsTokenCustomFeesStatusForMissingTokenStaticCall() {
        final var subject = new TokenCustomFeesCall(mockMessageFrame(), gasCalculator, mockEnhancement(), true, null);
