...
class IsTokenTranslatorTest {
    ...
    void matchesIsTokenTest() {
        given(attempt.selector()).willReturn(IsTokenTranslator.IS_TOKEN.selector());
    ...
    void callFromTest() {
        ...
        final Bytes inputBytes = Bytes.wrapByteBuffer(IsTokenTranslator.IS_TOKEN.encodeCall(tuple));
