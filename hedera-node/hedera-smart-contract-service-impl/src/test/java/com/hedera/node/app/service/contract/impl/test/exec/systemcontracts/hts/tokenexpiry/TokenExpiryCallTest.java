...
class TokenExpiryCallTest extends HtsCallTestBase {
    ...
    void returnsTokenExpiryStatusForMissingToken() {
        final var subject = new TokenExpiryCall(mockMessageFrame(), gasCalculator, mockEnhancement(), false, null);
    ...
    void returnsTokenExpiryStatusForMissingTokenStaticCall() {
        final var subject = new TokenExpiryCall(mockMessageFrame(), gasCalculator, mockEnhancement(), true, null);
