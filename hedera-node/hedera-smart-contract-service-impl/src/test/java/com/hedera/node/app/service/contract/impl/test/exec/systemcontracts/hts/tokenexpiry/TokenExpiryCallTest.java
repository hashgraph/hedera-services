...
class TokenExpiryCallTest extends HtsCallTestBase {
    ...
    void returnsValidTokenExpiryStatusForPresentToken() {
        final var subject =
                new TokenExpiryCall(frame, gasCalculator, mockEnhancement(), false, FUNGIBLE_EVERYTHING_TOKEN);
    ...
    void returnsTokenExpiryStatusForMissingToken() {
        final var subject = new TokenExpiryCall(frame, gasCalculator, mockEnhancement(), false, null);
    ...
    void returnsTokenExpiryStatusForMissingTokenStaticCall() {
        final var subject = new TokenExpiryCall(frame, gasCalculator, mockEnhancement(), true, null);
