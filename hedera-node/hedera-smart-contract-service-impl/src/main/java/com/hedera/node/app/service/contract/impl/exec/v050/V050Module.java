...
/**
 * Provides the Services 0.50 EVM implementation, which consists of Cancun operations and
 * Cancun precompiles plus the Hedera gas calculator, system contracts, and operations as they
 * were configured in the 0.50 release (with both the option for lazy creation, and with special
