...
public class ContractMetrics {
    ...
    public void init(@NonNull final Metrics metrics) {
        ...
        // This homegrown singleton initialization is (apparently) needed because 1) the Metrics
        // instance is created too late in the app - _after_ the AppContext is created, and 2) Services
        // do _not_ get a call after the app is "up" but before processing starts.  So we have to
        // lazy initialize - once only.
