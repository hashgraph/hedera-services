...
public class IsKycTranslator extends AbstractHtsCallTranslator {
    ...
    public boolean matches(@NonNull final HtsCallAttempt attempt) {
        return Arrays.equals(attempt.selector(), IS_KYC.selector());
    }
    ...
    public HtsCall callFrom(@NonNull final HtsCallAttempt attempt) {
        ...
        return new IsKycCall(attempt.enhancement(), token, args.get(1));
    }
}
