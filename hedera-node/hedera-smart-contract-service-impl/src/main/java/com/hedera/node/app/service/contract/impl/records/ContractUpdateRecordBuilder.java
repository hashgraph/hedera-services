...
public interface ContractUpdateRecordBuilder {
    ...
    /**
     * Tracks the final status of a top-level contract update.
     *
     * @param status the final status of the contract update
     * @return this builder
     */
    @NonNull
    ContractUpdateRecordBuilder status(@NonNull ResponseCodeEnum status);

    /**
     * Tracks the contract id updated by a successful top-level contract update.
     *
    ...
    /**
     * Tracks the result of a top-level contract update.
     *
     * @param result the {@link ContractFunctionResult} of the contract creation
     * @return this builder
     */
    @NonNull
    ContractUpdateRecordBuilder contractUpdateResult(@Nullable ContractFunctionResult result);
}
