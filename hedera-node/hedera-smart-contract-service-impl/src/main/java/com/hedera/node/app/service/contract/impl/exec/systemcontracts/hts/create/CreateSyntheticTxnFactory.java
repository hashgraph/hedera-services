...
public class CreateSyntheticTxnFactory {
    ...
    private static void setTokenKeys(@NonNull final TokenCreateWrapper tokenCreateWrapper,
            final Builder txnBodyBuilder) {
    ...
    private static void setExpiry(@NonNull final TokenCreateWrapper tokenCreateWrapper,
            @NonNull final Builder txnBodyBuilder) {
    ...
    private static void addCustomFees(@NonNull final TokenCreateWrapper tokenCreateWrapper,
            @NonNull final Builder txnBodyBuilder) {
        final var fractionalFees = tokenCreateWrapper.getFractionalFees().stream()
                .map(FractionalFeeWrapper::asGrpc);
        final var fixedFees = tokenCreateWrapper.getFixedFees().stream()
                .map(FixedFeeWrapper::asGrpc);
