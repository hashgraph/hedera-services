 ...
 * halts the frame with {@link StandardExceptionalHaltReason#INVALID_SOLIDITY_ADDRESS}.
 */
        ...
        try {
            ...
            if (!addressChecks.isPresent(address, frame)) {
                return new OperationResult(
                        cost(frame, memOffset, numBytes, true), StandardExceptionalHaltReason.INVALID_SOLIDITY_ADDRESS);
            }
