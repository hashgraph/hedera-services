...
/**
 * Implements the token redirect {@code unfreeze()} call of the HTS system contract.
 */
public class UnfreezeCall extends AbstractHtsCall {
    ...
    public PricedResult execute() {
        ...
        final var unfreezeTransactionBody = TokenUnfreezeAccountTransactionBody.newBuilder()
        ...
        final var transactionBody = TransactionBody.newBuilder()
                .tokenUnfreeze(unfreezeTransactionBody)
                .build();
