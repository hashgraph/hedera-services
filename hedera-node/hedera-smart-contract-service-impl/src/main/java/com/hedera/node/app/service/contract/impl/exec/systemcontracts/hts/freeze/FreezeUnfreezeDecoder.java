...
public class FreezeUnfreezeDecoder {
    ...
    private TokenFreezeAccountTransactionBody freeze(@NonNull final AddressIdConverter addressIdConverter,
            @NonNull final Address account, @NonNull final Address token) {
    ...
    private TokenUnfreezeAccountTransactionBody unfreeze(@NonNull final AddressIdConverter addressIdConverter,
            @NonNull final Address account, @NonNull final Address token) {
