...
import com.hedera.node.app.workflows.handle.verifier.CompoundSignatureVerificationFuture;
...
public class FakeHandleContextVerifier implements HandleContextVerifier {
    ...
    public FakeHandleContextVerifier(@NonNull final HederaConfig config) {
