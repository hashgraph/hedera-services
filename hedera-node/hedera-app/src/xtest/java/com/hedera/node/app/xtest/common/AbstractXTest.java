...
package com.hedera.node.app.xtest.common;
...
public abstract class AbstractXTest {
    ...
    private Map<FileID, File> initialFilesWithExchangeRate() {
        ...
        scenarioFiles.put(
                ...
                File.newBuilder()
                        .contents(ExchangeRateSet.PROTOBUF.toBytes(CommonXTestConstants.SET_OF_TRADITIONAL_RATES))
                        .build());
    ...
    private void setupInitialStates() {
        ...
        fakeHederaState.addService(
                FeeService.NAME,
                Map.of("MIDNIGHT_RATES", new AtomicReference<>(CommonXTestConstants.SET_OF_TRADITIONAL_RATES)));
