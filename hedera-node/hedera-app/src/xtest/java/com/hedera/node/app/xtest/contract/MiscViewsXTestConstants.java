...
public class MiscViewsXTestConstants {
    ...
    static final Address ERC_USER_ADDRESS = AbstractContractXTest.asHeadlongAddress(RAW_ERC_USER_ADDRESS.toByteArray());
    ...
    static final Address ERC721_OPERATOR_ADDRESS = AbstractContractXTest.asHeadlongAddress(
            asLongZeroAddress(OPERATOR_ID.accountNumOrThrow()).toArray());
    static final AccountID COINBASE_ID = AccountID.newBuilder().accountNum(98L).build();
    static final Address ERC20_TOKEN_ADDRESS = AbstractContractXTest.asHeadlongAddress(
