...
public class ContractLimitsXTest extends AbstractContractXTest {
    ...
    protected Map<AccountID, Account> initialAccounts() {
        ...
        accounts.put(
                XTestConstants.COINBASE_ID,
                Account.newBuilder().accountId(XTestConstants.COINBASE_ID).build());
        return accounts;
    }

    private TransactionBody synthCreateTxn() {
        return TransactionBody.newBuilder()
                .transactionID(TransactionID.newBuilder().accountID(XTestConstants.SENDER_ID))
