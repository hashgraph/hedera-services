...
public class TestApproverXTest extends AbstractContractXTest {
    ...
    private TransactionBody synthCreateTxn() {
        final var params = INPUTS.encodeElements(
                        XTestConstants.ERC20_TOKEN_ADDRESS, XTestConstants.SENDER_HEADLONG_ADDRESS)
                .array();
        return TransactionBody.newBuilder()
                .transactionID(transactionIdWith(XTestConstants.SENDER_ID))
    ...
    protected Map<AccountID, Account> initialAccounts() {
        ...
        accounts.put(
                ...
                Account.newBuilder()
                        ...
                        .expirationSecond(Instant.now().getEpochSecond() + XTestConstants.THREE_MONTHS_IN_SECONDS)
                        .key(XTestConstants.AN_ED25519_KEY)
                        .alias(XTestConstants.SENDER_ADDRESS)
                        .tinybarBalance(123 * 100 * XTestConstants.ONE_HBAR)
                        .build());
        accounts.put(
