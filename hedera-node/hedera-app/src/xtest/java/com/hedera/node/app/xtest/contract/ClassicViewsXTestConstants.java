...
public class ClassicViewsXTestConstants {
    ...
    static final ByteBuffer EXPECTED_TOKEN_EXPIRY = TOKEN_EXPIRY
            ...
            .encodeElements(
                    ...
                    Tuple.of(
                            EXPIRATION_SECONDS,
                            ConversionUtils.headlongAddressOf(MiscViewsXTestConstants.OPERATOR_ID),
                            AUTORENEW_SECONDS));
    ...
    static final CustomFee FIXED_TOKEN_FEES = CustomFee.newBuilder()
            .fixedFee(FixedFee.newBuilder()
                    .amount(3)
                    .denominatingTokenId(XTestConstants.ERC20_TOKEN_ID)
                    .build())
            .feeCollectorAccountId(MiscViewsXTestConstants.OPERATOR_ID)
            .build();
    ...
    public static final List<Tuple> EXPECTED_FIXED_CUSTOM_FEES = List.of(Tuple.of(
            3L,
            ConversionUtils.headlongAddressOf(XTestConstants.ERC20_TOKEN_ID),
            false,
            false,
            ConversionUtils.headlongAddressOf(MiscViewsXTestConstants.OPERATOR_ID)));
    public static final List<Tuple> EXPECTED_FRACTIONAL_CUSTOM_FEES = List.of(
            Tuple.of(1L, 100L, 2L, 4L, true, ConversionUtils.headlongAddressOf(MiscViewsXTestConstants.OPERATOR_ID)));
    public static final List<Tuple> EXPECTED_ROYALTY_CUSTOM_FEES = List.of(Tuple.of(
            2L,
            50L,
            5L,
            ConversionUtils.headlongAddressOf(XTestConstants.ERC20_TOKEN_ID),
            ...
            .encodeElements(
                    ...
                    Tuple.of(
                            Tuple.of(
                                    ...
                                    LEDGER_ID),
                            1L,
                            ConversionUtils.headlongAddressOf(MiscViewsXTestConstants.ERC_USER_ID),
                            0L,
