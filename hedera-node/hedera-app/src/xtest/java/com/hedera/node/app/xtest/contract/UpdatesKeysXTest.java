...
import static com.hedera.node.app.xtest.contract.XTestConstants.INVALID_ACCOUNT_ADDRESS;
import static com.hedera.node.app.xtest.contract.XTestConstants.INVALID_ACCOUNT_HEADLONG_ADDRESS;
import static com.hedera.node.app.xtest.contract.XTestConstants.INVALID_CONTRACT_ID_KEY;
import static com.hedera.node.app.xtest.contract.XTestConstants.INVALID_ID;
...
public class UpdatesKeysXTest extends AbstractContractXTest {
    ...
    protected void doScenarioOperations() {
        ...
        runHtsCallAndExpectOnSuccess(
                SENDER_BESU_ADDRESS,
                Bytes.wrap(UpdateKeysTranslator.TOKEN_UPDATE_KEYS_FUNCTION
                        .encodeCallWithArgs(AssociationsXTestConstants.A_TOKEN_ADDRESS, TOKEN_KEY)
                        .array()),
                output -> assertEquals(
