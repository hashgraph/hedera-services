...
import com.hedera.node.app.fixtures.workflows.handle.verifier.FakeHandleContextVerifier;
...
public interface BaseScaffoldingModule {
    ...
    @Provides
    @Singleton
    static HandleContextVerifier providesContextVerifier(@NonNull final ConfigProvider configProvider) {
        final var config = configProvider.getConfiguration().getConfigData(HederaConfig.class);
        return new FakeHandleContextVerifier(config);
    }
