...
import contract.AbstractContractXTests;
 ...
 *     by overriding methods like {@link AbstractXTests#initialAccounts()} to return {@link Map}s.</li>
 *     <li>Overriding {@link AbstractXTests#doScenarioOperations()} to run a test scenario that dispatches transactions
 ...
 *     {@link AbstractXTests#assertExpectedAccounts(ReadableKVState)}.</li>
 * </ol>
 */
@ExtendWith(MockitoExtension.class)
public abstract class AbstractXTests {
    ...
    protected Bytes resourceAsBytes(@NonNull final String loc) {
        try {
            try (final var in = AbstractContractXTests.class.getClassLoader().getResourceAsStream(loc)) {
