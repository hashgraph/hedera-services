...
class RebuiltStateTest {
    ...
    //
    //    private RebuiltState subject;
    //
    //    @BeforeEach
    //    void setUp() {
    //        subject = new RebuiltState<>("ALIASES", aliases, lastModifiedTime);
    //    }
    //
    //    @Test
    //    void gettersWork() {
    ...
    //        subject = new RebuiltState<>("ALIASES", lastModifiedTime);
    //        assertEquals(lastModifiedTime, subject.getLastModifiedTime());
    //        assertEquals(ALIASES, subject.getStateKey());
    //    }
    //
    ...
    //        assertTrue(subject.getReadCache().containsKey(alias));
    //
    //        assertEquals(Optional.of(account), subject.get(alias));
