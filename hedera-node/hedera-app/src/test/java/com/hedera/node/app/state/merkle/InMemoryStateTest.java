...
/**
 * Tests for the {@link InMemoryState}. This test class doesn't cover every permutation of the full
 * public API because tests for {@link com.hedera.node.app.state.MutableStateBase} cover everything
 * that doesn't eventually get committed to the underlying data store. So what we really need to
 * test here are unique API and implementations of {@link InMemoryState}.
 */
class InMemoryStateTest {
    ...
    final class MutationsTest {
        ...
        /**
         * Create a new state, put a new value into it, and then commit it. The new value MUST not
        ...
        /**
         * Create a new state, remove an existing value from it, and then commit it. The removed
        ...
        /**
         * Create a new state, remove an existing value from it, and then roll back. The removed
        ...
        void smorgasbord() {
            // Let's read with get and getForModify, remove something, put a modification, and put
            // something new.
            ...
            // Now let's make a fast copy and create a new state and make some more modifications
            // and reads.
                            ...
                            new ClassConstructorPair(
                                    ...
                                    () ->
                                            new InMemoryValue<>(
                                                    CLASS_ID,
                                                    (in, ver) ->
                                                            null, // Bad key parser returns null
                                                    MerkleTestBase::parseString,
                                                    MerkleTestBase::writeString,
                                                    MerkleTestBase::writeString)));
