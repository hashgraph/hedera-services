...
class MerkleStateRegistryTest extends MerkleTestBase {
    ...
    //                                new MerkleStateRegistry(
    //                                        null, path, FIRST_SERVICE, currentVersion,
    // previousVersion);
    //                            })
    ...
    //                    .complete();
    //
    //            // And given that this service exists in the saved state (we create it here to
    // simulate
    //            // loading it)
    ...
    //        //
    //        //            // Finalize the creation and check that the actual merkle stuff exists
    // now
    //        //            reg.migrate(hederaMerkle);
    ...
    //
    //        /**
    //         * This is a rich test. The original state has "A" -> "ART", etc. The new state will
    // map the
    //         * "A" to 0, "B" to 1, etc., so it is changing keys and data types of the keys. It is
    // also
    //         * replacing the science values with the appropriate "space" themed values. And it is
    // moving
    ...
    //                                final ReadableKVState<String, String> oldState =
    ...
    //                                final ReadableKVState<String, String> oldSteamState =
    //                                        oldStates.get(STEAM_STATE_KEY);
    //                                assertThat(oldSteamState).isNotNull();
    //                                final ReadableKVState<String, String> oldCountryState =
    //                                        oldStates.get(STEAM_STATE_KEY);
    ...
    //
    //        @Test
    //        @DisplayName("Register a migration with one state to migrate from which doesn't
    // exist")
    ...
    //        //        @Test
    //        //        @DisplayName(
    //        //                "Register a migration but with many states to migrate from, some of
    // which
    //        // don't"
    //        //                        + " exist")
    ...
    //    ////            // Pretend this is run #1 of the application, and it is some older
    // version.
    //    ////            // We will create a registry, register our state, "migrate" to create
    // things,
    //    ////            // get the InMemoryState for the state, put some stuff into it, and then
    // write
    //    ////            // to "disk".
    ...
    //    ////
    //    ////            final MerkleMap<InMemoryKey<String>, InMemoryValue<String, String>>
    // oldMerkleMap
    //    // =
    ...
    //    ////                    .onMigrate(
    //    ////                            (oldStates, newState) -> {
    //    ////                                // TODO I have a problem with generics here, and it is
    // the
    //    // fault of
    //    ////                                // map. Use my own interface?
    //    ////                                final ReadableState<String, String> old =
    //    ////                                        oldStates.get(oldStateKey);
    //    ////                                // TODO Oh no! The State objects need a way to
    // traverse
    //    // everything
