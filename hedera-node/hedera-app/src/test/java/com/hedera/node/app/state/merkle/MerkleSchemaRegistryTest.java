...
class MerkleSchemaRegistryTest extends MerkleTestBase {
    ...
    //        @Test
    //        @DisplayName(
    //                "Registering two schemas that are different but have the same version number, the" + " second is
    // used")
    ...
    //                        final var fruitDef = StateDefinition.inMemory(FRUIT_STATE_KEY, STRING_CODEC,
    // STRING_CODEC);
