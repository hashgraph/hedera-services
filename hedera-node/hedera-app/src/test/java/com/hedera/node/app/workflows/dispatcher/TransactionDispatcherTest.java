...
class TransactionDispatcherTest {
    ...
    @Mock private WritableStoreFactory writableStoreFactory;
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.contractCreateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                        .contractUpdateInstance(
                                                ContractUpdateTransactionBody.DEFAULT)
                                        .build(),
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.contractUpdateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.contractCallHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                        .contractDeleteInstance(
                                                ContractDeleteTransactionBody.DEFAULT)
                                        .build(),
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.contractDeleteHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.cryptoCreateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.cryptoDeleteHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.fileCreateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.fileUpdateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.fileDeleteHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.fileAppendHandler())
                                                        .preHandle(meta)),
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.tokenCreateHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.tokenBurnHandler())
                                                        .preHandle(eq(meta), any())),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.tokenAccountWipeHandler())
                                                        .preHandle(eq(meta), any())),
                        Arguments.of(
                                TransactionBody.newBuilder()
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.tokenPauseHandler())
                                                        .preHandle(eq(meta), any())),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.tokenUnpauseHandler())
                                                        .preHandle(eq(meta), any())),
                        ...
                        Arguments.of(
                                ...
                                (DispatchToHandler)
                                        (handlers, meta) ->
                                                verify(handlers.fileSystemDeleteHandler())
                                                        .preHandle(meta)),
                        Arguments.of(
                                TransactionBody.newBuilder()
                                        .systemUndelete(
    ...
    private interface DispatchToHandler {
        void dispatchTo(TransactionHandlers handlers, PreHandleContext meta)
                throws PreCheckException;
    }
}
