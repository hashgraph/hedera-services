...
class InMemoryWritableStateTests extends MerkleTestBase {
    ...
    final class ConstructorTest {
        ...
        void nullMetadataThrows() {
            ...
            assertThatThrownBy(() -> new InMemoryWritableKVState<>(null, fruitMerkleMap))
        ...
        void nullMerkleMapThrows() {
            //noinspection DataFlowIssue
            assertThatThrownBy(() -> new InMemoryWritableKVState<>(fruitMetadata, null))
                    .isInstanceOf(NullPointerException.class);
        }
