...
class TestLongCodec implements Codec<Long> {
    ...
    @NonNull
    @Override
    public Long parse(@NonNull ReadableSequentialData input, final boolean strictMode, final int maxDepth) throws ParseException {
    ...
    @Override
    public boolean fastEquals(@NonNull Long value, @NonNull ReadableSequentialData input) throws ParseException {
        Objects.requireNonNull(value);
        Objects.requireNonNull(input);
