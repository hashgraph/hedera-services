...
public class NetworkUtilizationManagerTest {
    ...
    @Mock
    private MonoMultiplierSources multiplierSources;
    ...
    @BeforeEach
    void setUp() {
        subject = new NetworkUtilizationManagerImpl(throttleAccumulator, multiplierSources);
    }
    ...
    void verifyTrackTxn() {
        ...
        verify(multiplierSources).updateMultiplier(consensusNow);
    }
    ...
    void shouldSuccessfullyResetThrottlesAndCongestionLevelsFromState() {
        ...
        verify(multiplierSources).resetGenericCongestionLevelStarts(new Instant[] {Instant.ofEpochSecond(12L, 34)});
        verify(multiplierSources).resetGasCongestionLevelStarts(new Instant[] {Instant.ofEpochSecond(56L, 78)});
    ...
    void shouldSuccessfullySaveThrottlesAndCongestionLevelsToState() {
        ...
        given(multiplierSources.genericCongestionStarts()).willReturn(new Instant[] {Instant.ofEpochSecond(12L, 34)});
        given(multiplierSources.gasCongestionStarts()).willReturn(new Instant[] {Instant.ofEpochSecond(56L, 78)});
