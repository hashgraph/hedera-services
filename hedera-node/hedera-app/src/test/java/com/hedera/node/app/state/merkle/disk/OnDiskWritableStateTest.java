...
class OnDiskWritableStateTest extends MerkleTestBase {
    ...
    //            assertThatThrownBy(() -> new InMemoryWritableState<>(null, fruitMerkleMap))
    ...
    //            assertThatThrownBy(() -> new InMemoryWritableState<>(fruitMetadata, null))
    //                    .isInstanceOf(NullPointerException.class);
    //        }
    //
    //        @Test
    ...
    //        void stateKey() {
    //            final var state = new InMemoryWritableState<>(fruitMetadata, fruitMerkleMap);
    ...
    //        private InMemoryWritableState<String, String> state;
    //
    //        @BeforeEach
    //        void setUp() {
    //            state = new InMemoryWritableState<>(fruitMetadata, fruitMerkleMap);
    ...
    //        void iterate() {
    //            assertThat(state.keys()).toIterable().containsExactlyInAnyOrder(A_KEY, B_KEY,
    // C_KEY);
    //        }
    //    }
    //
    ...
    //            state = new InMemoryWritableState<>(fruitMetadata, fruitMerkleMap);
    //            assertThat(state.getForModify(A_KEY)).get().isEqualTo(APPLE);
    //            state.remove(B_KEY);
    //            assertThat(state.get(C_KEY)).get().isEqualTo(CHERRY);
