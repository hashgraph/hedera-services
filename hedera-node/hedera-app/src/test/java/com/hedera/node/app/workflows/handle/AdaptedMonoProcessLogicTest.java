...
class AdaptedMonoProcessLogicTest extends AppTestBase {
    ...
    //                // payer, status, responseCode, txInfo, payerFuture, nonPayerFutures, nonPayerHollowFutures,
    // innerResult
    //                null, Status.SO_FAR_SO_GOOD, OK, null, verificationFuture(PAYER_KEY_PBJ), Map.of(), Map.of(),
    // null);
    //
