 ...
 */
public final class OnDiskKeySerializerMerkleDb<K> implements KeySerializer<OnDiskKey<K>> {
    ...
    @Deprecated(forRemoval = true)
    public OnDiskKeySerializerMerkleDb() {
        classId = CLASS_ID; // BAD!!
        codec = null;
        md = null;
    }

    public OnDiskKeySerializerMerkleDb(@NonNull final StateMetadata<K, ?> md) {
    ...
    @Override
    @Deprecated(forRemoval = true)
    public int serialize(final OnDiskKey<K> key, final ByteBuffer buffer) {
    ...
    @Override
    @Deprecated(forRemoval = true)
    public OnDiskKey<K> deserialize(@NonNull final ByteBuffer buffer, final long ignored) {
        throw new UnsupportedOperationException();
    }
    ...
    public boolean equals(@NonNull final ByteBuffer byteBuffer, final int ignored, @Nullable final OnDiskKey<K> key) {
        // It should never be called, as OnDiskKey objects should never be stored in the old binary JDB files
        throw new UnsupportedOperationException();
    }
    ...
    public boolean equals(@NonNull final BufferedData bufferedData, @NonNull final OnDiskKey<K> key) {
        ...
        final OnDiskKey<K> other = deserialize(bufferedData);
        // Should it be other.getKey().equals(key.getKey()) ?
