 ...
 */
public final class BlockStreamProducerConcurrentV1 implements BlockStreamProducer {
    /**
    ...
    /** The logger */
    private static final Logger logger = LogManager.getLogger(BlockStreamProducerConcurrentV1.class);
     ...
     */
    @Inject
    public BlockStreamProducerConcurrentV1(
