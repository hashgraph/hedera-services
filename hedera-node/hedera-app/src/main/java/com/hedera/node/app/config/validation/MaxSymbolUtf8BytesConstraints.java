...
public class MaxSymbolUtf8BytesConstraints implements ConfigPropertyConstraint<Integer> {

  public final static String PROPERTY_NAME = TOKENS_MAX_SYMBOL_UTF8_BYTES;
  ...
  public ConfigViolation check(final PropertyMetadata<Integer> propertyMetadata) {
    ...
    if (value > MerkleToken.UPPER_BOUND_SYMBOL_UTF8_BYTES) {
