...
import com.hedera.node.app.workflows.handle.flow.txn.modules.UserTxnModule;
 ...
 */
@Subcomponent(modules = {UserTxnModule.class, DispatchSubcomponentsModule.class})
@UserTxnScope
public interface UserTxnComponent {
    @Subcomponent.Factory
    interface Factory {
        /**
         * The factory for creating user transaction component. All the bindings annotated with @BindsInstance are provided
         * explicitly when constructing the component. This component is responsible for handling the user transaction
         * and handling all tasks that happen only once with a user transaction like advancing consensus clock,
         * hollow account finalization etc.,
         * All the objects provided by dagger used in this component are annotated with @UserTxnScope
         * @param platformState the platform state
         * @param platformEvent the consensus event
         * @param creator the creator node info
         * @param platformTxn the consensus transaction
         * @param consensusTime the consensus time
         * @param lastHandledConsensusTime the last handled consensus time
         * @return the user transaction component
         */
        UserTxnComponent create(
