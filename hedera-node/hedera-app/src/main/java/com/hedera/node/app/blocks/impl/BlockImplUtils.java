...
import static com.hedera.hapi.block.stream.output.StateIdentifier.STATE_ID_TSS_ENCRYPTION_KEY;
        ...
        final var stateId =
                switch (serviceName) {
                    ...
                    case "TssBaseService" -> switch (stateKey) {
                        ...
                        case "TSS_ENCRYPTION_KEY" -> STATE_ID_TSS_ENCRYPTION_KEY.protoOrdinal();
                        default -> UNKNOWN_STATE_ID;
                    };
                    default -> UNKNOWN_STATE_ID;
                };
