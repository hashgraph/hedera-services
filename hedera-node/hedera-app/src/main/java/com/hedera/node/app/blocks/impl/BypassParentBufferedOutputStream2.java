 ...
 */
public class BypassParentBufferedOutputStream2 extends BufferedOutputStream {
    /**
     ...
     */
    public BypassParentBufferedOutputStream2(@NonNull final OutputStream outputStream, @NonNull final byte[] buf) {
    ...
    public void write(@NonNull final byte[] bytes, final int offset, final int length) throws IOException {
        ((FilterOutputStream) this).write(bytes, offset, length);
    }
