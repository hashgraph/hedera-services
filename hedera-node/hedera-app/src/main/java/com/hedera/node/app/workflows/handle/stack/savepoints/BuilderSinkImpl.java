...
public class BuilderSinkImpl implements BuilderSink {
    protected final List<SingleTransactionStreamBuilder> precedingBuilders = new ArrayList<>();
    protected final List<SingleTransactionStreamBuilder> followingBuilders = new ArrayList<>();
    ...
    @Override
    public List<SingleTransactionStreamBuilder> allBuilders() {
        if (precedingBuilders.isEmpty()) {
            return followingBuilders;
        } else {
            final List<SingleTransactionStreamBuilder> allBuilders = new ArrayList<>(precedingBuilders);
    ...
    @Override
    public boolean hasBuilderOtherThan(@NonNull final SingleTransactionStreamBuilder baseBuilder) {
    ...
    @Override
    public void addPrecedingOrThrow(@NonNull final SingleTransactionStreamBuilder builder) {
    ...
    @Override
    public void addFollowingOrThrow(@NonNull final SingleTransactionStreamBuilder builder) {
        requireNonNull(builder);
    ...
    @Override
    public List<SingleTransactionStreamBuilder> followingBuilders() {
        return followingBuilders;
    }
