...
public class BuilderSinkImpl implements BuilderSink {
    protected final List<SingleTransactionBuilder> precedingBuilders = new ArrayList<>();
    protected final List<SingleTransactionBuilder> followingBuilders = new ArrayList<>();
    ...
    @Override
    public List<SingleTransactionBuilder> allBuilders() {
        if (precedingBuilders.isEmpty()) {
            return followingBuilders;
        } else {
            final List<SingleTransactionBuilder> allBuilders = new ArrayList<>(precedingBuilders);
    ...
    @Override
    public boolean hasBuilderOtherThan(@NonNull final SingleTransactionBuilder baseBuilder) {
    ...
    @Override
    public void addPrecedingOrThrow(@NonNull final SingleTransactionBuilder builder) {
    ...
    @Override
    public void addFollowingOrThrow(@NonNull final SingleTransactionBuilder builder) {
        requireNonNull(builder);
    ...
    @Override
    public List<SingleTransactionBuilder> followingBuilders() {
        return followingBuilders;
    }
