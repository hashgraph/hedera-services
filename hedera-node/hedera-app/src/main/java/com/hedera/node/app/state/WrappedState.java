...
/**
 * Used to wrap a {@link ReadableState}, allowing to buffer reads into the {@link WrappedState}.
 *
 * @param <K> The key of the state
 * @param <V> The value of the state
 */
public class WrappedState<K, V> extends StateBase<K, V> {
     ...
     */
    public WrappedState(@NonNull final ReadableState<K, V> delegate) {
