...
public record ProcessUserTransactionResult(
    ...
    public ProcessUserTransactionResult {
        requireNonNull(transactionRecordStream, "transactionRecordStream must not be null");
        requireNonNull(transactionBody, "transactionBody must not be null");
    }
}
