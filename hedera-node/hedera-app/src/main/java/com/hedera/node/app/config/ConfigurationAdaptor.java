...
public class ConfigurationAdaptor implements Configuration {
    ...
    private NodeConfig createNodeConfig() {
        return new NodeConfig(
                ...
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.STATS_ENTITY_UTILS_GAUGE_UPDATE_INTERVAL_MS),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.STATS_THROTTLE_UTILS_GAUGE_UPDATE_INTERVAL_MS),
                propertySource.getTypedProperty(
                        Profile.class, PropertyNames.HEDERA_PROFILES_ACTIVE),
                propertySource.getTypedProperty(
                        Double.class, PropertyNames.STATS_SPEEDOMETER_HALF_LIFE_SECS),
                propertySource.getTypedProperty(
                        Double.class, PropertyNames.STATS_RUNNING_AVG_HALF_LIFE_SECS),
                propertySource.getTypedProperty(
                        String.class, PropertyNames.HEDERA_RECORD_STREAM_LOG_DIR),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.HEDERA_RECORD_STREAM_LOG_PERIOD),
                propertySource.getTypedProperty(
                        Boolean.class, PropertyNames.HEDERA_RECORD_STREAM_IS_ENABLED),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.HEDERA_RECORD_STREAM_QUEUE_CAPACITY),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.QUERIES_BLOB_LOOK_UP_RETRIES),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_PROD_KEEP_ALIVE_TIME),
                ...
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_PROD_KEEP_ALIVE_TIMEOUT),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_PROD_MAX_CONNECTION_AGE),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_PROD_MAX_CONNECTION_AGE_GRACE),
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_PROD_MAX_CONNECTION_IDLE),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.NETTY_PROD_MAX_CONCURRENT_CALLS),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.NETTY_PROD_FLOW_CONTROL_WINDOW),
                propertySource.getTypedProperty(
                        String.class, PropertyNames.DEV_DEFAULT_LISTENING_NODE_ACCOUNT),
                propertySource.getTypedProperty(
                        Boolean.class, PropertyNames.DEV_ONLY_DEFAULT_NODE_LISTENS),
                propertySource.getTypedProperty(
                        String.class, PropertyNames.HEDERA_ACCOUNTS_EXPORT_PATH),
                propertySource.getTypedProperty(
                        Boolean.class, PropertyNames.HEDERA_EXPORT_ACCOUNTS_ON_STARTUP),
                ...
                propertySource.getTypedProperty(
                        Long.class, PropertyNames.NETTY_START_RETRY_INTERVAL_MS),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.STATS_EXECUTION_TIMES_TO_TRACK),
                ...
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.HEDERA_PREFETCH_QUEUE_CAPACITY),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.HEDERA_PREFETCH_THREAD_POOL_SIZE),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.HEDERA_PREFETCH_CODE_CACHE_TTL_SECS),
                propertySource.getTypedProperty(
                        List.class, PropertyNames.STATS_CONS_THROTTLES_TO_SAMPLE),
                propertySource.getTypedProperty(
                        List.class, PropertyNames.STATS_HAPI_THROTTLES_TO_SAMPLE),
                propertySource.getTypedProperty(
                        String.class, PropertyNames.HEDERA_RECORD_STREAM_SIDE_CAR_DIR),
                propertySource.getTypedProperty(Integer.class, PropertyNames.GRPC_WORKFLOWS_PORT),
                propertySource.getTypedProperty(
                        Integer.class, PropertyNames.GRPC_WORKFLOWS_TLS_PORT));
    }
    ...
    private GlobalConfig createGlobalConfig() {
        return new GlobalConfig(
                propertySource.getTypedProperty(Set.class, PropertyNames.WORKFLOWS_ENABLED));
    }
