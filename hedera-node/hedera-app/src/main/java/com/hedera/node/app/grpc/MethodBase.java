...
abstract class MethodBase implements ServerCalls.UnaryMethod<ByteBuffer, ByteBuffer> {
	 ...
	 *
	 * @param session
	 * 		The {@link SessionContext} for this call
	 * @param requestBuffer
	 * 		The {@link ByteBuffer} containing the protobuf bytes for the request
	 * @param responseBuffer
	 * 		A {@link ByteBuffer} into which the response protobuf bytes may be
	 * 		written
	 */
	 ...
	 *
	 * @param metrics
	 * 		The {@link Metrics} object to use to create the counter.
	 * @param nameTemplate
	 * 		A template to use for generating the metric name
	 * @param descriptionTemplate
	 * 		A template to use for generating the metric description
	 * @return The metric
	 */
	 ...
	 *
	 * @param metrics
	 * 		The {@link Metrics} object to use to create the speedometer.
	 * @param nameTemplate
	 * 		A template to use for generating the metric name
	 * @param descriptionTemplate
	 * 		A template to use for generating the metric description
