...
public class RecomputeTypeConverter extends AbstractEnumConfigConverter<RecomputeType> implements
        ConfigConverter<RecomputeType> {

    @NonNull
    @Override
    protected Class<RecomputeType> getEnumType() {
        return RecomputeType.class;
    }
}
