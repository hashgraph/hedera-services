 ...
 * though it were the backend data source. Modifications to this {@link WrappedMutableState} are
 * buffered, along with reads, allowing code to rollback by simply throwing away the wrapper.
 *
 * @param <K> The key
 * @param <V> The value
 */
public class WrappedMutableState<K, V> extends MutableStateBase<K, V> {
     ...
     */
    public WrappedMutableState(@NonNull final WritableState<K, V> delegate) {
