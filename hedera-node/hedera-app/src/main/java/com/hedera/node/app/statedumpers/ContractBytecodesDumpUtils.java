...
//    @NonNull
//    public static List<Account> gatherModContracts(
//            VirtualMap<OnDiskKey<ContractID>, OnDiskValue<Bytecode>> contracts,
//            final VirtualMap<OnDiskKey<AccountID>, OnDiskValue<Account>> accounts,
//            final StateMetadata<AccountID, Account> stateMetadata) {
//        final var contractsToReturn = new ConcurrentLinkedQueue<Account>();
...
//                        contractsToReturn.add(p.left(), p.right(), accounts, stateMetadata);
//                    },
//                    threadCount);
