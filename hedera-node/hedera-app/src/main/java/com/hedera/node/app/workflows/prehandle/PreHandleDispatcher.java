...
import com.hedera.node.app.service.freeze.FreezePreTransactionHandler;
...
public final class PreHandleDispatcher {
    ...
    public PreHandleDispatcher(
        ...
        contractHandler = services.contractService().createPreTransactionHandler(contractState);
        ...
        freezeHandler = services.freezeService().createPreTransactionHandler(freezeState);

        final var networkState = hederaState.createReadableStates(HederaState.NETWORK_SERVICE);
        networkHandler = services.networkService().createPreTransactionHandler(networkState);

        final var scheduledState = hederaState.createReadableStates(HederaState.SCHEDULE_SERVICE);
        scheduleHandler = services.scheduleService().createPreTransactionHandler(scheduledState);
