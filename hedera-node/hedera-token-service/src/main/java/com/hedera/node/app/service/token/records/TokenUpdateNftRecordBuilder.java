 ...
 * transaction.
 */
public interface TokenUpdateNftRecordBuilder extends TokenBaseRecordBuilder {
    /**
     ...
     * @return the builder
     */
    TokenUpdateNftRecordBuilder addAutomaticTokenAssociation(@NonNull final TokenAssociation tokenAssociation);
}
