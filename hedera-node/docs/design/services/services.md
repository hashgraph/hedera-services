...
See also the [Service Modules](service-modules.md) document for more information on how to create a new service module.
...
- **Account Management:** Manage user accounts, including creation, updates, and deletion.
