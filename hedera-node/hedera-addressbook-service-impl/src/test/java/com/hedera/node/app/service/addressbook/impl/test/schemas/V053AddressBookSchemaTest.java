...
class V053AddressBookSchemaTest extends AddressBookTestBase {
    ...
    @Test
    void migrateAsExpected2() throws IOException {
    ...
    @Test
    void migrateAsExpected3() throws IOException {
    ...
    @Test
    void migrateAsExpected4() throws IOException {
    ...
    private void setupMigrationContext2() throws IOException {
        setupMigrationContext();
        accounts.put(
    ...
    private void setupMigrationContext3() throws IOException {
        setupMigrationContext2();
    ...
    private void setupMigrationContext4() throws IOException {
        setupMigrationContext2();
