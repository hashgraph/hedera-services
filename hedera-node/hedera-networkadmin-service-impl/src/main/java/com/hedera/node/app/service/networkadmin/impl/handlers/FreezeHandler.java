...
public class FreezeHandler implements TransactionHandler {
    ...
    public void preHandle(@NonNull final PreHandleContext context) throws PreCheckException {
        ...
        final TransactionID txnId = context.body().transactionID();
        ...
        switch (freezeType) {
            ...
            case FREEZE_ONLY -> verifyFreezeStartTimeIsInFuture(freezeTxn, txnId.transactionValidStart());
            ...
            case FREEZE_UPGRADE, TELEMETRY_UPGRADE -> {
                verifyFreezeStartTimeIsInFuture(freezeTxn, txnId.transactionValidStart());
