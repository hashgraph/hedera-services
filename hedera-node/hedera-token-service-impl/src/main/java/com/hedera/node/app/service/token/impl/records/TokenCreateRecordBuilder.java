 ...
 * transaction.
 */
public interface TokenCreateRecordBuilder extends RecordBuilder<TokenCreateRecordBuilder> {
    /**
     * Returns the number of the created token.
     *
     * @return the number of the created token
     */
    long getCreatedToken();
     ...
     */
    @NonNull
    TokenCreateRecordBuilder setCreatedToken(long num);
}
