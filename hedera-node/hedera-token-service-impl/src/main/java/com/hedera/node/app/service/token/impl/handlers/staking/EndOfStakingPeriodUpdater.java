...
public class EndOfStakingPeriodUpdater {
    ...
    public @Nullable StreamBuilder updateNodes(
            ...
            @NonNull final BiConsumer<Long, Long> weightUpdates) {
        ...
        newNodeInfos.forEach((nodeId, nodeInfo) -> {
            ...
            // maxStake.So, there is no need to clamp the stake value here. The stake can be used to set
            // the weight.
            final long newWeight = nodeInfo.deleted() ? 0 : nodeInfo.stake();
