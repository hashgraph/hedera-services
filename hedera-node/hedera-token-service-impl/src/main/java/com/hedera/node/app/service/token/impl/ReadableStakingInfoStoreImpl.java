...
public class ReadableStakingInfoStoreImpl implements ReadableStakingInfoStore {
    ...
    private final ReadableKVState<AccountID, StakingInfo> stakingInfoState;
    /**
    ...
    @Nullable
    @Override
    public StakingInfo get(@NonNull final AccountID accountId) {
        return stakingInfoState.get(accountId);
    }
}
