    ...
    public void doIn(final TransferContext transferContext) {
        ...
        for (var xfers : op.tokenTransfers()) {
            ...
            for (final var nftTransfer : xfers.nftTransfersOrElse(emptyList())) {
                ...
                final var senderRel = getIfUsable(senderId, tokenId, tokenRelStore, accountStore);
                final var receiverRel = getIfUsable(receiverId, tokenId, tokenRelStore, accountStore);
