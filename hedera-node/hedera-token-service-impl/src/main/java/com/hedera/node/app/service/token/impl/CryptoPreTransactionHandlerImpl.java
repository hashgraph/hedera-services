...
public final class CryptoPreTransactionHandlerImpl implements CryptoPreTransactionHandler {
    ...
    public TransactionMetadata preHandleCryptoCreate(
            @NonNull final TransactionBody tx, @NonNull final AccountID payer) {
    ...
    @Override
    /** {@inheritDoc} */
    public TransactionMetadata preHandleCryptoTransfer(@NonNull final TransactionBody txn, @NonNull final AccountID payer) {
        Objects.requireNonNull(txn);
    ...
    private void handleTokenTransfers(List<AccountAmount> transfers, SigTransactionMetadataBuilder meta) {
    ...
    private void handleHbarTransfers(
            CryptoTransferTransactionBody op, SigTransactionMetadataBuilder meta) {
