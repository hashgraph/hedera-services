...
public interface CryptoTransferRecordBuilder {
    CryptoTransferRecordBuilder transferList(TransferList transferList);

    CryptoTransferRecordBuilder tokenTransferLists(List<TokenTransferList> tokenTransferLists);
}
