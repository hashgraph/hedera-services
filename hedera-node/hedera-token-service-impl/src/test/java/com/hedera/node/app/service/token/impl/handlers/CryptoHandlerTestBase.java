...
public class CryptoHandlerTestBase {
	...
	@Mock
	protected RebuiltStateImpl aliases;
	@Mock
	protected InMemoryStateImpl accounts;
	@Mock
	protected MerkleAccount payerAccount;
	@Mock
	protected States states;
	@Mock
	protected HederaAccountNumbers accountNumbers;
	@Mock
	protected HederaFileNumbers fileNumbers;
	@Mock
