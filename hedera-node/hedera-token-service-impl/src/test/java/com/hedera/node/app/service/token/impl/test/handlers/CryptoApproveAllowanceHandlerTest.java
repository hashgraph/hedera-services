...
//
//        given(accountStore.loadAccount(payerAccount.getId())).willReturn(payerAccount);
//        given(accountStore.loadAccountOrFailWith(ownerAccount.getId(), ResponseCodeEnum.INVALID_ALLOWANCE_OWNER_ID))
...
//        final com.hederahashgraph.api.proto.java.NftAllowance nftAllowance = com.hederahashgraph.api.proto.java.NftAllowance.newBuilder()
//                .setSpender(spender1)
//                .setOwner(ownerId)
//                .setTokenId(token2)
//                .addAllSerialNumbers(List.of(serial1))
//                .build();
//        final com.hederahashgraph.api.proto.java.NftAllowance nftAllowance1 = com.hederahashgraph.api.proto.java.NftAllowance.newBuilder()
//                .setSpender(spender1)
//                .setOwner(ownerId)
//                .setTokenId(token2)
...
//
//        var ownerAcccount = new com.hedera.node.app.service.mono.store.models.Account(Id.fromGrpcAccount(ownerId));
//
//        givenValidTxnCtx();
//
