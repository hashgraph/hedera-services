...
class PreHandleCryptoTransferParityTest {
    ...
    void cryptoTransferReceiverIsMissingAliasScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_RECEIVER_IS_MISSING_ALIAS_SCENARIO), payer);
        assertThat(
    ...
    void tokenTransactWithOwnershipChangeNoSigReqWithFallbackWhenReceiverIsTreasury() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_SIG_REQ_WITH_FALLBACK_WHEN_RECEIVER_IS_TREASURY), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
    ...
    void cryptoTransferSenderIsMissingAliasScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_SENDER_IS_MISSING_ALIAS_SCENARIO), payer);
    ...
    void cryptoTransferNoReceiverSigUsingAliasScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_NO_RECEIVER_SIG_USING_ALIAS_SCENARIO), payer);
    ...
    void cryptoTransferToImmutableReceiverScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_TO_IMMUTABLE_RECEIVER_SCENARIO), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void cryptoTransferTokenToImmutableReceiverScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_TOKEN_TO_IMMUTABLE_RECEIVER_SCENARIO), payer);
        // THEN
    ...
    void cryptoTransferNftFromMissingSenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_NFT_FROM_MISSING_SENDER_SCENARIO), payer);
        // THEN
    ...
    void cryptoTransferNftToMissingReceiverAliasScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_NFT_TO_MISSING_RECEIVER_ALIAS_SCENARIO), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void cryptoTransferNftFromImmutableSenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_NFT_FROM_IMMUTABLE_SENDER_SCENARIO), payer);
        // THEN
        //        assertMetaFailedWith(meta, INVALID_ACCOUNT_ID);
        // NOW
        assertMetaFailedWithReqPayerKeyAnd(meta, ACCOUNT_IS_IMMUTABLE);
    ...
    void cryptoTransferNftToImmutableReceiverScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_NFT_TO_IMMUTABLE_RECEIVER_SCENARIO), payer);
        // THEN
        //        assertMetaFailedWith(meta, INVALID_ACCOUNT_ID);
        // NOW
    ...
    void cryptoTransferFromImmutableSenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_FROM_IMMUTABLE_SENDER_SCENARIO), payer);
        // THEN
        //        assertMetaFailedWith(meta, INVALID_ACCOUNT_ID);
        // NOW
        assertMetaFailedWithReqPayerKeyAnd(meta, ACCOUNT_IS_IMMUTABLE);
    ...
    void cryptoTransferNoReceiverSigScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(CRYPTO_TRANSFER_NO_RECEIVER_SIG_SCENARIO), payer);
        assertThat(sanityRestored(meta.getReqKeys()), contains(DEFAULT_PAYER_KT.asKey()));
    }
    ...
    void cryptoTransferReceiverSigScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(CRYPTO_TRANSFER_RECEIVER_SIG_SCENARIO), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
    ...
    void cryptoTransferReceiverSigUsingAliasScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_RECEIVER_SIG_USING_ALIAS_SCENARIO), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), RECEIVER_SIG_KT.asKey()));
    }
    ...
    void cryptoTransferMissingAccountScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(CRYPTO_TRANSFER_MISSING_ACCOUNT_SCENARIO), payer);
        assertMetaFailedWithReqPayerKeyAnd(meta, INVALID_ACCOUNT_ID);
    }
    ...
    void tokenTransactWithExtantSenders() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(TOKEN_TRANSACT_WITH_EXTANT_SENDERS), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
    ...
    void tokenTransactMovingHbarsWithExtantSender() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_MOVING_HBARS_WITH_EXTANT_SENDER), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactMovingHbarsWithReceiverSigReqAndExtantSender() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_MOVING_HBARS_WITH_RECEIVER_SIG_REQ_AND_EXTANT_SENDER), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(
    ...
    void tokenTransactWithReceiverSigReqAndExtantSenders() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_RECEIVER_SIG_REQ_AND_EXTANT_SENDERS), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(
                        DEFAULT_PAYER_KT.asKey(),
    ...
    void tokenTransactWithMissingSenders() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(TOKEN_TRANSACT_WITH_MISSING_SENDERS), payer);
    ...
    void tokenTransactWithOwnershipChange() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeUsingAlias() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_USING_ALIAS), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeReceiverSigReq() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_RECEIVER_SIG_REQ), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(
                        DEFAULT_PAYER_KT.asKey(),
    ...
    void tokenTransactWithOwnershipChangeNoReceiverSigReq() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_RECEIVER_SIG_REQ), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeNoReceiverSigReqButRoyaltyFeeWithFallbackTriggered() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_RECEIVER_SIG_REQ_BUT_ROYALTY_FEE_WITH_FALLBACK_TRIGGERED), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(
                        DEFAULT_PAYER_KT.asKey(),
    ...
    void tokenTransactWithOwnershipChangeNoSigReqWithFallbackTriggeredButSenderIsTreasury() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_SIG_REQ_WITH_FALLBACK_TRIGGERED_BUT_SENDER_IS_TREASURY), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
    ...
    void tokenTransactWithOwnershipChangeNoReceiverSigReqAndFallbackNotTriggeredDueToHbar() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_RECEIVER_SIG_REQ_AND_FALLBACK_NOT_TRIGGERED_DUE_TO_HBAR), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeNoReceiverSigReqAndFallbackNotTriggeredDueToFt() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_RECEIVER_SIG_REQ_AND_FALLBACK_NOT_TRIGGERED_DUE_TO_FT), payer);
        assertThat(
                sanityRestored(meta.getReqKeys()),
                contains(DEFAULT_PAYER_KT.asKey(), FIRST_TOKEN_SENDER_KT.asKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeNoReceiverSigReqAndMissingToken() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(
                                TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_NO_RECEIVER_SIG_REQ_AND_MISSING_TOKEN), payer);
    ...
    void tokenTransactWithOwnershipChangeMissingSender() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_MISSING_SENDER), payer);
        assertMetaFailedWithReqPayerKeyAnd(meta, INVALID_ACCOUNT_ID);
    }
    ...
    void tokenTransactWithOwnershipChangeMissingReceiver() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(TOKEN_TRANSACT_WITH_OWNERSHIP_CHANGE_MISSING_RECEIVER), payer);
        assertMetaFailedWithReqPayerKeyAnd(meta, INVALID_ACCOUNT_ID, FIRST_TOKEN_SENDER_KT.asKey());
    }
    ...
    void cryptoTransferAllowanceSpenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(
                        txnFrom(CRYPTO_TRANSFER_ALLOWANCE_SPENDER_SCENARIO), payer);
        assertThat(sanityRestored(meta.getReqKeys()), contains(DEFAULT_PAYER_KT.asKey()));
    }
    ...
    void tokenTransferAllowanceSpenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(TOKEN_TRANSFER_ALLOWANCE_SPENDER_SCENARIO), payer);
        assertThat(sanityRestored(meta.getReqKeys()), contains(DEFAULT_PAYER_KT.asKey()));
    }
    ...
    void nftTransferAllowanceSpenderScenario() {
        final var meta =
                subject.preHandleCryptoTransfer(txnFrom(NFT_TRANSFER_ALLOWANCE_SPENDER_SCENARIO), payer);
        assertThat(sanityRestored(meta.getReqKeys()), contains(DEFAULT_PAYER_KT.asKey()));
    }
