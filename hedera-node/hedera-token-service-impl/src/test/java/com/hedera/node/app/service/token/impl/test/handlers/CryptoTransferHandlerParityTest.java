...
class CryptoTransferHandlerParityTest extends ParityTestBase {
    ...
    void cryptoTransferReceiverIsMissingAliasScenario() {
        ...
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertThat(sanityRestoredToPbj(context.getRequiredNonPayerKeys()), contains(FIRST_TOKEN_SENDER_KT.asPbjKey()));
    }
    ...
    void tokenTransactWithOwnershipChangeNoSigReqWithFallbackWhenReceiverIsTreasury() {
        ...
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertTrue(sanityRestoredToPbj(context.getRequiredNonPayerKeys()).contains(NO_RECEIVER_SIG_KT.asPbjKey()));
    }
    ...
    void cryptoTransferNftToImmutableReceiverScenario() {
        ...
        //        assertMetaFailedWith(meta, INVALID_ACCOUNT_ID);
        // NOW
        assertContextFailedWithReqPayerKeyAnd(context, ACCOUNT_IS_IMMUTABLE, FIRST_TOKEN_SENDER_KT.asPbjKey());
    }
    ...
    void cryptoTransferReceiverSigScenario() {
        ...
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertThat(sanityRestoredToPbj(context.getRequiredNonPayerKeys()), contains(RECEIVER_SIG_KT.asPbjKey()));
    }
    ...
    void tokenTransactWithExtantSenders() {
        ...
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertThat(sanityRestoredToPbj(context.getRequiredNonPayerKeys()), contains(SECOND_TOKEN_SENDER_KT.asPbjKey()));
    }
    ...
    void tokenTransactMovingHbarsWithReceiverSigReqAndExtantSender() {
        ...
        assertThat(
                ...
                contains(FIRST_TOKEN_SENDER_KT.asPbjKey(), RECEIVER_SIG_KT.asPbjKey()));
    }
    ...
    void tokenTransactWithMissingSenders() {
        ...
        final var context = new PreHandleContext(readableAccountStore, theTxn);
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertContextFailedWithReqPayerKeyAnd(context, INVALID_ACCOUNT_ID, FIRST_TOKEN_SENDER_KT.asPbjKey());
    }
    ...
    void tokenTransactWithOwnershipChangeNoSigReqWithFallbackTriggeredButSenderIsTreasury() {
        ...
        subject.preHandle(context, readableAccountStore, readableTokenStore);
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertTrue(sanityRestoredToPbj(context.getRequiredNonPayerKeys()).contains(MISC_ACCOUNT_KT.asPbjKey()));
    }
    ...
    private void assertContextFailedWithReqPayerKeyAnd(
        ...
        assertEquals(expectedFailure, context.getStatus());
        assertEquals(sanityRestoredToPbj(context.getPayerKey()), DEFAULT_PAYER_KT.asPbjKey());
        assertThat(sanityRestoredToPbj(context.getRequiredNonPayerKeys()), contains(aNonPayerKey));
    }
}
