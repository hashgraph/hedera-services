...
import com.hedera.node.app.service.token.impl.staking.StakingUtils;
...
class StakingUtilsTest {
    ...
    void readableNonZeroHistoryFromEmptyRewards() {
        final var result = StakingUtils.readableNonZeroHistory(Collections.emptyList());
        Assertions.assertThat(result).isEqualTo("[]");
    }

    @Test
    void readableNonZeroHistoryFromNoZeroRewards() {
        final var result = StakingUtils.readableNonZeroHistory(List.of(1L, 2L, 3L, 4L, 5L));
        Assertions.assertThat(result).isEqualTo("[1, 2, 3, 4, 5]");
    }

    @Test
    void readableNonZeroHistoryFromOneZeroRewards() {
        final var result = StakingUtils.readableNonZeroHistory(List.of(1L, 2L, 3L, 0L, 5L));
        Assertions.assertThat(result).isEqualTo("[1, 2, 3]");
    }

    @Test
    void readableNonZeroHistoryFromMultipleZeroRewards() {
        final var result = StakingUtils.readableNonZeroHistory(List.of(1L, 2L, 0L, 0L, 3L, 0L, 0L, 4L, 0L));
    ...
    void calculatesUpdatedRewardsSumHistoryWithRateLimiting() {
        ...
        final var result = StakingUtils.calculateUpdatedRewardSumHistory(STAKING_INFO, rewardRate, maxRewardRate, true);
    ...
    void calculatesUpdatedRewardsSumHistoryAsExpectedForNodeWithGreaterThanMinStakeAndNoMoreThanMaxStake() {
        ...
        final var result = StakingUtils.calculateUpdatedRewardSumHistory(STAKING_INFO, rewardRate, Long.MAX_VALUE, true);
    ...
    void calculatesUpdatedRewardsSumHistoryAsExpectedForNodeWithGreaterThanMaxStake() {
        ...
        final var stakingInfo = STAKING_INFO.copyBuilder().stakeRewardStart(2 * STAKING_INFO.maxStake()).build();
        final var result = StakingUtils.calculateUpdatedRewardSumHistory(stakingInfo, rewardRate, Long.MAX_VALUE, true);
    ...
    void usesBiArithmeticForRewardRateDownScaling() {
        ...
        final var stakingInfo = STAKING_INFO.copyBuilder().stakeRewardStart(excessStake).build();
        final var result = StakingUtils.calculateUpdatedRewardSumHistory(stakingInfo, rewardRate, Long.MAX_VALUE, true);
    ...
    void calculatesUpdatedSumHistoryAsExpectedForNodeWithLessThanMinStakeWhenMinIsNotReqForReward() {
        ...
        final var stakingInfo = STAKING_INFO.copyBuilder().stake(0).stakeRewardStart(STAKING_INFO.minStake() - 1).build();
        final var result = StakingUtils.calculateUpdatedRewardSumHistory(stakingInfo, rewardRate, Long.MAX_VALUE, false);
    ...
    void computeStakeNullArg() {
        Assertions.assertThatThrownBy(() -> StakingUtils.computeStake(null)).isInstanceOf(NullPointerException.class);
    }
    ...
    void computeStakeTotalStakeGreaterThanMaxStake() {
        ...
        final var result = StakingUtils.computeStake(input);
    ...
    void computeStakeTotalStakeLessThanMinStake() {
        final var input = STAKING_INFO.copyBuilder().minStake(STAKE_TO_REWARD + STAKE_TO_NOT_REWARD + 1).build();
    ...
    void computeStakeTotalStakeInBetweenMinStakeAndMaxStake() {
        final var input = STAKING_INFO.copyBuilder().minStake(STAKE_TO_REWARD + STAKE_TO_NOT_REWARD - 1).maxStake(STAKE_TO_REWARD + STAKE_TO_NOT_REWARD + 1).build();
