...
import com.hedera.node.app.service.mono.contracts.ContractsModule.V_0_50;
...
@Module
public interface ContractsV_0_50Module {

    String EVM_VERSION_0_50  = "v0.50";
    ...
    static Operation bindCallCodeOperation(
            ...
            @V_0_50 final BiPredicate<Address, MessageFrame> addressValidator,
    ...
    static Operation bindDelegateCallOperation(
            ...
            @V_0_50 BiPredicate<Address, MessageFrame> addressValidator,
            final @Named("HederaSystemAccountDetector") Predicate<Address> hederaSystemAccountDetector) {
    ...
    @Singleton
    @V_0_50
    static EVM provideV_0_50EVM(@V_0_50 Set<Operation> hederaOperations, GasCalculator gasCalculator) {
