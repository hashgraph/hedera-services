...
public class StakeStartupHelper {
  ...
  /**
   * Given the genesis address book, prepares the network's staking infrastructure to work with this
   * address book.
   *
  ...
  /**
   * Given the current address book and a mutable staking info map, updates the map to have exactly
   * one entry for each node id in the address book. This could both remove and add entries to the
   * map.
   *
  ...
  /**
   * Given a mutable accounts map, staking info map, and network context, re-computes any requested
   * staking metadata based on the value of the {@code staking.startupHelper.recompute} property.
   *
