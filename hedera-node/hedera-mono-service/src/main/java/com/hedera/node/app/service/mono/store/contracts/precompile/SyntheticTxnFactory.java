...
public class SyntheticTxnFactory {
   ...
   * {@link TransactionBody} for use during precheck. In the case of a {@code ContractCreate}, if
   * the call data is missing, replaces it with dummy initcode (it is not the job of precheck to
   * look up initcode from a file).
   *
   ...
   * synthesize a builder for an appropriate HAPI TransactionBody---ContractCall if the given {@code
   * ethTxData} has a "to" address, and ContractCreate otherwise.
   *
