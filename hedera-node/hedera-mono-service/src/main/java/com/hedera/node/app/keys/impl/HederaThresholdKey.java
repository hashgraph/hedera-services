...
public class HederaThresholdKey implements ReplHederaKey {
    ...
    public HederaThresholdKey asReadOnly() {
        final var copy = new HederaThresholdKey(this);
        copy.immutable = true;
        return copy;
    }
    ...
    public void setThreshold(final int threshold) {
        throwIfImmutable("Tried to set the threshold on an immutable HederaThresholdKey");
        this.threshold = threshold;
    }

    @StateSetter
    public void setKeys(final HederaKeyList keys) {
        throwIfImmutable("Tried to set the keys on an immutable HederaThresholdKey");
        this.keys = keys;
    }
}
