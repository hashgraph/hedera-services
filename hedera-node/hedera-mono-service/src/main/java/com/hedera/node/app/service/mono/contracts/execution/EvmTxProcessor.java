...
abstract class EvmTxProcessor extends HederaEvmTxProcessor {
	...
	private static <T> Map<String, Supplier<T>> convert(final Map<String, Provider<T>> map) {
		final Map<String, Supplier<T>> result = new HashMap<>();
	 ...
	 * @param receiver
	 * 		the priority form of the receiving {@link Address} (i.e., EIP-1014 if
	 ...
	 * 		transaction value
	 * @param payload
	 * 		transaction payload. For Create transactions, the bytecode + constructor
	 * 		arguments
	 ...
	 * 		the mirror form of the receiving {@link Address}; or the newly created
	 * 		address
