...
public class StakingUtils {
    ...
    public static long getAccountStakeeNum(@NotNull final Map<AccountProperty, Object> changes) {
        final var entityId = (long) changes.getOrDefault(AccountProperty.STAKED_ID, 0L);
    ...
    public static long finalBalanceGiven(
        ...
        if (changes.containsKey(AccountProperty.BALANCE)) {
            return (long) changes.get(AccountProperty.BALANCE);
        } else {
    ...
    public static boolean finalDeclineRewardGiven(
        ...
        if (changes.containsKey(AccountProperty.DECLINE_REWARD)) {
            return (Boolean) changes.get(AccountProperty.DECLINE_REWARD);
        } else {
    ...
    public static boolean hasStakeMetaChanges(
            @NotNull final Map<AccountProperty, Object> changes,
            @Nullable final HederaAccount account) {
        return (changes.containsKey(AccountProperty.DECLINE_REWARD)
                        && (account == null
