...
public class StakePeriodManager {
  ...
  /**
   * Given the current and new staked ids for an account, as well as if it received a reward in this
   * transaction, returns the new {@code stakePeriodStart} for this account:
   *
   * <ol>
