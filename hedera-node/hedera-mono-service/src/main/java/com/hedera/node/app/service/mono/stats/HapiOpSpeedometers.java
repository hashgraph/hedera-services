...
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_ANSWERED_DESC_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_ANSWERED_NAME_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_DEPRECATED_TXNS_DESC;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_DEPRECATED_TXNS_NAME;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_HANDLED_DESC_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_HANDLED_NAME_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_RECEIVED_DESC_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_RECEIVED_NAME_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_SUBMITTED_DESC_TPL;
import static com.hedera.node.app.service.mono.stats.ServicesStatsConfig.SPEEDOMETER_SUBMITTED_NAME_TPL;
...
public class HapiOpSpeedometers {
    ...
    public void registerWith(Platform platform) {
        ...
        receivedDeprecatedTxns = platform.getContext().getMetrics().getOrCreate(receivedDeprecatedTxnsConfig);
    ...
    private void registerSpeedometers(
        ...
        configs.forEach((function, config) ->
                speedometers.put(function, platform.getContext().getMetrics().getOrCreate(config)));
    }
