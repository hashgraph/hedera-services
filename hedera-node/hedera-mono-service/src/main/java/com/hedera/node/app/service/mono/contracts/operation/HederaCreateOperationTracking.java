...
import com.hedera.node.app.service.evm.contracts.operations.CreateOperationTracking;
...
public class HederaCreateOperationTracking extends CreateOperationTracking {
    ...
    @Inject
    public HederaCreateOperationTracking(
