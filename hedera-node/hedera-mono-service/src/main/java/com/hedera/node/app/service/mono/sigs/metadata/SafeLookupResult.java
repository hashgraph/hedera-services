...
public class SafeLookupResult<T> {
    ...
    private SafeLookupResult(final KeyOrderingFailure failure) {
        this.failure = failure;
        metadata = Optional.empty();
    }

    public SafeLookupResult(final T metadata) {
        this.failure = NONE;
        this.metadata = Optional.of(metadata);
    }

    @SuppressWarnings("unchecked")
    public static <R> SafeLookupResult<R> failure(final KeyOrderingFailure type) {
