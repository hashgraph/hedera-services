...
@FunctionalInterface
public interface LegacyKeyValidator {
    /**
     * Checks if an implicit key for the target address is active in the given context; where this
     * key is assumed to potentially have legacy contract activations. Note the address may
     * represent any entity type; and the key may implicitly be of any sort (account key, admin key,
     * supply key, etc.)
     *
