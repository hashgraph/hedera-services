...
public record ContractStoragePriceTiers(
	 ...
	 *
	 * @param spec
	 * 		a comma-separated list of price tiers as described above
	 * @param freeTierLimit
	 * 		the number of key/value pairs at which a contract starts paying rent
	 * @param maxTotalKvPairs
	 * 		the maximum allowed key/value pairs in the system
	 * @param referenceLifetime
	 * 		the lifetime assumed by the prices in the comma-separated spec
	 ...
	 * @param usageInfo
	 * 		the information on the pending usage to be charged
