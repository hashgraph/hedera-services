...
public class InfrastructureInitializer {
	...
	public static void initializeBundle(
		...
		if (config.containsKey("userAccounts")) {
			initSomeAccounts(bundle.get(InfrastructureType.ACCOUNTS_LEDGER), (int) config.get("userAccounts"));
		}
	}
	...
	public static void initializeStakeableAccounts(
		...
		backingAccounts.put(Constructables.STAKING_REWARD_ID, accountWith(250_000_000L * 100_000_000L));
