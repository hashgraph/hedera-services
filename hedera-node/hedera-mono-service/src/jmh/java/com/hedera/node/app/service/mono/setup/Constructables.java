...
public class Constructables {
    ...
    public static final AccountID FUNDING_ID = InfrastructureInitializer.accountIdWith(98L);
    public static final AccountID STAKING_REWARD_ID = InfrastructureInitializer.accountIdWith(800L);
