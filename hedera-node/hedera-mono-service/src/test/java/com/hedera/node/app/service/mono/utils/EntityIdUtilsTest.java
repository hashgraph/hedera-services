...
class EntityIdUtilsTest {
    ...
    void observesUnalising() {
        ...
        final AtomicReference<ByteString> observer = new AtomicReference<>();
    ...
    @ParameterizedTest
    void canParseValidRanges(final String literal, final long left, final long right) {
    ...
    @ParameterizedTest
    void rejectsInvalidRanges(final String literal, final String iaeMsg) {
        try {
