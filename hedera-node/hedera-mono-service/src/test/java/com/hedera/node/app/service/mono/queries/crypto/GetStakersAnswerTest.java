...
class GetStakersAnswerTest {
    ...
    void respectsTypeOfUnsupportedQuery() {
        // given:
        final Query costAnswer = getStakersQuery(COST_ANSWER);
        final Query answerOnly = getStakersQuery(ANSWER_ONLY);
    ...
    private Query getStakersQuery(final ResponseType type) {
        final CryptoGetStakersQuery.Builder op = CryptoGetStakersQuery.newBuilder();
