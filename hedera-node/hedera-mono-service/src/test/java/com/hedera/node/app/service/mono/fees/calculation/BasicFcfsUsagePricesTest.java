...
class BasicFcfsUsagePricesTest {
    ...
    void returnsExpectedPriceSequence() {
        ...
        // when:
        final var actual = subject.activePricingSequence(ContractCall);
    ...
    private TransactionFeeSchedule tfsWithOldAndNewPriceData(
            final FeeData oldPrices, final FeeData newPrices, final SubType... newPriceTypes) {
        final var tfs = TransactionFeeSchedule.newBuilder().setFeeData(oldPrices);
        for (final var priceType : newPriceTypes) {
