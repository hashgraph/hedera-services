...
public class SerializableSemVersSerdeTests extends SelfSerializableDataTests<SerializableSemVers> {
    @Override
    ...
    protected Optional<BiConsumer<SerializableSemVers, SerializableSemVers>> customAssertEquals() {
        return Optional.of(SerializableSemVersSerdeTests::assertEqualVersions);
    }
