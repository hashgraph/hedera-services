...
class RedirectViewExecutorTest {
	...
	void computeCostedBALANCE_OF_TOKEN() {
		final Bytes nestedInput = prerequisites(ABI_ID_ERC_BALANCE_OF_TOKEN, fungibleTokenAddress);
	...
	void computeCostedOWNER_OF_NFT() {
		final Bytes nestedInput = prerequisites(ABI_ID_ERC_OWNER_OF_NFT, nonfungibleTokenAddress);
	...
	void computeCostedTOKEN_URI_NFT() {
		final Bytes nestedInput = prerequisites(ABI_ID_ERC_TOKEN_URI_NFT, nonfungibleTokenAddress);
	...
	Bytes prerequisites(final int descriptor, final Bytes tokenAddress) {
		...
		final Bytes nestedInput = Bytes.of(Integers.toBytes(descriptor));
		final Bytes input =
				Bytes.concatenate(
