...
class TxnAwareRatesManagerTests {
    ...
    void allowsLargeValidChangeFromMaster() {
        ...
        // when:
        final var verdict = subject.preUpdate(exchangeRates, validRates);
    ...
    void rejectsInvalidBytes() {
        ...
        // when:
        final var verdict = subject.preUpdate(exchangeRates, invalidBytes);
    ...
    void rubberstampsIrrelevantFiles() {
        ...
        // when:
        final var verdict = subject.preUpdate(otherFile, invalidBytes);
    ...
    private void givenPayer(final AccountID id) {
