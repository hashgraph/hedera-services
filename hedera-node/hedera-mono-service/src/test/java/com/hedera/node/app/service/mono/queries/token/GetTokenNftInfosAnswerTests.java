...
class GetTokenNftInfosAnswerTests {
    GetTokenNftInfosAnswer subject = new GetTokenNftInfosAnswer();
    ...
    void extractsValidity() {
        ...
        final Response response = Response.newBuilder()
                .setTokenGetNftInfos(TokenGetNftInfosResponse.newBuilder()
    ...
    void respectsTypeOfUnsupportedQuery() {
        ...
        assertEquals(
                COST_ANSWER,
                costAnswerResponse.getTokenGetNftInfos().getHeader().getResponseType());
        assertEquals(
                ANSWER_ONLY,
                answerOnlyResponse.getTokenGetNftInfos().getHeader().getResponseType());
        // and:
    ...
    private Query getQuery(final ResponseType type) {
        final TokenGetNftInfosQuery.Builder op = TokenGetNftInfosQuery.newBuilder();
