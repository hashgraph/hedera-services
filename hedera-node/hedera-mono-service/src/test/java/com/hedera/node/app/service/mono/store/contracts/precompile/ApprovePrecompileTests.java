...
class ApprovePrecompileTests {
    ...
    void decodeApproveForNFTERC() {
        final var decodedInput = decodeTokenApprove(APPROVE_NFT_INPUT_ERC, TOKEN_ID, false, identity(), ledgers);
    ...
    void decodeApproveForTokenERC() {
        ...
        final var decodedInput = decodeTokenApprove(APPROVE_TOKEN_INPUT_ERC, TOKEN_ID, true, identity(), ledgers);
    ...
    void decodeApproveForNFTHAPI() {
        ...
        final var decodedInput = decodeTokenApprove(APPROVE_NFT_INPUT_HAPI, null, false, identity, ledgers);
    ...
    void decodeApproveForTokenAHPI() {
        ...
        final var decodedInput = decodeTokenApprove(APPROVE_TOKEN_INPUT_HAPI, null, true, identity, ledgers);
