...
import com.hedera.node.app.service.mono.store.contracts.precompile.utils.KeyActivationTests;
import com.hedera.node.app.service.mono.store.contracts.precompile.utils.LegacyActivationTests;
import com.hedera.node.app.service.mono.store.contracts.precompile.utils.LegacyKeyActivationTests;
...
class AbstractTokenUpdatePrecompileTests {
    @Mock
    ...
    void validatesAdminKeyAndNewTreasury() {
        final var captor = forClass(KeyActivationTests.class);
        final var legacyCaptor = forClass(LegacyKeyActivationTests.class);
