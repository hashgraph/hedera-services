...
public class MerkleNetworkContextSerdeTests extends SelfSerializableDataTests<MerkleNetworkContext> {
    ...
    protected Optional<BiConsumer<MerkleNetworkContext, MerkleNetworkContext>> customAssertEquals() {
        return Optional.of(MerkleNetworkContextTests::assertEqualContexts);
    }
