...
import static com.hedera.node.app.service.mono.stream.RecordStreamRecoveryAndReplayTests.ALL_EXPECTED_RSOS_ASSET;
import static com.hedera.node.app.service.mono.stream.RecordStreamRecoveryAndReplayTests.ON_DISK_FILES_LOC;
import static com.hedera.node.app.service.mono.stream.RecordStreamRecoveryAndReplayTests.RECOVERY_STREAM_ONLY_RSOS_ASSET;
import static com.hedera.node.app.service.mono.stream.RecordStreamRecoveryAndReplayTests.loadRsosFrom;
import static com.hedera.node.app.service.mono.stream.RecordStreamRecoveryAndReplayTests.rsoFrom;
...
class RecoveryRecordsWriterTests {
    static final String CORRUPT_ON_DISK_FILES_LOC =
            RecordStreamRecoveryAndReplayTests.RECOVERY_ASSETS_LOC + File.separator + "corruptOnDiskFiles";
