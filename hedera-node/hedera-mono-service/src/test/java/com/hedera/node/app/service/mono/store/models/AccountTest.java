...
class AccountTest {
    ...
    void invalidCanonicalAddresses() {
        final Address untranslatedAddress =
    ...
    void accountEqualsCheck() {
        // setup:
        final var account = new Account(subjectId);
        ...
        // when:
        final var actualResult = subject.equals(account);
    ...
    void accountHashCodeCheck() {
        ...
        final var otherSubject = new Account(subjectId);
        ...
        // when:
        final var actualResult = subject.hashCode();
