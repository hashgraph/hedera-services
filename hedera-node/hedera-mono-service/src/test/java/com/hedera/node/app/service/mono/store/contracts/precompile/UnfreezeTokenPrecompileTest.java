...
class UnfreezeTokenPrecompileTest {
    ...
    void gasRequirementReturnsCorrectValueForUnfreezeToken() {
        ...
        unfreezeTokenPrecompile.when(() -> decodeUnfreeze(any(), any())).thenReturn(tokenFreezeUnFreezeWrapper);
    ...
    private void givenFreezeUnfreezeContext() {
        ...
        given(infrastructureFactory.newUnfreezeLogic(accountStore, tokenStore)).willReturn(unFreezeLogic);
