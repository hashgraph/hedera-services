...
public class RecordsRunningHashLeafSerdeTests extends SelfSerializableDataTests<RecordsRunningHashLeaf> {
    @Override
    ...
    protected Optional<BiConsumer<RecordsRunningHashLeaf, RecordsRunningHashLeaf>> customAssertEquals() {
        return Optional.of(RecordsRunningHashLeafSerdeTests::assertEqualLeaves);
    }
