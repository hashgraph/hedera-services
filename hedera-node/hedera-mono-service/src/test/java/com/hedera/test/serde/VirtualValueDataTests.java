...
public abstract class VirtualValueDataTests<T extends VirtualValue> extends SelfSerializableDataTests<T> {
    @ParameterizedTest
    ...
    protected static class AsReadOnlyArgumentsProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(final ExtensionContext context) {
            ...
            final var ref = (VirtualValueDataTests<? extends VirtualValue>) instantiate(testType);
