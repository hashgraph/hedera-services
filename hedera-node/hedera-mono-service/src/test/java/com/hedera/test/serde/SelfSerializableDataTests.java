 ...
 *
 * <p>A typical subclass (c.f., {@link MerkleAccountStateSerdeTests}) will use a {@link
 ...
 */
public abstract class SelfSerializableDataTests<T extends SelfSerializable> {
    ...
    static class SupportedVersionsArgumentsProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(final ExtensionContext context) {
            ...
            final var ref = (SelfSerializableDataTests<? extends SelfSerializable>) instantiate(testType);
    ...
    private static <T extends SelfSerializable> List<Arguments> allTestCasesFrom(
            final SelfSerializableDataTests<T> refTest) {
    ...
    private static <T extends SelfSerializable> List<Arguments> testCasesFrom(
            final SelfSerializableDataTests<T> refTest, final boolean onlyCurrent) {
