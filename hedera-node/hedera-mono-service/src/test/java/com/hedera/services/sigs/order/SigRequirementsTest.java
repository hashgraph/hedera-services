...
import com.hedera.services.sigs.metadata.*;
...
import static com.hedera.test.factories.scenarios.CryptoAllowanceScenarios.*;
...
class SigRequirementsTest {
    ...
    private void setupFor(
        ...
        final var accountsAdapter = AccountStorageAdapter.fromInMemory(accounts);
        subject =
                new SigRequirements(
