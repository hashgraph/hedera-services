 ...
 */
package com.hedera.node.app.service.mono.testFixtures.factories.txns;
...
import com.hedera.node.app.service.mono.testFixtures.factories.keys.NodeFactory;
import com.hedera.node.app.service.mono.testFixtures.factories.sigs.SigFactory;
import com.hedera.node.app.service.mono.testFixtures.factories.sigs.SigMapGenerator;
...
public abstract class SignedTxnFactory<T extends SignedTxnFactory<T>> {
    ...
    public static final KeyTree DEFAULT_PAYER_KT = KeyTree.withRoot(NodeFactory.list(NodeFactory.ed25519()));
