...
import com.hedera.node.app.service.mono.testFixtures.factories.txns.TokenWipeFactory;
...
public enum TokenWipeScenarios implements TxnHandlingScenario {
    VALID_WIPE_WITH_EXTANT_TOKEN {
        ...
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(
                    TokenWipeFactory.newSignedTokenWipe()
    ...
    WIPE_WITH_MISSING_TOKEN {
        ...
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(
                    TokenWipeFactory.newSignedTokenWipe().wiping(MISSING_TOKEN, MISC_ACCOUNT).get());
        }
    },
