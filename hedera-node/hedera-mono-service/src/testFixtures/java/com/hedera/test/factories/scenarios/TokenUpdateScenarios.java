...
public enum TokenUpdateScenarios implements TxnHandlingScenario {
    UPDATE_WITH_NO_KEYS_AFFECTED {
        ...
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenUpdate().updating(KNOWN_TOKEN_NO_SPECIAL_KEYS).get());
        }
    },
    ...
    UPDATE_WITH_MISSING_TOKEN_ADMIN_KEY {
        @Override
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenUpdate().updating(KNOWN_TOKEN_IMMUTABLE).get());
        }
    },
