...
public class TestFixturesKeyLookup implements AccountKeyLookup {
    @NonNull
    @Override
    public KeyOrLookupFailureReason getKey(@NonNull AccountID idOrAlias) {
        return null;
    }

    @NonNull
    @Override
    public KeyOrLookupFailureReason getKeyIfReceiverSigRequired(@NonNull AccountID idOrAlias) {
        return null;
    }

    @NonNull
    @Override
    public KeyOrLookupFailureReason getKey(@NonNull ContractID idOrAlias) {
        return null;
    }

    @NonNull
    @Override
    public KeyOrLookupFailureReason getKeyIfReceiverSigRequired(@NonNull ContractID idOrAlias) {
        return null;
    }
