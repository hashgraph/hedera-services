...
public enum TokenCreateScenarios implements TxnHandlingScenario {
    TOKEN_CREATE_WITH_ADMIN_ONLY {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().nonPayerKts(TOKEN_ADMIN_KT).get());
        }
    },
    ...
    TOKEN_CREATE_WITH_AUTO_RENEW {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().missingAdmin().autoRenew(MISC_ACCOUNT).get());
        }
    },
    TOKEN_CREATE_WITH_AUTO_RENEW_AS_PAYER {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().missingAdmin().autoRenew(DEFAULT_PAYER).get());
        }
    },
    ...
    TOKEN_CREATE_WITH_MISSING_AUTO_RENEW {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().missingAdmin().autoRenew(MISSING_ACCOUNT).get());
        }
    },
    ...
    TOKEN_CREATE_WITH_MISSING_TREASURY {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().missingAdmin().treasury(MISSING_ACCOUNT).get());
        }
    },
    TOKEN_CREATE_WITH_TREASURY_AS_PAYER {
        public PlatformTxnAccessor platformTxn() throws Throwable {
            return PlatformTxnAccessor.from(newSignedTokenCreate().missingAdmin().treasury(DEFAULT_PAYER).get());
        }
    },
