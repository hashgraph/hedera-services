...
public class InfrastructureManager {
	...
	public static InfrastructureBundle loadOrCreateBundle(
			...
			Collection<InfrastructureType> types
	) {
	...
	private static String bundleDirFor(
		...
		final var sb = new StringBuilder("bundle")
				.append(InfrastructureBundle.codeFor(types));
		config.keySet().stream().sorted().forEach(key ->
				sb.append("_").append(key).append(config.get(key)));
