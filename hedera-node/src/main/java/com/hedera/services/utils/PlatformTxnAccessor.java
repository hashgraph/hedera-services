 ...
 * com.swirlds.common.SwirldTransaction} whose contents is <i>supposed</i> to be a Hedera Services
 * gRPC {@link Transaction}. (The constructor of this class immediately tries to parse the {@code
 * byte[]} contents of the txn, and propagates any protobuf exceptions encountered.)
 *
...
public class PlatformTxnAccessor extends SignedTxnAccessor {
  ...
  /**
   * Convenience static factory for a txn whose {@code byte[]} contents are <i>certain</i> to be a
   * valid serialized gRPC txn.
   *
