 ...
 * RationalizedSigMeta#forPayerOnly(JKey, List)}, and {@link
 * RationalizedSigMeta#forPayerAndOthers(JKey, List, List)}. (There is no factory for just
 * other-party signatures, because without a payer signature {@link
...
public class RationalizedSigMeta {
  ...
  public static RationalizedSigMeta forPayerOnly(
      JKey payerReqSig, List<TransactionSignature> rationalizedSigs) {
    return forPayerAndOthers(payerReqSig, null, rationalizedSigs);
  }

  public static RationalizedSigMeta forPayerAndOthers(
      JKey payerReqSig, List<JKey> othersReqSigs, List<TransactionSignature> rationalizedSigs) {
    return new RationalizedSigMeta(
        payerReqSig, othersReqSigs, rationalizedSigs, pkToSigMapFrom(rationalizedSigs));
  }
