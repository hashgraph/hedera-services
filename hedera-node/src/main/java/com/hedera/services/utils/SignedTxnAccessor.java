...
public class SignedTxnAccessor implements TxnAccessor {
  ...
  static Function<TransactionBody, HederaFunctionality> functionExtractor =
      txn -> {
        try {
  ...
  public ScheduleID getScheduleRef() {
    throw new UnsupportedOperationException(
        "Only the TriggeredTxnAccessor implementation can refer to a schedule");
  }
  ...
  public CryptoTransferMeta availXferUsageMeta() {
    if (function != CryptoTransfer) {
      throw new IllegalStateException(
          "Cannot get CryptoTransfer metadata for a " + function + " accessor");
    }
  ...
  public SubmitMessageMeta availSubmitUsageMeta() {
    if (function != ConsensusSubmitMessage) {
      throw new IllegalStateException(
          "Cannot get ConsensusSubmitMessage metadata for a " + function + " accessor");
    }
  ...
  private void setXferUsageMeta() {
    ...
    xferUsageMeta =
        new CryptoTransferMeta(1, totalTokensInvolved, totalTokenTransfers, numNftOwnershipChanges);
  }
