...
/**
 * Defines a type able to describe sub-lists of the unique tokens that share one of two common
 * characteristics:
 *
 * <ol>
 *   <li>All the unique tokens belong to the same non-fungible unique token type.
 *   <li>All the unique tokens have the same owner.
 * </ol>
 *
 * The ordering of these sub-lists are only guaranteed stable between queries if no change is made
 * to the family of unique tokens in question.
 */
public interface UniqTokenView {
  /**
   * Returns query-friendly descriptions of the requested sub-list of the unique tokens owned by the
   * given account.
   *
  ...
  /**
   * Returns query-friendly descriptions of the requested sub-list of the unique tokens belonging to
   * the given type.
   *
