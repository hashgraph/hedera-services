...
public class TokenInfoRetrievalUtils {
    ...
    public static NonFungibleTokenInfo getNonFungibleTokenInfo(
    ...
    public static FungibleTokenInfo getFungibleTokenInfo(
            final TokenID tokenId, final WorldLedgers ledgers, final NetworkInfo networkInfo) {
        final var tokenInfo = getTokenInfo(tokenId, ledgers, networkInfo);
    ...
    private static FractionalFee getFractionalFee(
            final FcCustomFee fee, final Address feeCollector) {
    ...
    private static List<TokenKey> getTokenKeys(final TokenID tokenId, final WorldLedgers ledgers) {
        ...
        if (ledgers.feeScheduleKey(tokenId).isPresent()) {
            tokenKeys.add(
                    getTokenKey(
                            ledgers.feeScheduleKey(tokenId).orElse(null),
