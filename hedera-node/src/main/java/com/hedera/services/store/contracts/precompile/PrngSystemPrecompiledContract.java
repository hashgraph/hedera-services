 ...
 * using n-3 record's running hash.
 * If 32-bit integer "range" and 256-bit "seed" is provided returns a pseudorandom 32-bit integer X belonging to [0,
 * range).
 */
@Singleton
public class PrngSystemPrecompiledContract extends AbstractPrecompiledContract {
	...
	private void addContractCallResultToRecord(
		...
		PrecompileUtils.addContractCallResultToRecord(gasRequirement,
				childRecord,
				result,
				errorStatus,
				frame,
