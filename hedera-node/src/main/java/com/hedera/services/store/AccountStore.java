...
public class AccountStore {
  ...
  /**
   * Returns a model of the requested token, with operations that can be used to implement business
   * logic in a transaction.
   *
   * <p><b>IMPORTANT:</b> Changes to the returned model are not automatically persisted to state!
   * The altered model must be passed to {@link AccountStore#persistAccount(Account)} in order for
  ...
  /**
   * Persists the given account to the Swirlds state, inviting the injected {@link
