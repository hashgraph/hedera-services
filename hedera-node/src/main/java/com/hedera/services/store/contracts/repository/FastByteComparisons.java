...
public abstract class FastByteComparisons {
    ...
    public static int compareTo(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2) {
        return FastByteComparisons.LexicographicalComparerHolder.BEST_COMPARER.compareTo(
                b1, s1, l1, b2, s2, l2);
    }
    ...
    private static class LexicographicalComparerHolder {
        static final String UNSAFE_COMPARER_NAME =
                FastByteComparisons.LexicographicalComparerHolder.class.getName() + "$UnsafeComparer";
        ...
        static FastByteComparisons.Comparer<byte[]> getBestComparer() {
            try {
                ...
                FastByteComparisons.Comparer<byte[]> comparer =
                        (FastByteComparisons.Comparer<byte[]>) theClass.getEnumConstants()[0];
                return comparer;
