...
public class TokenRelationship {
  ...
  /**
   * Set the balance of this relationship's token that the account holds at the beginning of a user
   * transaction. (In particular, does <b>not</b> change the return value of {@link
   ...
   *
   * <p>Before the property modification, the method performs validation, that the respective token
   * has a freeze key.
   *
