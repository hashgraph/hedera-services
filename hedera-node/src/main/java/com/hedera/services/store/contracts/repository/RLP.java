...
import static com.hedera.services.store.contracts.repository.ByteUtil.byteArrayToInt;
import static com.hedera.services.store.contracts.repository.ByteUtil.intToBytesNoLeadZeroes;
import static com.hedera.services.store.contracts.repository.ByteUtil.isNullOrZeroArray;
import static com.hedera.services.store.contracts.repository.ByteUtil.isSingleZero;
...
public class RLP {
    ...
    public static final class LList {
        ...
        public RLP.LList getList(int idx) {
    ...
    public static RLP.LList decodeLazyList(byte[] data) {
        return decodeLazyList(data, 0, data.length).getList(0);
    }

    public static RLP.LList decodeLazyList(byte[] data, int pos, int length) {
        if (data == null || data.length < 1) {
            return null;
        }
        RLP.LList ret = new RLP.LList(data);
        int end = pos + length;
