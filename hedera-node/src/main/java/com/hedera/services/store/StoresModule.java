...
public interface StoresModule {
	...
	static boolean provideAreFcotmrQueriesDisabled(@CompositeProps PropertySource properties) {
		return !properties.getBooleanProperty("tokens.nfts.areQueriesEnabled");
	}

	@Provides
	@AreTreasuryWildcardsEnabled
	static boolean provideAreTreasuryWildcardsEnabled(@CompositeProps PropertySource properties) {
