...
public interface EntityAccess {
   ...
   * instances commit directly to the Hedera world state. Only makes sense to return non-degenerate
   * ledgers for a mutable {@link EntityAccess} implementation (though both mutable and static
   * entity access do require the alias "ledger").
   *
  ...
  void flushStorage(TransactionalLedger<AccountID, AccountProperty, MerkleAccount> accountsLedger);
