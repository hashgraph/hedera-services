...
public class EncodingFacade {
	private static final TupleType mintReturnType = TupleType.parse("(int256,uint64,int256[])");
	private static final TupleType burnReturnType = TupleType.parse("(int256,uint64)");
