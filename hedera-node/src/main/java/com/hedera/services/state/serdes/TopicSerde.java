...
public class TopicSerde {
  ...
  public void deserializeV1(SerializableDataInputStream in, MerkleTopic to) throws IOException {
    ...
    to.setRunningHash(
        in.readBoolean() ? in.readByteArray(MerkleTopic.RUNNING_HASH_BYTE_ARRAY_SIZE) : null);
  }

  public void serialize(MerkleTopic merkleTopic, SerializableDataOutputStream out)
      throws IOException {
