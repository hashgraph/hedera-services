...
public class ExpiringCreations implements EntityCreator {
  ...
  public ExpirableTxnRecord.Builder buildExpiringRecord(
    ...
    final var currencyAdjustments =
        transfersList.getAccountAmountsCount() > 0
            ? CurrencyAdjustments.fromGrpc(transfersList)
            : null;
  ...
  public ExpirableTxnRecord.Builder buildFailedExpiringRecord(
      TxnAccessor accessor, Instant consensusTime) {
  ...
  private void setTokensAndTokenAdjustments(
      ExpirableTxnRecord.Builder builder, List<TokenTransferList> tokenTransferList) {
