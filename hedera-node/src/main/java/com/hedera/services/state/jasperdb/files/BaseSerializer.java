 ...
 *
 * @param <T> The type of data we are serializing and deserializing
 */
public interface BaseSerializer<T> {
     ...
     default int getTypicalSerializedSize() {
          if (isVariableSize()) throw new IllegalStateException("Variable sized data implementations have to override this method");
      ...
      */
     default int copyItem(long serializedVersion, int dataItemSize, ByteBuffer dataItemData, SerializableDataOutputStream writingStream) throws IOException {
