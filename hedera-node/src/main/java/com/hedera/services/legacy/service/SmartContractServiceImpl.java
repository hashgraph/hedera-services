...
public class SmartContractServiceImpl extends SmartContractServiceGrpc.SmartContractServiceImplBase {
	 ...
	 *
	 * @param request
	 * 		API request for contract method call
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
	public void contractCallLocalMethod(Query request, StreamObserver<Response> responseObserver) {
		...
		validationCode = txHandler.validateScheduledFee(HederaFunctionality.ContractCallLocal, feePayment,
				scheduledFee);
	 ...
	 * @param responseObserver
	 * 		Observer to be informed of results
	 */
	@Override
	 ...
	 *
	 * @param request
	 * 		API request to call the contract
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
	 ...
	 *
	 * @param request
	 * 		API request to update the contract
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
	 ...
	 *
	 * @param request
	 * 		API request for transaction records
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
	public void getTxRecordByContractID(Query request, StreamObserver<Response> responseObserver) {
		...
		FeeData feeMatrices = feeBuilder.getContractRecordsQueryFeeMatrices(txRecord,
				query.getHeader().getResponseType());
		long scheduledFee = 0;
		...
		validationCode = txHandler.validateScheduledFee(HederaFunctionality.ContractGetRecords, feePayment,
				scheduledFee);
		if (OK == validationCode && scheduledFee > 0) {
			if (submissionManager.trySubmission(uncheckedFrom(feePayment)) != OK) {
	 ...
	 *
	 * @param request
	 * 		API request to system-delete the contract
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
	 ...
	 *
	 * @param request
	 * 		API request to system-undelete the contract
	 * @param responseObserver
	 * 		Observer to be informed of the results
	 */
	@Override
