...
public class TransactionHandler {
	...
	public boolean isAccountExist(AccountID acctId) {
		MerkleEntityId merkleEntityId = new MerkleEntityId(acctId.getShardNum(), acctId.getRealmNum(),
				acctId.getAccountNum());
	...
	public TxnValidityAndFeeReq validateTransactionPreConsensus(Transaction transaction, boolean isQueryPayment) {
		...
		if (returnCode == OK) {
			var rationalStatus = PureValidation.queryableAccountStatus(txn.getTransactionID().getAccountID(),
					accounts.get());
