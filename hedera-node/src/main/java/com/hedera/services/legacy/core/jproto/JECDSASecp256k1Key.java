...
public class JECDSASecp256k1Key extends JKey {
	...
	public static final int ECDSASECP256_UNCOMPRESSED_BYTE_LENGTH = 65;
	...
	public boolean isValid() {
		return !(isEmpty()
				|| (ecdsaSecp256k1Key.length != ECDSASECP256_UNCOMPRESSED_BYTE_LENGTH)
				|| (ecdsaSecp256k1Key[0] != 0x04));
	}
