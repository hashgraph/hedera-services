...
public enum SignatureStatusCode {
	...
	INVALID_TOKEN_REF("Missing token [ source = '%s', transactionId = '%s', token = '%s' ]"),
	INVALID_AUTO_RENEW_ACCOUNT_ID(
			"Invalid AutoRenew Account ID [ source = '%s', transactionId = '%s', accountId = '%s' ]");
