...
public class AnswerFunctions {
	 ...
	 *
	 * @param view
	 * 		the view of the world state to get payer records from
	 * @param payer
	 * 		the target payer account
	 * @return the most recent available records for the given payer
	 */
	public List<TransactionRecord> mostRecentRecords(final StateView view, final AccountID payer) {
		final var targetId = EntityNum.fromAccountId(payer);
	 ...
	 *
	 * @param recordCache
	 * 		the cache to get the record from
	 * @param op
	 * 		the query with the target transaction id
	 ...
	 * @param n
	 * 		the expected number of records in the account
