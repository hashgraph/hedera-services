...
public class GetAccountNftInfosAnswer implements AnswerService {
  public static final String ACCOUNT_NFT_INFO_CTX_KEY =
      GetAccountNftInfosAnswer.class.getSimpleName() + "_accountNftInfos";
  ...
  public ResponseCodeEnum checkValidity(Query query, StateView view) {
    ...
    var validity =
        validator.nftMaxQueryRangeCheck(
            accountNftInfoQuery.getStart(), accountNftInfoQuery.getEnd());
    if (validity != OK) {
      return validity;
    }
    ...
    if (accountNftInfoQuery.getStart() < 0
