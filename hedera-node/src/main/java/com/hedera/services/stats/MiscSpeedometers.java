...
public class MiscSpeedometers {
  ...
  public void registerWith(Platform platform) {
    platform.addAppStatEntry(
        speedometer.from(
            Names.SYNC_VERIFICATIONS, Descriptions.SYNC_VERIFICATIONS, syncVerifications));
    platform.addAppStatEntry(
        speedometer.from(
            Names.ASYNC_VERIFICATIONS, Descriptions.ASYNC_VERIFICATIONS, asyncVerifications));
    platform.addAppStatEntry(
        speedometer.from(
