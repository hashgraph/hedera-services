...
public final class StatsModule {
    ...
    public static MiscRunningAvgs provideMiscRunningAvgs(
        ...
        return new MiscRunningAvgs(
                new RunningAvgFactory() {}, nodeLocalProperties.statsRunningAvgHalfLifeSecs());
    }
    ...
    public static MiscSpeedometers provideMiscSpeedometers(
            final NodeLocalProperties nodeLocalProperties) {
        return new MiscSpeedometers(
                new SpeedometerFactory() {}, nodeLocalProperties.statsSpeedometerHalfLifeSecs());
    }
