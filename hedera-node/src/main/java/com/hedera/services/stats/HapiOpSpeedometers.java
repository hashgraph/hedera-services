...
public class HapiOpSpeedometers {
    ...
    final Map<HederaFunctionality, Long> lastReceivedOpsCount =
            new EnumMap<>(HederaFunctionality.class);
    final Map<HederaFunctionality, Long> lastHandledTxnsCount =
            new EnumMap<>(HederaFunctionality.class);
    final Map<HederaFunctionality, Long> lastSubmittedTxnsCount =
            new EnumMap<>(HederaFunctionality.class);
    final Map<HederaFunctionality, Long> lastAnsweredQueriesCount =
            new EnumMap<>(HederaFunctionality.class);
    Long lastReceivedDeprecatedTxnCount;

    final EnumMap<HederaFunctionality, StatsSpeedometer> receivedOps =
            new EnumMap<>(HederaFunctionality.class);
    final EnumMap<HederaFunctionality, StatsSpeedometer> handledTxns =
            new EnumMap<>(HederaFunctionality.class);
    final EnumMap<HederaFunctionality, StatsSpeedometer> submittedTxns =
            new EnumMap<>(HederaFunctionality.class);
    final EnumMap<HederaFunctionality, StatsSpeedometer> answeredQueries =
            new EnumMap<>(HederaFunctionality.class);
    ...
    public void registerWith(Platform platform) {
        ...
        registerSpeedometers(
                platform, handledTxns, SPEEDOMETER_HANDLED_NAME_TPL, SPEEDOMETER_HANDLED_DESC_TPL);
        registerSpeedometers(
                platform,
                answeredQueries,
        ...
        registerSpeedometer(
                ...
                SPEEDOMETER_RECEIVED_DEPRECATED_NAME_TPL,
                SPEEDOMETER_RECEIVED_DEPRECATED_DESC_TPL);
    }

    private void registerSpeedometer(
            Platform platform, StatsSpeedometer speedometers, String nameTpl, String descTpl) {
