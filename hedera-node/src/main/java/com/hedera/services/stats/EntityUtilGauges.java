...
public class EntityUtilGauges {
	...
	public EntityUtilGauges(final UsageLimits usageLimits) {
		utils = List.of(
				new UtilGauge(usageLimits::percentAccountsUsed,
						gaugeFor("accounts")),
				new UtilGauge(usageLimits::percentContractsUsed,
						gaugeFor("contracts")),
				new UtilGauge(usageLimits::percentFilesUsed,
						gaugeFor("files")),
				new UtilGauge(usageLimits::percentNftsUsed,
						gaugeFor("nfts")),
				new UtilGauge(usageLimits::percentSchedulesUsed,
						gaugeFor("schedules")),
				new UtilGauge(usageLimits::percentStorageSlotsUsed,
						gaugeFor("storageSlots", "storage slots")),
				new UtilGauge(usageLimits::percentTokensUsed,
						gaugeFor("tokens")),
				new UtilGauge(usageLimits::percentTokenRelsUsed,
						gaugeFor("tokenAssociations", "token associations")),
				new UtilGauge(usageLimits::percentTopicsUsed,
						gaugeFor("topics")));
	}
