...
public class HapiOpCounters {
    ...
    EnumMap<HederaFunctionality, AtomicLong> submittedTxns =
            new EnumMap<>(HederaFunctionality.class);
    EnumMap<HederaFunctionality, AtomicLong> answeredQueries =
            new EnumMap<>(HederaFunctionality.class);
    ...
    public void registerWith(final Platform platform) {
        registerCounters(
                platform, receivedOps, COUNTER_RECEIVED_NAME_TPL, COUNTER_RECEIVED_DESC_TPL);
        registerCounters(
                platform, submittedTxns, COUNTER_SUBMITTED_NAME_TPL, COUNTER_SUBMITTED_DESC_TPL);
        registerCounters(platform, handledTxns, COUNTER_HANDLED_NAME_TPL, COUNTER_HANDLED_DESC_TPL);
        registerCounters(
                platform, answeredQueries, COUNTER_ANSWERED_NAME_TPL, COUNTER_ANSWERED_DESC_TPL);
        registerCounter(
                platform,
                receivedDeprecatedTxns,
                COUNTER_RECEIVED_DEPRECATED_NAME_TPL,
