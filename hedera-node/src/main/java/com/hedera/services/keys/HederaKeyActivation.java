...
public class HederaKeyActivation {
  ...
  public static boolean payerSigIsActive(
      TxnAccessor accessor, BiPredicate<JKey, TransactionSignature> validity) {
   ...
   *
   * <p><b>IMPORTANT:</b> The sigs must be supplied in the order that a DFS traversal of the Hedera
   * key tree structure encounters the corresponding simple keys.
   *
