...
import com.hedera.services.store.contracts.precompile.ExchangeRateContract;
...
import static com.hedera.services.store.contracts.precompile.ExchangeRateContract.EXCHANGE_RATE_SYSTEM_CONTRACT_ADDRESS;
...
public interface ContractsModule {
	...
	PrecompiledContract bindExchangeRatePrecompile(ExchangeRateContract exchangeRateContract);
