...
public class TopicCreateTransitionLogic implements TransitionLogic {
  ...
  private final Function<TransactionBody, ResponseCodeEnum>
      PRE_SIGNATURE_VALIDATION_SEMANTIC_CHECK = this::validatePreSignatureValidation;
  ...
  public void doStateTransition() {
    ...
    try {
      // expirationTime (currently un-enforced) is consensus timestamp of create plus the specified
      // required
      // autoRenewPeriod->seconds.
      var expirationTime =
          transactionContext.consensusTime().plusSeconds(op.getAutoRenewPeriod().getSeconds());
      ...
      var topic =
          new MerkleTopic(
              ...
              op.hasAutoRenewAccount()
                  ? EntityId.fromGrpcAccountId(op.getAutoRenewAccount())
                  : null,
