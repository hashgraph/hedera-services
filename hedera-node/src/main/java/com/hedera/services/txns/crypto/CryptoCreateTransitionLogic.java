...
public class CryptoCreateTransitionLogic implements TransitionLogic {
	...
	public void doStateTransition() {
		try {
			...
			final var result = ledger.lookUpAliasedPayerId(cryptoCreateTxn.getTransactionID().getAccountID());
			...
			if (op.hasProxyAccountID()) {
				final var proxyLookUp = ledger.lookUpAndValidateAliasedId(op.getProxyAccountID(),
