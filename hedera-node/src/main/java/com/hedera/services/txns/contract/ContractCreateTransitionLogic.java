...
public class ContractCreateTransitionLogic implements TransitionLogic {
  ...
  public interface LegacyCreator {
    TransactionRecord perform(
        TransactionBody txn, Instant consensusTime, byte[] bytecode, SequenceNumber seqNum);
  }
  ...
  public void doStateTransition() {
    try {
      ...
      var legacyRecord =
          delegate.perform(contractCreateTxn, txnCtx.consensusTime(), inputs.getKey(), seqNo.get());
