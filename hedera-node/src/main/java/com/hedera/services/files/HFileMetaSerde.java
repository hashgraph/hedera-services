...
public class HFileMetaSerde {
  ...
  public static Function<InputStream, SerializableDataInputStream> serInFactory =
      SerializableDataInputStream::new;
  public static Function<OutputStream, SerializableDataOutputStream> serOutFactory =
      SerializableDataOutputStream::new;

  public static byte[] serialize(HFileMeta meta) throws IOException {
    return streamContentDiscovery.discoverFor(
        out -> {
