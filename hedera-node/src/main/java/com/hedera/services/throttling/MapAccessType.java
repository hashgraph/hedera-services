...
/**
 * Enumerates the type of {@link com.swirlds.merkle.map.MerkleMap} and {@link com.swirlds.virtualmap.VirtualMap}
 * operations needed to auto-renew or auto-remove expired entities.
 *
 * <p><b>IMPORTANT:</b> since expiration is only enabled for contracts at this time, not all map access types
 * are included now.
 */
public enum MapAccessType {
    ...
    NFTS_REMOVE,
    /**
     * To update an NFT's owner on treasury return, or {@code prev} link after returning the preceding head NFT.
     */
    NFTS_GET_FOR_MODIFY,
    /**
    ...
    STORAGE_GET,
    /**
     * To replace a {@link com.hedera.services.state.virtual.IterableContractValue} with modified links.
     */
    STORAGE_PUT,
    /**
