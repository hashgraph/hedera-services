...
public class NodeInfo {
	...
	private PermHashInteger[] accountKeys;
	...
	public PermHashInteger accountKeyOf(long nodeId) {
		final int index = validatedIndexFor(nodeId);
	...
	void readBook() {
		...
		accountKeys = new PermHashInteger[numberOfNodes];
		...
		for (int i = 0; i < numberOfNodes; i++) {
			...
			try {
				...
				accountKeys[i] = PermHashInteger.fromAccountId(accounts[i]);
