...
public interface TransactionContext {
  ...
  /**
   * Constructs and gets a {@link ExpirableTxnRecord} which captures the history of processing the
   * current txn up to the time of the call.
   *
  ...
  /**
   * Gets an accessor to the defined type {@link TxnAccessor} currently being processed.
   *
  ...
  /**
   * Record that the payer of the current txn is known to have an active signature (that is, the txn
   * includes enough valid cryptographic signatures to activate the payer's Hedera key).
   */
