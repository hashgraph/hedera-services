...
public class AwareTransactionContext implements TransactionContext {
  ...
  public void setCallResult(ContractFunctionResult result) {
    recordConfig =
        expiringRecord -> expiringRecord.setContractCallResult(SolidityFnResult.fromGrpc(result));
  }

  @Override
  public void setCreateResult(ContractFunctionResult result) {
    recordConfig =
        expiringRecord -> expiringRecord.setContractCreateResult(SolidityFnResult.fromGrpc(result));
  }
  ...
  public void setCreated(List<Long> serialNumbers) {
    receiptConfig =
        receipt -> receipt.setSerialNumbers(serialNumbers.stream().mapToLong(l -> l).toArray());
  }
