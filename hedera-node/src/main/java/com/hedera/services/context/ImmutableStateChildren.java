 ...
 * com.swirlds.common.merkle.utility.AbstractNaryMerkleInternal#getChild(int)} is much more
 * expensive, since the compiler does not seem to ever inline those calls.)
 */
