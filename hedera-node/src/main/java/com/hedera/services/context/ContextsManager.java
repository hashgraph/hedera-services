...
/**
 * Defines a type that manages references to multiple node contexts per classloader by using the
 * {@link com.swirlds.common.Platform#getSelfId()} in the context.
 *
 * <p>Logically, the {@link ServicesContext} is a singleton but for testing it is convenient to run
 * multiple nodes in the same JVM.
 *
...
public interface ContextsManager {
   ...
   * @throws IllegalArgumentException if there is no such context
   */
