 ...
 *
 * <p>For each platform txn added to the hashgraph, {@code expandFor} checks which
 ...
 */
@Singleton
public class SignatureExpander {
    private static final Logger logger = LogManager.getLogger(SignatureExpander.class);

    SigRequirements keyOrderer;

    @Inject
    public SignatureExpander(@RetryingSigReqs SigRequirements keyOrderer) {
