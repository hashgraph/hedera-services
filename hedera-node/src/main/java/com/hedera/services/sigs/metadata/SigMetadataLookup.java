...
public interface SigMetadataLookup {
  Function<TokenStore, Function<TokenID, SafeLookupResult<TokenSigningMetadata>>>
      REF_LOOKUP_FACTORY =
          tokenStore ->
              ref -> {
                TokenID id;
  ...
  Function<ScheduleStore, Function<ScheduleID, SafeLookupResult<ScheduleSigningMetadata>>>
