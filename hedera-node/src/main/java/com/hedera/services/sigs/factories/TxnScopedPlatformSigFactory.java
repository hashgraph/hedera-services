...
/**
 * Defines a type of {@link com.swirlds.common.crypto.Signature} factory that does not
...
public interface TxnScopedPlatformSigFactory {
	/**
	 * Returns a {@link com.swirlds.common.crypto.Signature} on the scoped transaction.
	 *
	 * @param publicKey
	 ...
	 */
	Signature create(ByteString publicKey, ByteString sigBytes);
}
