...
/**
 * Used by {@link com.hedera.services.ServicesState#expandSignatures(SwirldTransaction)} to expand
 * the cryptographic signatures <i>linked</i> to a given transaction. Linked signatures are derived
