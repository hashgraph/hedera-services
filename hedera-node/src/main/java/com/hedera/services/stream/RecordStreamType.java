...
/**
 * Contains properties related to RecordStream file type; Its constructor is private. Users need to
 * use the singleton to denote this type.
 */
public final class RecordStreamType implements StreamType {
  ...
  /**
   * Header which is written in the beginning of a stream file, before writing the Object Stream
   * Version. the ints in fileHeader denote: version 5, hapiProtoVersion: 0.11.0
   */
  private static final int[] RECORD_FILE_HEADER = new int[] {5, 0, 11, 0};
  /**
   * Header which is written in the beginning of a stream signature file, before writing the Object
   * Stream Signature Version. the byte in sigFileHeader denotes version 5
   */
