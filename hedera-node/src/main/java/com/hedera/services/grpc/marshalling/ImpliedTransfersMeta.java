 ...
 * across "span" between the {@link
 * com.hedera.services.ServicesState#expandSignatures(SwirldTransaction)} and {@link
...
public class ImpliedTransfersMeta {
  ...
  public ImpliedTransfersMeta(
      ValidationProps validationProps, ResponseCodeEnum code, List<CustomFeeMeta> customFeeMeta) {
    this.code = code;
  ...
  public boolean wasDerivedFrom(
      GlobalDynamicProperties dynamicProperties, CustomFeeSchedules customFeeSchedules) {
