 ...
 *
 * <p>Note that if the {@link ImpliedTransfersMeta#code()} is not {@code OK}, the list of changes
...
public class ImpliedTransfers {
  ...
  public static ImpliedTransfers invalid(
      ImpliedTransfersMeta.ValidationProps validationProps, ResponseCodeEnum code) {
