...
public class HederaLedger {
     ...
     * {@code tokenRelsLedger} and {@code nftsLedger} both have interceptors that update properties
     * in the accounts {@code MerkleMap}. If either of them were committed before the {@code
     * accountsLedger} at the end of a contract operation, their changes would be overwritten, since
     * in a contract operation, <i>all</i> {@link AccountProperty} values appear in an account's
     * change set.
     */
    public void commit() {
