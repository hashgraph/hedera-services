...
public class AutoAssocTokenRelsCommitInterceptor
		implements CommitInterceptor<Pair<AccountID, TokenID>, MerkleTokenRelStatus, TokenRelProperty> {
	private static final Set<HederaFunctionality> AUTO_ASSOCIATING_OPS = EnumSet.of(
			CryptoTransfer,
			TokenCreate
	);
