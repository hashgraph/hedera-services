 ...
 * {@link com.hedera.services.ledger.accounts.BackingAccounts} and {@link
 * com.hedera.services.ledger.accounts.BackingTokenRels} components whose APIs still use gRPC types.
 */
public class BalanceChange {
  ...
  public static BalanceChange changingNftOwnership(
      Id token, TokenID tokenId, NftTransfer nftTransfer) {
  ...
  private BalanceChange(
      Id token, AccountID sender, AccountID receiver, long serialNo, ResponseCodeEnum code) {
    this.token = token;
