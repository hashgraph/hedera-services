...
/**
 * Defines a type able to receive information about changes to properties; used by
 * {@link TransactionalLedger} as a commit interceptor to allow a parent
 * {@link com.hedera.services.store.contracts.AbstractLedgerWorldUpdater} to keep
 * its {@code updateAccounts} map in sync with changes made by an HTS precompile.
 *
...
public interface PropertyChangeObserver<K, P extends Enum<P>> {
	 ...
	 * its property of the given type changed.
	 *
