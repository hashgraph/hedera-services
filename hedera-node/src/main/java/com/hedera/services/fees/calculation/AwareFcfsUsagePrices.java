...
public class AwareFcfsUsagePrices implements UsagePricesProvider {
  ...
  public static final FeeComponents DEFAULT_PROVIDER_RESOURCE_PRICES =
  ...
  void ensurePricesMapHasRequiredTypes(
      TransactionFeeSchedule tfs, Map<SubType, FeeData> pricesMap, Set<SubType> requiredTypes) {
