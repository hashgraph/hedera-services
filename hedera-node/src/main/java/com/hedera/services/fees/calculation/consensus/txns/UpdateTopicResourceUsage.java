...
public class UpdateTopicResourceUsage implements TxnResourceUsageEstimator {
  ...
  public FeeData usageGiven(
      final TransactionBody txnBody, final SigValueObj sigUsage, final StateView view)
    ...
    final MerkleTopic merkleTopic =
        view.topics()
            .get(MerkleEntityId.fromTopicId(txnBody.getConsensusUpdateTopic().getTopicID()));
