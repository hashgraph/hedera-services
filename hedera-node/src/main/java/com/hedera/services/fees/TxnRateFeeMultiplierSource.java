...
public class TxnRateFeeMultiplierSource implements FeeMultiplierSource {
  ...
  public TxnRateFeeMultiplierSource(
      GlobalDynamicProperties properties, FunctionalityThrottling throttling) {
        ...
        sb.append("    ")
            .append(
                readableTpsCutoffFor(
                    activeTriggerValues[i][j], throttle.mtps(), throttle.capacity()))
  ...
  public void updateMultiplier(Instant consensusNow) {
    ...
    multiplier =
        highestMultiplierNotShorterThan(activeConfig.multipliers(), minPeriod, consensusNow);
