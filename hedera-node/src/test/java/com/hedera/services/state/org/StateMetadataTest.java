...
class StateMetadataTest {
  ...
  @Mock private FCOneToManyRelation<PermHashInteger, Long> uniqueTokenAssociations;
  @Mock private FCOneToManyRelation<PermHashInteger, Long> uniqueOwnershipAssociations;
  @Mock private FCOneToManyRelation<PermHashInteger, Long> uniqueTreasuryOwnershipAssociations;
  ...
  void copyAsExpected() {
    ...
    given(uniqueTreasuryOwnershipAssociations.copy())
        .willReturn(uniqueTreasuryOwnershipAssociations);
