...
class FcmDumpTest {
    ...
    @Mock private MerkleDataOutputStream out;
    @Mock private Function<String, MerkleDataOutputStream> merkleOutFn;
    ...
    @Mock private FcmDump.DirectoryCreation directoryCreation;
    ...
    void propagatesIoEUnchecked() throws IOException {
        given(directoryCreation.createDirectories(Paths.get(OK_PATH).getParent()))
