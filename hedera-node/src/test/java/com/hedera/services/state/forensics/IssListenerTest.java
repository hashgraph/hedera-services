...
class IssListenerTest {
    ...
    void logsFallbackInfo() {
        ...
        // then:
        var desired = String.format(IssListener.ISS_FALLBACK_ERROR_MSG_PATTERN, round, self, other);
    ...
    void logsAndDumpsIfConfiguredInfo() {
        ...
        var desired =
                String.format(
                        IssListener.ISS_ERROR_MSG_PATTERN, round, selfId, otherId, sigHex, hashHex);
