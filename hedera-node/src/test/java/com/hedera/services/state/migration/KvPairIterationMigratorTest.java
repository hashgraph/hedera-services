...
class KvPairIterationMigratorTest {
	...
	@BeforeEach
	void setUp() {
		subject = new KvPairIterationMigrator(1, accounts, storageUpserter, iterableContractStorage);
	}
	...
	public static final IterableContractValue iterableRootValue = IterableContractValue.from(rootEvmValue);
	public static final ContractValue tailValue = ContractValue.from(tailEvmValue);
	public static final IterableContractValue iterableTailValue = IterableContractValue.from(tailEvmValue);
