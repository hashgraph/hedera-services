...
class ExpirableTxnRecordTest {
	...
	void toStringHasntChanged() {
		// setup:
		final var desired = "ExpirableTxnRecord{receipt=TxnReceipt{status=INVALID_ACCOUNT_ID, exchangeRates=null, " +
				...
				"submittingMember=1, memo=Alpha bravo charlie, " +
				"contractCreation=SolidityFnResult{gasUsed=55, bloom=, result=, error=null, " +
				...
				"readable=[1.2.5 -> -1, 1.2.6 <- +1, 1.2.7 <- +1000]}), " +
