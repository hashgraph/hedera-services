...
class StateModuleTest {
    ...
    @Mock private LegacyEd25519KeyReader b64KeyReader;
    ...
    void looksUpExpectedKey() {
        ...
        given(properties.getStringProperty("bootstrap.genesisB64Keystore.path"))
                .willReturn(keystoreLoc);
        given(properties.getStringProperty("bootstrap.genesisB64Keystore.keyName"))
                .willReturn(storeName);
        given(b64KeyReader.hexedABytesFrom(keystoreLoc, storeName))
                .willReturn(CommonUtils.hex(keyBytes));
