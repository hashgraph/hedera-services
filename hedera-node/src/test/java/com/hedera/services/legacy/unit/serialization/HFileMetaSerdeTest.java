...
public class HFileMetaSerdeTest {
  ...
  void deserializesNewVersionAsExpected() throws IOException {
    ...
    given(serdes.readNullable(argThat(serIn::equals), any(IoReadingFunction.class)))
        .willReturn(known.getWacl());
  ...
  public void serializesNewVersionAsExpected() throws IOException {
    ...
    inOrder
        .verify(serdes)
        .writeNullable(
            argThat(wacl::equals), argThat(serOut::equals), any(IoWritingConsumer.class));
