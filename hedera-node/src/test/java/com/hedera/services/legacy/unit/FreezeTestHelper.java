...
class FreezeTestHelper {
  ...
  static Transaction createFreezeTransaction(
      final boolean paidBy58, final boolean valid, final FileID fileID) {
    return createFreezeTransaction(paidBy58, valid, fileID, null, null);
  }

  static Transaction createFreezeTransaction(
      final boolean paidBy58, final boolean valid, final FileID fileID, final byte[] fileHash) {
  ...
  static Transaction createFreezeTransaction(
    ...
    return createFreezeTransaction(
        paidBy58, valid, fileID, fileHash, startHourMin, endHourMin, timeStamp);
  }
  ...
  private static FreezeTransactionBody.Builder getFreezeTranBuilder(
