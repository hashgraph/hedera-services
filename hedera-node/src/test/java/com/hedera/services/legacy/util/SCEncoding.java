...
/**
 * @author peter Smart contract call encoding for use by smart contract unit tests. Copied from
 *     SmartContractSimpleStorage regression test.
 */
public class SCEncoding {
  private static final String SC_GET_ABI =
      "{\"constant\":true,\"inputs\":[],\"name\":\"get\","
          + "\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\","
          + "\"type\":\"function\"}";
  private static final String SC_SET_ABI =
      "{\"constant\":false,\"inputs\":[{\"name\":\"x\",\"type\":\"uint256\"}],"
          + "\"name\":\"set\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\","
          + "\"type\":\"function\"}";
  public static final String SC_ALL_ABI =
      "[{\"constant\":false,\"inputs\":[{\"name\":\"x\",\"type\":\"uint256\"}],"
          + "\"name\":\"set\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\","
  ...
  private static final String SC_GET_BALANCE =
      "{\"constant\":true,\"inputs\":[],\"name\":\"getBalance\","
          + "\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\","
          + "\"type\":\"function\"}";
  private static final String SC_DEPOSIT =
      "{\"constant\":false,\"inputs\":[{\"name\":\"amount\","
          + "\"type\":\"uint256\"}],\"name\":\"deposit\",\"outputs\":[],\"payable\":true,"
          + "\"stateMutability\":\"payable\",\"type\":\"function\"}";
  private static final String SC_GET_BALANCE_OF =
      "{\"constant\":true,\"inputs\":[{\"name\":\"accToCheck\","
          + "\"type\":\"address\"}],\"name\":\"getBalanceOf\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],"
          + "\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}";
  private static final String SC_SEND_FUNDS =
      "{\"constant\":false,\"inputs\":[{\"name\":\"receiver\","
          + "\"type\":\"address\"},{\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"sendFunds\",\"outputs\":[],"
          + "\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";

  private static final String SC_MAP_PUT_ABI =
      "{\"constant\":false,\"inputs\":[{\"name\":\"key\","
          + "\"type\":\"uint256\"},{\"name\":\"val\",\"type\":\"uint256\"}],\"name\":\"put\",\"outputs\":[],"
          + "\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";
  private static final String SC_MAP_GET_ABI =
      "{\"constant\":true,\"inputs\":[{\"name\":\"key\","
          + "\"type\":\"uint256\"}],\"name\":\"get\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],"
          + "\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]";

  private static final String SC_CT_CREATE_ABI =
      "{\"constant\":false,\"inputs\":[],\"name\":\"create\","
          + "\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}";
  private static final String SC_CT_GETINDIRECT_ABI =
      "{\"constant\":true,\"inputs\":[],\"name\":\"getIndirect\","
          + "\"outputs\":[{\"name\":\"value\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\","
          + "\"type\":\"function\"}";
  private static final String SC_CT_GETADDRESS_ABI =
      "{\"constant\":true,\"inputs\":[],\"name\":\"getAddress\","
          + "\"outputs\":[{\"name\":\"retval\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\","
          + "\"type\":\"function\"}";

  private static final String SC_OPSHL_ABI =
      "{\"constant\":true,\"inputs\":[{\"name\":\"_one\","
          + "\"type\":\"uint256\"},{\"name\":\"_two\",\"type\":\"uint256\"}],\"name\":\"opShl\","
          + "\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\","
          + "\"type\":\"function\"}";
  private static final String SC_OPSHR_ABI =
      "{\"constant\":true,\"inputs\":[{\"name\":\"_one\","
          + "\"type\":\"uint256\"},{\"name\":\"_two\",\"type\":\"uint256\"}],\"name\":\"opShr\","
          + "\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\","
          + "\"type\":\"function\"}";
  private static final String SC_OPSAR_ABI =
      "{\"constant\":true,\"inputs\":[{\"name\":\"_one\","
          + "\"type\":\"uint256\"},{\"name\":\"_two\",\"type\":\"uint256\"}],\"name\":\"opSar\","
          + "\"outputs\":[{\"name\":\"_resp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"pure\","
          + "\"type\":\"function\"}";
  private static final String SC_OPEXTCODEHASH_ABI =
      "{\"constant\":true,\"inputs\":[{\"name\":\"_addr\","
          + "\"type\":\"address\"}],\"name\":\"opExtCodeHash\",\"outputs\":[{\"name\":\"_resp\","
  ...
  private static CallTransaction.Function getMapPutFunction() {
  ...
  private static CallTransaction.Function getMapGetFunction() {
  ...
  private static CallTransaction.Function getDepositFunction() {
  ...
  private static CallTransaction.Function getGetBalanceFunction() {
  ...
  private static CallTransaction.Function getSendFundsFunction() {
  ...
  private static CallTransaction.Function getGetBalanceOfFunction() {
  ...
  private static CallTransaction.Function getCreateTrivialCreateFunction() {
  ...
  private static CallTransaction.Function getCreateTrivialGetIndirectFunction() {
  ...
  private static CallTransaction.Function getCreateTrivialGetAddressFunction() {
  ...
  private static CallTransaction.Function getOpShlFunction() {
  ...
  private static CallTransaction.Function getOpShrFunction() {
  ...
  private static CallTransaction.Function getOpSarFunction() {
  ...
  private static CallTransaction.Function getOpExtCodeHashFunction() {
