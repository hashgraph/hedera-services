...
import static com.hedera.services.store.contracts.precompile.PrecompileFunctionSelector.ABI_ID_REVOKE_TOKEN_KYC;
...
class RevokeKycPrecompileTest {
    ...
    void RevokeKyc() {
        // given
        final var input = Bytes.of(Integers.toBytes(ABI_ID_REVOKE_TOKEN_KYC.getFunctionSelector()));
        givenFrameContext();
        givenLedgers();
