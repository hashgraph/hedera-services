...
import static com.hedera.services.store.contracts.precompile.PrecompileFunctionSelector.ABI_ID_UNFREEZE;
...
class UnfreezeTokenPrecompileTest {
    ...
    void computeCallsSuccessfullyForUnFreezeFungibleToken() {
        // given
        final var input = Bytes.of(Integers.toBytes(ABI_ID_UNFREEZE.getFunctionSelector()));
        givenFrameContext();
        givenLedgers();
