...
class EncodingFacadeTest {
    ...
    void decodeGetTokenInfo() {
        final var expiry = new Expiry(1665581019, Address.wrap(Bytes.fromHexString("0x0000000000000000000000000000000000000471")), 7776000L);
        final var tokenKeys = new ArrayList<TokenKey>();
        final var adminKey = new TokenKey(TokenKeyType.ADMIN_KEY.value(), new KeyValue(false, null, new byte[]{113, -121, -112, -17, 36, 52, -82, -128, -110, 41, -42, 49, -77, -115, 35, 27, 61, -25, -31, -94, 109, -48, -16, 117, -17, 127, 53, 96, -93, 36, 71, 69},
            new byte[]{}, null));
        final var kycKey = new TokenKey(TokenKeyType.KYC_KEY.value(), new KeyValue(false, null, new byte[]{-108, -112, 90, -116, -45, 75, -64, -65, 30, 24, 113, 113, 20, -108, 45, 87, -104, -109, 80, -93, -35, 24, 11, 77, 33, -21, -66, 20, 32, -59, 55, 101},
            new byte[]{}, null));
        final var freezeKey = new TokenKey(TokenKeyType.FREEZE_KEY.value(), new KeyValue(false, null, new byte[]{5, -99, -9, -62, 55, -86, 16, -40, -34, 6, 6, -93, -95, 118, -56, -85, 31, 80, -88, 45, -101, -36, -98, 77, 107, -63, 97, 97, -3, -104, 26, -90},
            new byte[]{}, null));
        final var wipeKey = new TokenKey(TokenKeyType.WIPE_KEY.value(), new KeyValue(false, null, new byte[]{51, 121, 53, -52, 4, -56, -94, -20, 38, -96, -119, 93, 22, 96, 86, -112, 121, 24, -61, -102, 43, -53, -81, -11, 62, -62, -14, -14, 44, -65, -123, 38},
            new byte[]{}, null));
        final var supplyKey = new TokenKey(TokenKeyType.SUPPLY_KEY.value(), new KeyValue(false, null, new byte[]{99, 25, -105, 51, 109, -10, -22, 8, 32, 37, 55, -57, 86, -121, 23, -116, 110, 55, -88, 6, -88, -10, -91, 69, -77, 78, 98, 81, 112, 36, 64, -95},
            new byte[]{}, null));
        final var feeScheduleKey = new TokenKey(TokenKeyType.FEE_SCHEDULE_KEY.value(), new KeyValue(false, null, new byte[]{40, -16, -88, 30, 37, -31, 95, 24, -33, 102, 26, 88, 122, -69, 7, 22, 85, 1, -119, 76, -116, -108, 3, 62, 15, -81, 29, -96, -5, 97, 46, 106},
            new byte[]{}, null));
        final var pauseKey = new TokenKey(TokenKeyType.PAUSE_KEY.value(), new KeyValue(false, null, new byte[]{-98, -94, 115, -96, -95, 44, -96, -62, -77, -124, -70, -75, 1, -98, 127, 67, 119, -79, 113, -65, 96, -39, 8, -114, 89, 34, 89, -12, -49, -128, 32, -90},
            new byte[]{}, null));
        ...
        final var hederaToken = new HederaToken("primary", "AKDDNYDI", Address.wrap(Bytes.fromHexString("0x0000000000000000000000000000000000000470")), "JUMP",
            true, 1000, true, tokenKeys, expiry);
        final TokenInfo tokenInfo = new TokenInfo(hederaToken, 500, false, false, false,
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), Bytes.fromHexString("0x03").toString());
