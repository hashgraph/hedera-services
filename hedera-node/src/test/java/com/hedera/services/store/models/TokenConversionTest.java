...
class TokenConversionTest {
	...
	void conversionFromMerkleWorks() {
		final var newToken = fromMerkle(merkleToken, tokenId, treasuryAccount, autoRenewAccount);
	...
	void conversionCycleFromMerkleWorks() {
		final var tokenSubject = fromMerkle(merkleToken, tokenId, treasuryAccount, autoRenewAccount);
	...
	void conversionCycleFromTokenWorks() {
		...
		final var newToken = fromMerkle(newMerkleToken, tokenId, treasuryAccount, null);
