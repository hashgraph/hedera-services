 ...
 * limitations under the License.ou may not use this file except in compliance with the License.
 *  * You may obtain a copy of the License at
 *  *
 *  *     http://www.apache.org/licenses/LICENSE-2.0
 *  *
...
class ExceptionalUniqueTokenStoreTest {
	...
	void allButSetAreUse() {
		...
		assertThrows(UnsupportedOperationException.class, () -> NOOP_UNIQUE_TOKEN_STORE.resolve(null));
		assertThrows(UnsupportedOperationException.class, () -> NOOP_UNIQUE_TOKEN_STORE.delete(null));
		assertThrows(UnsupportedOperationException.class, () -> NOOP_UNIQUE_TOKEN_STORE.mint(null, null));
		...
		assertThrows(UnsupportedOperationException.class, () -> NOOP_UNIQUE_TOKEN_STORE.get(NftID.getDefaultInstance()));
		assertThrows(UnsupportedOperationException.class, () -> NOOP_UNIQUE_TOKEN_STORE.get(TokenID.getDefaultInstance()));

		assertThrows(UnsupportedOperationException.class, NOOP_UNIQUE_TOKEN_STORE::rebuildViews);
