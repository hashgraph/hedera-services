...
class NonFungibleTokenInfoTest {
  ...
  void hashCodeDiscriminates() {
    final var aNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            null, 1, senderAddress, 1434353562L, new byte[]{40, -32, 56, 2, -8}, recipientAddr);
    final var bNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            null, 2, senderAddress, 43643743437L, new byte[]{56, -32, 73, 2, -8}, recipientAddr);
    final var cNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            null, 3, senderAddress, 74643363L, new byte[]{74, -32, 56, 2, -5}, recipientAddr);
  ...
  void equalsDiscriminates() {
    final var aNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            createTokenInfo(), 1, senderAddress, 1434353562L, new byte[]{40, -32, 56, 2, -8}, recipientAddr);
    final var bNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            createTokenInfo(), 2, senderAddress, 43643743437L, new byte[]{56, -32, 73, 2, -8}, recipientAddr);
    final var cNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            createTokenInfo(), 3, senderAddress, 74643363L, new byte[]{74, -32, 56, 2, -5}, recipientAddr);
    final var dNonFungibleTokenInfo =
        new NonFungibleTokenInfo(
            createTokenInfo(), 1, senderAddress, 1434353562L, new byte[]{40, -32, 56, 2, -8}, recipientAddr);
  ...
  void toStringWorks() {
    ...
    assertEquals("NonFungibleTokenInfo{"
        + "tokenInfo="
        + "TokenInfo[token=HederaToken[name=Name, symbol=Symbol, treasury=0x0000000000000000000000000000000000000008, memo=Memo, tokenSupplyType=true, maxSupply=10000, freezeDefault=false, tokenKeys=[], expiry=Expiry[second=3253253234, autoRenewAccount=0x0000000000000000000000000000000000000008, autoRenewPeriod=10000000]], totalSupply=10, deleted=false, defaultKycStatus=false, pauseStatus=false, fixedFees=[], fractionalFees=[], royaltyFees=[], ledgerId=0x03]"
        + ", serialNumber="
        + 1
        + ", ownerId="
        + senderAddress
