...
class FeeAssessorTest {
  ...
  private final ImpliedTransfersMeta.ValidationProps props =
      new ImpliedTransfersMeta.ValidationProps(0, 0, 0, 1, 20, true);
  ...
  void abortsOnExcessiveNesting() {
    ...
    assertEquals(
        ...
        subject.assess(
            fungibleTrigger, customSchedulesManager, balanceChangeManager, accumulator, props));
  }
  ...
  void exemptForTreasury() {
    ...
    final var result =
        subject.assess(
            treasuryTrigger, customSchedulesManager, balanceChangeManager, accumulator, props);
  ...
  void exemptsSelfPayments() {
    ...
    final var result =
        subject.assess(
            collectorTrigger, customSchedulesManager, balanceChangeManager, accumulator, props);
  ...
  void usesRoyaltyAssessorAppropriately() {
    ...
    final var result =
        subject.assess(
            royaltyTrigger, customSchedulesManager, balanceChangeManager, accumulator, props);
  ...
  private final BalanceChange fungibleTrigger =
      BalanceChange.changingFtUnits(fungibleTokenId, fungibleTokenId.asGrpcToken(), fungibleDebit);
  private final BalanceChange treasuryTrigger =
      BalanceChange.changingFtUnits(
          fungibleTokenId, fungibleTokenId.asGrpcToken(), fungibleTreasuryDebit);
  private final BalanceChange collectorTrigger =
      BalanceChange.changingFtUnits(
          fungibleTokenId, fungibleTokenId.asGrpcToken(), fungibleCollectorDebit);
