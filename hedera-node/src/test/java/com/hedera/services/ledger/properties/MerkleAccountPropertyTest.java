...
public class MerkleAccountPropertyTest {
	...
	public void gettersAndSettersWork() throws Exception {
		...
		long origExpiry = 1L;
		MerkleAccountEntities origTokens = new MerkleAccountEntities();
		origTokens.associateAllTokens(Set.of(IdUtils.asToken("1.2.3")));
		origTokens.associateAllTokens(Set.of(IdUtils.asToken("3.2.1")));
		...
		long newExpiry = 2L;
		MerkleAccountEntities newTokens = origTokens.copy();
		newTokens.dissociateAllTokens(Set.of(IdUtils.asToken("1.2.3")));
		newTokens.associateAllTokens(Set.of(IdUtils.asToken("8.9.10")));
