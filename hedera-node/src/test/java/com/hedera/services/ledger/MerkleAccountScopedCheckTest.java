...
class MerkleAccountScopedCheckTest {
	...
	void failsAsExpectedWhenSpenderIsNotGrantedAllowanceOnFungible() {
		...
		assertEquals(SPENDER_DOES_NOT_HAVE_ALLOWANCE, subject.validateFungibleTokenAllowance(account, null, changeSet));
	}
	...
	void failsAsExpectedWhenSpenderIsHasInsufficientAllowanceOnFungible() {
		...
		assertEquals(AMOUNT_EXCEEDS_ALLOWANCE, subject.validateFungibleTokenAllowance(account, null, changeSet));
	}
	...
	void happyPathWithSpenderIsHasAllowanceOnFungible() {
		...
		assertEquals(OK, subject.validateFungibleTokenAllowance(account, null, changeSet));
	}
	...
	void failsAsExpectedWhenSpenderIsNotGrantedAllowanceOnNFT() {
		...
		assertEquals(SPENDER_DOES_NOT_HAVE_ALLOWANCE, subject.validateNftAllowance(account, null, changeSet));
	}
	...
	void happyPathWithSpenderIsHasAllowanceOnAllNFT() {
		...
		assertEquals(OK, subject.validateNftAllowance(account, null, changeSet));
	}
