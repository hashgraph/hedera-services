...
class MerkleAccountScopedCheckTest {
  @Mock GlobalDynamicProperties dynamicProperties;

  @Mock OptionValidator validator;

  @Mock BalanceChange balanceChange;

  @Mock MerkleAccount account;

  @Mock Map<AccountProperty, Object> changeSet;
  ...
  void throwsAsExpected() {
    ...
    assertEquals(
        "Property " + AUTO_RENEW_PERIOD + " cannot be validated in scoped check", iae.getMessage());
  }
}
