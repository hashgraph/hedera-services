...
public class RecordsRunningHashLeafSerdeTest extends SelfSerializableDataTest<RecordsRunningHashLeaf> {
	...
	public static void assertEqualLeaves(final RecordsRunningHashLeaf a,
			final RecordsRunningHashLeaf b) {
		try {
	...
	private static void assertEqualRunningHashes(@Nullable final RunningHash a,
			@Nullable final RunningHash b) throws InterruptedException {
		if (a == b) {
			return;
