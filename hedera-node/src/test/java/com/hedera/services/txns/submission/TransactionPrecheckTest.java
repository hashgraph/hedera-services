...
class TransactionPrecheckTest {
  ...
  private void assertSuccess(
      long reqFee, Pair<TxnValidityAndFeeReq, Optional<SignedTxnAccessor>> response) {
  ...
  private void assertFailure(
      ResponseCodeEnum abort, Pair<TxnValidityAndFeeReq, Optional<SignedTxnAccessor>> response) {
