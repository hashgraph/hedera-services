...
class StorageExpiryTest {
    ...
    @Mock private MessageFrame stackBottomFrame;
    @Mock private MessageFrame stackTopFrame;
    @Mock private MessageFrame currentFrame;
    ...
    void lookupUsesImmediateRecipientIfPresentInAliasForm() {
        ...
        given(aliasManager.lookupIdBy(ByteString.copyFrom(nonMirrorAddress.toArrayUnsafe())))
                .willReturn(aContractNum);
