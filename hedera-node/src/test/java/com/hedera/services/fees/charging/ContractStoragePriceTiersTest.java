...
class ContractStoragePriceTiersTest {
  ...
  void doesntChargeZeroGivenNonZeroPrice() {
    givenTypicalSubject();
    final var degenerate = subject.priceOfPendingUsage(
  ...
  void failsOnZeroSlotsRequested() {
    ...
    assertThrows(IllegalArgumentException.class, () -> subject.priceOfPendingUsage(
  ...
  void alwaysFreeIfInFreeTier() {
    ...
    final var actual = subject.priceOfPendingUsage(
        someRate, 500_000_000, 3 * DEFAULT_REFERENCE_LIFETIME / 2,
  ...
  void failsOnDecreasingPrice() {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> ContractStoragePriceTiers.from(input, DEFAULT_FREE_TIER_LIMIT, DEFAULT_MAX_KV_PAIRS,
  ...
  void failsOnEmpty() {
    assertThrows(IllegalArgumentException.class,
        () -> ContractStoragePriceTiers.from("", DEFAULT_FREE_TIER_LIMIT, DEFAULT_MAX_KV_PAIRS,
            DEFAULT_REFERENCE_LIFETIME));
  }
  ...
  void objectMethodsAsExpected() {
    final var a = ContractStoragePriceTiers.from("1til10,5til50,1000til100",
        DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME);
    final var b = ContractStoragePriceTiers.from("1til10,5til50,10til100", DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME);
    final var c = ContractStoragePriceTiers.from("1til10,5til50,1000til200",
        DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME);
    final var d = a;
    final var e = ContractStoragePriceTiers.from("1til10,5til50,1000til100",
        DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME);
    final var f = ContractStoragePriceTiers.from("1til10,5til50,1000til100",
        DEFAULT_FREE_TIER_LIMIT - 1,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME);
    final var g = ContractStoragePriceTiers.from("1til10,5til50,1000til100",
        DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS - 1, DEFAULT_REFERENCE_LIFETIME);
    final var h = ContractStoragePriceTiers.from("1til10,5til50,1000til100",
        DEFAULT_FREE_TIER_LIMIT,
        DEFAULT_MAX_KV_PAIRS, DEFAULT_REFERENCE_LIFETIME - 1);
    final var desired =
        "ContractStoragePriceTiers{usageTiers=[10, 50, 100], prices=[100000, 500000, "
            + "100000000], freeTierLimit=100, maxTotalKvPairs=500000000, referenceLifetime=2592000}";
  ...
  private void givenDefaultSubjectWith(final String spec) {
    givenSubjectWith(spec, DEFAULT_FREE_TIER_LIMIT, DEFAULT_MAX_KV_PAIRS,
        DEFAULT_REFERENCE_LIFETIME);
  }
  ...
  private void givenSubjectWith(
      final String spec, final int freeTierLimit, final long maxTotalKvPairs,
      final long referenceLifetime) {
    subject = ContractStoragePriceTiers.from(spec, freeTierLimit, maxTotalKvPairs,
        referenceLifetime);
  }
