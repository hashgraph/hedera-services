...
class ContractStoragePriceTiersTest {
    ...
    void chargesBytecodeAsAtLeastOneKvPair() {
        ...
        final var codePrice =
                CANONICAL_TIERS.codePrice(someRate, DEFAULT_PERIOD, numKvPairs, code, reqLifetime);
        final var expectedPrice =
                CANONICAL_TIERS.slotPrice(someRate, DEFAULT_PERIOD, numKvPairs, 1, reqLifetime);
    ...
    void failsOnZeroSlotsRequested() {
        assertThrows(
                ...
                () -> CANONICAL_TIERS.slotPrice(someRate, DEFAULT_PERIOD, 666, 0, DEFAULT_PERIOD));
    }
    ...
    void failsOnNegativeLifetime() {
        assertThrows(
                IllegalArgumentException.class,
                () -> CANONICAL_TIERS.slotPrice(someRate, DEFAULT_PERIOD, 666, 1, -DEFAULT_PERIOD));
    }
    ...
    void getsExpectedForCanonicalPeriod() {
        ...
        final var actual =
                CANONICAL_TIERS.slotPrice(someRate, DEFAULT_PERIOD, 150_000_000, 1, DEFAULT_PERIOD);
    ...
    void objectMethodsAsExpected() {
        ...
        final var desired =
                "ContractStoragePriceTiers{usageTiers=[10, 50, 100], "
    ...
    private static final ExchangeRate someOtherRate =
