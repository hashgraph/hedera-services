...
class RecordedStorageFeeChargingTest {
    ...
    private static final ContractStoragePriceTiers canonicalTiers =
    ...
    void createsNoRecordWithNothingToDo() {
        subject.chargeStorageFees(
                numKvPairsUsed, Collections.emptyMap(), Collections.emptyMap(), accountsLedger);
    ...
    void chargesOnlyPositiveDeltasWithAutoRenewAccountPriority() {
        ...
        final var expectedACharge =
                canonicalTiers.slotPrice(someRate, canonicalLifetime, numKvPairsUsed, 2, aExpiry);
        final var expectedCCharge =
                canonicalTiers.slotPrice(someRate, canonicalLifetime, numKvPairsUsed, 4, cExpiry);
    ...
    void fallsBackToContractIfAutoRenewCannotCover() {
        ...
        final var expectedACharge =
                canonicalTiers.slotPrice(someRate, canonicalLifetime, numKvPairsUsed, 181, aExpiry);
