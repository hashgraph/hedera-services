...
class BootstrapPropertiesTest {
  ...
  private static final Map<String, Object> expectedProps =
      Map.ofEntries(
          ...
          entry("contracts.referenceSlotLifetime", 31_536_000L),
          entry("contracts.freeStorageTierLimit", 100),
          entry("contract.storageSlotPriceTiers", "0til100M,2000til450M"),
  ...
  void logsLoadedPropsOnInit() {
    ...
    assertThat(
        logCaptor.infoLogs(), contains(Matchers.startsWith(("Resolved bootstrap properties:"))));
  }
}
