...
import com.hedera.services.grpc.controllers.*;
...
class MiscUtilsTest {
    ...
    void hmm() throws TextFormat.InvalidEscapeSequenceException, InvalidProtocolBufferException {
        final var encoded = "\\325\\024\\251CVXV\\265V{\\201\\236\\235\\020\\266n\\341Sf\\303U\\351\\341#T\\\\\\\"\\265\\267\\210\\364W";
        final var raw = TextFormat.unescapeBytes(encoded);
        System.out.println(com.swirlds.common.utility.CommonUtils.hex(raw.toByteArray()));
    }
