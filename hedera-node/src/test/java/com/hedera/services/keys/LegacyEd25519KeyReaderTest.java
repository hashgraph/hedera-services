...
class LegacyEd25519KeyReaderTest {
  private final String expectedABytes =
      "447dc6bdbfc64eb894851825194744662afcb70efb8b23a6a24af98f0c1fd8ad";
  ...
  void getsExpectedABytes() {
    // expect:
    assertEquals(expectedABytes, subject.hexedABytesFrom(b64Loc, "START_ACCOUNT"));
  }
  ...
  void throwsIaeOnProblem() {
    // expect:
    assertThrows(
        IllegalArgumentException.class, () -> subject.hexedABytesFrom(invalidB64Loc, "NOPE"));
  }
}
