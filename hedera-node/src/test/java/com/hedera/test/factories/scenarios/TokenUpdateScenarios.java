...
public enum TokenUpdateScenarios implements TxnHandlingScenario {
  ...
  UPDATE_WITH_SUPPLY_KEYED_TOKEN {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedTokenUpdate().updating(KNOWN_TOKEN_WITH_SUPPLY).replacingSupply().get()));
    }
  },
  UPDATE_WITH_KYC_KEYED_TOKEN {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedTokenUpdate().updating(KNOWN_TOKEN_WITH_KYC).replacingKyc().get()));
    }
  },
  UPDATE_WITH_FREEZE_KEYED_TOKEN {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedTokenUpdate().updating(KNOWN_TOKEN_WITH_FREEZE).replacingFreeze().get()));
    }
  },
  UPDATE_WITH_WIPE_KEYED_TOKEN {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedTokenUpdate().updating(KNOWN_TOKEN_WITH_WIPE).replacingWipe().get()));
    }
  },
  UPDATE_WITH_MISSING_TOKEN {
    @Override
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedTokenUpdate().updating(MISSING_TOKEN).get()));
    }
  },
