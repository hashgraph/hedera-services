...
public enum ScheduleSignScenarios implements TxnHandlingScenario {
  SCHEDULE_SIGN_MISSING_SCHEDULE {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedScheduleSign().signing(UNKNOWN_SCHEDULE).get()));
    }
  },
  ...
  SCHEDULE_SIGN_KNOWN_SCHEDULE_WITH_PAYER {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedScheduleSign().signing(KNOWN_SCHEDULE_WITH_EXPLICIT_PAYER).get()));
    }
  ...
  SCHEDULE_SIGN_KNOWN_SCHEDULE_WITH_NOW_INVALID_PAYER {
    ...
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedScheduleSign().signing(KNOWN_SCHEDULE_WITH_NOW_INVALID_PAYER).get()));
    }
  }
}
