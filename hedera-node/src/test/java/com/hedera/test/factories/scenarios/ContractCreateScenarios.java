...
public enum ContractCreateScenarios implements TxnHandlingScenario {
  CONTRACT_CREATE_WITH_ADMIN_KEY {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedContractCreate().useAdminKey(true).get()));
    }
  },
  CONTRACT_CREATE_NO_ADMIN_KEY {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedContractCreate().useAdminKey(false).get()));
    }
  },
