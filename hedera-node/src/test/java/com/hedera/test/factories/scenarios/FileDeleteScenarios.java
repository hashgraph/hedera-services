...
public enum FileDeleteScenarios implements TxnHandlingScenario {
  VANILLA_FILE_DELETE_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileDelete(MISC_FILE_ID).get()));
    }
  },
  IMMUTABLE_FILE_DELETE_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileDelete(IMMUTABLE_FILE_ID).get()));
    }
  },
  MISSING_FILE_DELETE_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileDelete(MISSING_FILE_ID).get()));
    }
  }
}
