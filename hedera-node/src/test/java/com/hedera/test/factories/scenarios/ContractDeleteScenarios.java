...
public enum ContractDeleteScenarios implements TxnHandlingScenario {
  CONTRACT_DELETE_XFER_ACCOUNT_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedContractDelete(MISC_CONTRACT_ID).withBeneficiary(RECEIVER_SIG).get()));
    }
  },
  CONTRACT_DELETE_IMMUTABLE_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedContractDelete(IMMUTABLE_CONTRACT_ID).withBeneficiary(RECEIVER_SIG).get()));
    }
  },
  ...
  CONTRACT_DELETE_MISSING_ACCOUNT_BENEFICIARY_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedContractDelete(MISC_CONTRACT_ID).withBeneficiary(MISSING_ACCOUNT).get()));
    }
  },
  CONTRACT_DELETE_MISSING_CONTRACT_BENEFICIARY_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedContractDelete(MISC_CONTRACT_ID).withBeneficiary(MISSING_CONTRACT).get()));
    }
  }
}
