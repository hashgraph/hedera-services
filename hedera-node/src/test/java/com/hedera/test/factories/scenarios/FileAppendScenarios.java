...
public enum FileAppendScenarios implements TxnHandlingScenario {
  VANILLA_FILE_APPEND_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileAppend(MISC_FILE_ID).get()));
    }
  },
  ...
  IMMUTABLE_FILE_APPEND_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileAppend(IMMUTABLE_FILE_ID).get()));
    }
  },
  FILE_APPEND_MISSING_TARGET_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedFileAppend(MISSING_FILE_ID).get()));
    }
  }
}
