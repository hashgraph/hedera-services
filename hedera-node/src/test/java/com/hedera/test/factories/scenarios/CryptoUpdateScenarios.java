...
public enum CryptoUpdateScenarios implements TxnHandlingScenario {
  CRYPTO_UPDATE_NO_NEW_KEY_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedCryptoUpdate(MISC_ACCOUNT_ID).get()));
    }
  },
  CRYPTO_UPDATE_MISSING_ACCOUNT_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedCryptoUpdate(MISSING_ACCOUNT_ID).get()));
    }
  },
  ...
  CRYPTO_UPDATE_WITH_NEW_KEY_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedCryptoUpdate(MISC_ACCOUNT_ID).newAccountKt(NEW_ACCOUNT_KT).get()));
    }
  },
  ...
  CRYPTO_UPDATE_SYS_ACCOUNT_WITH_NO_NEW_KEY_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedCryptoUpdate(SYS_ACCOUNT_ID).get()));
    }
  },
