...
public enum ConsensusUpdateTopicScenarios implements TxnHandlingScenario {
  CONSENSUS_UPDATE_TOPIC_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedConsensusUpdateTopic(EXISTING_TOPIC_ID).get()));
    }
  },
  CONSENSUS_UPDATE_TOPIC_MISSING_TOPIC_SCENARIO {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedConsensusUpdateTopic(MISSING_TOPIC_ID).get()));
    }
  },
