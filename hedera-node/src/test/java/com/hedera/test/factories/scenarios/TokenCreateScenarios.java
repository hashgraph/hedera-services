...
public enum TokenCreateScenarios implements TxnHandlingScenario {
  ...
  TOKEN_CREATE_WITH_ADMIN_AND_FREEZE {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(
          from(newSignedTokenCreate().frozen().nonPayerKts(TOKEN_ADMIN_KT, TOKEN_FREEZE_KT).get()));
    }
  },
  TOKEN_CREATE_MISSING_ADMIN {
    public PlatformTxnAccessor platformTxn() throws Throwable {
      return new PlatformTxnAccessor(from(newSignedTokenCreate().missingAdmin().get()));
    }
  },
      ...
      return new PlatformTxnAccessor(
          from(
              newSignedTokenCreate()
                  .missingAdmin()
                  .plusCustomFee(
                      royaltyFee(1, 2, new FixedFeeSpec(1, new EntityId(2, 3, 4)), collector))
                  .get()));
    }
  },
      ...
      return new PlatformTxnAccessor(
          from(
              newSignedTokenCreate()
                  .missingAdmin()
                  .plusCustomFee(
                      royaltyFee(1, 2, new FixedFeeSpec(1, MISSING_ENTITY_ID), collector))
                  .get()));
    }
  },
