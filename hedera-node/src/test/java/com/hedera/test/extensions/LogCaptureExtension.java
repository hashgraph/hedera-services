...
/**
 * JUnit5 extension that reports logging events generated by an annotated {@link LoggingSubject}
 * per executed {@code @Test} method. The events are captured by a {@link LogCaptor} instance which
 * must be a field on the test instance.
 *
 * For example,
 *
 * <pre>
