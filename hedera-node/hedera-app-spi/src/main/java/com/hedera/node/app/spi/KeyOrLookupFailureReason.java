...
public record KeyOrLookupFailureReason(@Nullable HederaKey key, @Nullable ResponseCodeEnum failureReason) {
    ...
    private static KeyOrLookupFailureReason withFailureReason(
            final com.hederahashgraph.api.proto.java.ResponseCodeEnum accountIdDoesNotExist) {
    ...
    private static ResponseCodeEnum convertToPbj(
            final com.hederahashgraph.api.proto.java.ResponseCodeEnum accountIdDoesNotExist) {
