...
public record ContractsConfig(@ConfigProperty(defaultValue = "true") boolean itemizeStorageFees,
                              ...
                              //@ConfigProperty(defaultValue = "CONTRACT_STATE_CHANGE,CONTRACT_BYTECODE,CONTRACT_ACTION") Set<SidecarType> sidecars,
                              ...
                              @ConfigProperty(value = "precompile.exchangeRateGasCost", defaultValue = "100") long precompileExchangeRateGasCost,
                              @ConfigProperty(value = "precompile.htsDefaultGasCost", defaultValue = "10000") long precompileHtsDefaultGasCost,
                              @ConfigProperty(value = "precompile.exportRecordResults", defaultValue = "true") boolean precompileExportRecordResults,
                              @ConfigProperty(value = "precompile.htsEnableTokenCreate", defaultValue = "true") boolean precompileHtsEnableTokenCreate,
                              //@ConfigProperty(value = "precompile.unsupportedCustomFeeReceiverDebits", defaultValue = "") Set<CustomFeeType> precompileUnsupportedCustomFeeReceiverDebits,
                              @ConfigProperty(value = "precompile.atomicCryptoTransfer.enabled", defaultValue = "false") boolean precompileAtomicCryptoTransferEnabled,
                              @ConfigProperty(value = "precompile.hrcFacade.associate.enabled", defaultValue = "true") boolean precompileHrcFacadeAssociateEnabled,
