...
public class PropertyNames {
    ...
    public static final String CONTRACTS_CREATE_SYSTEM_CONTRACTS = "contracts.createSystemContracts";
    public static final String CONTRACTS_SYSTEM_CONTRACTS = "contracts.systemContracts";
