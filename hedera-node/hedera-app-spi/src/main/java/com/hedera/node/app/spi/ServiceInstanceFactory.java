...
/**
 * This class provides the ability to load {@link Service} implementations at runtime. The Java SPI (see {@link
 * ServiceLoader}) is used to provide such information at runtime. Since we use the Java module system the {@link
 * ServiceLoader} instance can not be created in the factory. It must be created in the module that add "uses"
 * information for the module to the {@code module-info.java}.
 */
public final class ServiceInstanceFactory {
