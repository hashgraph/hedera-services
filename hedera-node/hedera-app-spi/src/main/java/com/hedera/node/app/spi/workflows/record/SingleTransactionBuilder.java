 ...
 */
public interface SingleTransactionBuilder extends FeeBuilder {
    /**
     * Sets the transaction for this stream item builder.
     * @param transaction the transaction
     * @return this builder
     */
    SingleTransactionBuilder transaction(@NonNull Transaction transaction);
     ...
     * @return the builder
     */
    SingleTransactionBuilder status(@NonNull ResponseCodeEnum status);
     ...
     * @return the builder
     */
    SingleTransactionBuilder syncBodyIdFromRecordId();
     ...
     * @return the builder
     */
    SingleTransactionBuilder memo(@NonNull String memo);
     ...
     * @return the builder
     */
    SingleTransactionBuilder consensusTimestamp(@NonNull final Instant now);
     ...
     * @return the builder
     */
    SingleTransactionBuilder transactionID(@NonNull TransactionID transactionID);
     ...
     * @return the builder
     */
    SingleTransactionBuilder parentConsensus(@NonNull Instant parentConsensus);
     ...
     * @return this builder
     */
    SingleTransactionBuilder transactionBytes(@NonNull Bytes transactionBytes);
     ...
     * @return this builder
     */
    SingleTransactionBuilder exchangeRate(@NonNull ExchangeRateSet exchangeRate);
