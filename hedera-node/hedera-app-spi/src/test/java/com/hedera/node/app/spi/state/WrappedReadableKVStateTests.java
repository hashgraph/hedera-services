...
/**
 * This test extends the {@link ReadableKVStateBaseTests}, getting all the test methods used there,
 * but this time executed on a {@link WrappedReadableKVState}.
 */
class WrappedReadableKVStateTests extends ReadableKVStateBaseTests {
    @Override
