...
public class ObjectWritableSingletonState<T> extends WritableSingletonStateBase<T> {
    /**
     ...
     */
    public ObjectWritableSingletonState(
            @NonNull String stateKey,
            @NonNull Supplier<T> backingStoreAccessor,
            @NonNull Consumer<T> backingStoreMutator) {
        super(stateKey, backingStoreAccessor, backingStoreMutator);
    }
}
