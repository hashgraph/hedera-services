...
public class ObjectReadableSingletonState<T> extends ReadableSingletonStateBase<T> {
    /**
     ...
     *                             backing store.
     */
    public ObjectReadableSingletonState(@NonNull String stateKey, @NonNull Supplier<T> backingStoreAccessor) {
