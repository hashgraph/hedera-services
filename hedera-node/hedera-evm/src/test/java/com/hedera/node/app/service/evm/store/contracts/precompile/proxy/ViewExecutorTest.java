...
public class ViewExecutorTest {
    ...
    void computeGetTokenInfo() {
        ...
        try (MockedStatic<EvmTokenInfoPrecompile> utilities =
            ...
            given(tokenAccessor.evmInfoForToken(fungibleTokenAddress))
                    ...
                    .when(
                            () ->
                                    EvmNonFungibleTokenInfoPrecompile.decodeGetNonFungibleTokenInfo(
                                            any()))
                    .thenReturn(tokenInfoWrapper);
            given(tokenAccessor.evmInfoForToken(nonfungibleTokenAddress))
                    .willReturn(Optional.of(evmTokenInfo));
            given(tokenAccessor.evmNftInfo(nonfungibleTokenAddress, 1L))
