    ...
    void testFees() {
        ...
        assertEquals(
                "RoyaltyFee{numerator=15, denominator=100, amount=50,"
                        ...
                        + " feeCollector=0x00000000000000000000000000000000000005ce}",
                royaltyFee.toString());
        assertEquals(
                "FixedFee{amount=100, denominatingTokenId=null, useHbarsForPayment=true,"
                        + " useCurrentTokenForPayment=false,"
                        + " feeCollector=0x00000000000000000000000000000000000005ce}",
                fixedFeeInHbar.toString());
        assertEquals(
                "FractionalFee{numerator=15, denominator=100, getMinimumAmount=10,"
                        + " getMaximumAmount=50, netOfTransfers=false,"
                        + " feeCollector=0x00000000000000000000000000000000000005ce}",
                fractionalFee.toString());
