...
public class UtilServiceFactory implements ServiceFactory<UtilService> {
    @NonNull
    @Override
    public Class<UtilService> getServiceClass() {
        return UtilService.class;
    }

    @NonNull
    @Override
    public UtilService createService(final ServiceProvider serviceProvider, final FacilityFacade facilityFacade) {
