...
package com.hedera.node.app.service.networkadmin.impl.codec;
...
public class MonoSpecialFilesAdapterCodec implements Codec<MerkleSpecialFiles> {
    @NonNull
    @Override
    public MerkleSpecialFiles parse(final @NonNull ReadableSequentialData input, final boolean strictMode, final int maxDepth) throws ParseException {
        try {
