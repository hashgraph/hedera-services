...
class HederaEvmStaticCallOperationTest {
    ...
    private HederaEvmStaticCallOperation subject;

    @BeforeEach
    void setup() {
        subject = new HederaEvmStaticCallOperation(calc, addressValidator);
    }
    ...
    private void commonSetup(
            MessageFrame evmMsgFrame, AbstractLedgerEvmWorldUpdater worldUpdater, Account acc) {
        given(evmMsgFrame.getWorldUpdater()).willReturn(worldUpdater);
        given(worldUpdater.get(any())).willReturn(acc);
    }
}
