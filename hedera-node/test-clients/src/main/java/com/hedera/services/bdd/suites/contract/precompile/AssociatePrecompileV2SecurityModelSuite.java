...
public class AssociatePrecompileV2SecurityModelSuite {
    ...
    final Stream<DynamicTest> v2Security031AssociateSingleTokenWithDelegateContractKeyLegacy() {

        return propertyPreservingHapiSpec("v2Security031AssociateSingleTokenWithDelegateContractKeyLegacy")
    ...
    @LeakyHapiTest({PROPERTY_OVERRIDES, FEE_SCHEDULE_OVERRIDES})
    final Stream<DynamicTest> v2Security006TokenAssociateNegativeTestsLegacy() {
        return propertyPreservingHapiSpec("v2Security006TokenAssociateNegativeTestsLegacy")
                .preserving("entities.unlimitedAutoAssociationsEnabled")
                .given(
                        overriding("entities.unlimitedAutoAssociationsEnabled", FALSE_VALUE),
                        uploadCustomFeeSchedules(GENESIS, FEE_SCHEDULE_JSON),
    ...
    @LeakyHapiTest({PROPERTY_OVERRIDES, FEE_SCHEDULE_OVERRIDES})
    final Stream<DynamicTest> v2Security010NestedAssociateNftAndNonFungibleTokensLegacy() {

        return propertyPreservingHapiSpec("v2Security010NestedAssociateNftAndNonFungibleTokensLegacy")
                .preserving("entities.unlimitedAutoAssociationsEnabled")
                .given(
                        overriding("entities.unlimitedAutoAssociationsEnabled", FALSE_VALUE),
                        uploadCustomFeeSchedules(GENESIS, FEE_SCHEDULE_JSON),
    ...
    @LeakyHapiTest({PROPERTY_OVERRIDES, FEE_SCHEDULE_OVERRIDES})
    final Stream<DynamicTest> v2Security036TokenAssociateFromDelegateCallWithDelegateContractIdLegacy() {

        return propertyPreservingHapiSpec("v2Security036TokenAssociateFromDelegateCallWithDelegateContractIdLegacy")
                .preserving("entities.unlimitedAutoAssociationsEnabled")
                .given(
                        overriding("entities.unlimitedAutoAssociationsEnabled", FALSE_VALUE),
                        uploadCustomFeeSchedules(GENESIS, FEE_SCHEDULE_JSON),
    ...
    final Stream<DynamicTest> v2Security036TokenAssociateFromDelegateCallWithDelegateContractId() {
        ...
        return propertyPreservingHapiSpec("v2Security036TokenAssociateFromDelegateCallWithDelegateContractId")
                .preserving("entities.unlimitedAutoAssociationsEnabled")
                .given(
                        overriding("entities.unlimitedAutoAssociationsEnabled", TRUE_VALUE),
                        cryptoCreate(ACCOUNT).balance(ONE_HUNDRED_HBARS),
    ...
    @LeakyHapiTest({PROPERTY_OVERRIDES, FEE_SCHEDULE_OVERRIDES})
    final Stream<DynamicTest> v2Security041TokenAssociateFromStaticcallAndCallcodeLegacy() {

        return propertyPreservingHapiSpec("v2Security041TokenAssociateFromStaticcallAndCallcodeLegacy")
                .preserving("entities.unlimitedAutoAssociationsEnabled")
                .given(
                        overriding("entities.unlimitedAutoAssociationsEnabled", FALSE_VALUE),
                        uploadCustomFeeSchedules(GENESIS, FEE_SCHEDULE_JSON),
