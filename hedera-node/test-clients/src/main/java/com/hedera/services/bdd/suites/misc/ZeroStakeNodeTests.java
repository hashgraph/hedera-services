...
public class ZeroStakeNodeTests extends HapiSuite {
    private static final Logger log = LogManager.getLogger(ZeroStakeNodeTests.class);

    public static void main(String... args) throws Exception {
        new ZeroStakeNodeTests().runSuiteSync();
    }
