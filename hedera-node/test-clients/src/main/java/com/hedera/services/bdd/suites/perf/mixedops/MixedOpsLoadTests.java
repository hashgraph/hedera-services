...
public class MixedOpsLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(MixedOpsLoadTests.class);
    ...
    public static void main(String... args) {
        parseArgs(args);
        MixedOpsLoadTests suite = new MixedOpsLoadTests();
        suite.runSuiteSync();
    }
