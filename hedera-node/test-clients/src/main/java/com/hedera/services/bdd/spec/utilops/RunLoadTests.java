...
public class RunLoadTests extends UtilOp {
    private static final Logger log = LogManager.getLogger(RunLoadTests.class);
    ...
    public RunLoadTests tps(DoubleSupplier targetTps) {
        this.targetTps = targetTps;
        return this;
    }

    public RunLoadTests setMemoLength(IntSupplier memoLength) {
        this.memoLength = memoLength;
        return this;
    }

    public RunLoadTests tolerance(IntSupplier tpsTolerance) {
        this.tpsTolerancePercentage = tpsTolerance;
        return this;
    }

    public RunLoadTests allowedSecsBelow(IntSupplier allowedSecsBelow) {
        this.secsAllowedBelowTolerance = allowedSecsBelow;
        return this;
    }

    public RunLoadTests setNumberOfThreads(IntSupplier numberOfThreads) {
        this.threads = numberOfThreads;
        return this;
    }

    public RunLoadTests setTotalTestAccounts(IntSupplier totalTestAccounts) {
        this.totalTestAccounts = totalTestAccounts;
        return this;
    }

    public RunLoadTests setTotalTestTopics(IntSupplier totalTestTopics) {
        this.totalTestTopics = totalTestTopics;
        return this;
    }

    public RunLoadTests setTotalTestTokens(IntSupplier totalTestTokens) {
        this.totalTestTokens = totalTestTokens;
        return this;
    }

    public RunLoadTests setTotalTokenAssociations(IntSupplier totalTokenAssociations) {
        this.totalTokenAssociations = totalTokenAssociations;
        return this;
    }

    public RunLoadTests setTotalScheduled(IntSupplier totalScheduled) {
        this.totalScheduled = totalScheduled;
        return this;
    }

    public RunLoadTests setDurationTokenTransfer(IntSupplier durationTokenTransfer) {
        this.durationTokenTransfer = durationTokenTransfer;
        return this;
    }

    public RunLoadTests setDurationCreateTokenAssociation(IntSupplier durationCreateTokenAssociation) {
        this.durationCreateTokenAssociation = durationCreateTokenAssociation;
        return this;
    }

    public RunLoadTests setTestTreasureStartAccount(IntSupplier testTreasureStartAccount) {
        this.testTreasureStartAccount = testTreasureStartAccount;
        return this;
    }

    public RunLoadTests setTotalTestTokenAccounts(IntSupplier totalTestTokenAccts) {
        this.totalTestTokenAccounts = totalTestTokenAccts;
        return this;
    }

    public RunLoadTests setHCSSubmitMessageSize(IntSupplier submitMessageSize) {
        this.hcsSubmitMessageSize = submitMessageSize;
        return this;
    }

    public RunLoadTests setHCSSubmitMessageSizeVar(IntSupplier submitMessageSizeVar) {
        this.hcsSubmitMessageSizeVar = submitMessageSizeVar;
        return this;
    }

    public RunLoadTests setInitialBalance(LongSupplier initialBalance) {
        this.initialBalance = initialBalance;
        return this;
    }

    public RunLoadTests setTestTopicId(IntSupplier testTopicId) {
        this.testTopicId = testTopicId;
        return this;
    }

    public RunLoadTests setBalancesExportPeriodSecs(IntSupplier balancesExportPeriodSecs) {
        this.balancesExportPeriodSecs = balancesExportPeriodSecs;
        return this;
    }

    public RunLoadTests setClientToExportBalances(BooleanSupplier clientToExportBalances) {
        this.clientToExportBalances = clientToExportBalances;
        return this;
    }

    public RunLoadTests lasting(LongSupplier duration, Supplier<TimeUnit> ofUnit) {
        this.testDuration = duration;
        this.ofUnit = ofUnit;
        return this;
    }

    public RunLoadTests(Supplier<HapiSpecOperation[]> opSource) {
