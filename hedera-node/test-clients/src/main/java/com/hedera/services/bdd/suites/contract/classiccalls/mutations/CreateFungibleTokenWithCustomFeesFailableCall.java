...
public class CreateFungibleTokenWithCustomFeesFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function(
            "createFungibleTokenWithCustomFees((string,string,address,string,bool,uint32,bool,(uint256,(bool,address,bytes,bytes,address))[],(int64,address,int64)),int64,int32,(int64,address,bool,bool,address)[],(int64,int64,int64,int64,bool,address)[])",
            "(int64,address)");

    public CreateFungibleTokenWithCustomFeesFailableCall() {
        super(EnumSet.of(INVALID_ACCOUNT_ID_FAILURE));
    }

    @Override
    public String name() {
        return "createFungibleTokenWithCustomFees";
    }
