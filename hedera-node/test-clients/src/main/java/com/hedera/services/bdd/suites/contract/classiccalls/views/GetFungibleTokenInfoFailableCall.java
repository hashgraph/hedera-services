...
public class GetFungibleTokenInfoFailableCall extends AbstractFailableStaticCall {
    private static final Function SIGNATURE = new Function("getFungibleTokenInfo(address)");

    public GetFungibleTokenInfoFailableCall() {
        super(EnumSet.of(INVALID_TOKEN_ID_FAILURE));
    }

    @Override
    public String name() {
        return "getFungibleTokenInfo";
    }
