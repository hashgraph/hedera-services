        ...
        return hapiTest(
                ...
                withOpContext((spec, opLog) -> {
                    ...
                    final var parentContractId =
                            CommonUtils.hex(asEvmAddress(parentId.getShardNum(), parentId.getRealmNum(), parentId.getContractNum()));
                    final var firstChildId = createdIds.get(1);
                    final var firstChildContractId =
                            CommonUtils.hex(asEvmAddress(firstChildId.getShardNum(), firstChildId.getRealmNum(), firstChildId.getContractNum()));
                    final var secondChildId = createdIds.get(2);
                    final var secondChildContractId =
                            CommonUtils.hex(asEvmAddress(secondChildId.getShardNum(), secondChildId.getRealmNum(), secondChildId.getContractNum()));
                    final var thirdChildId = createdIds.get(3);
                    final var thirdChildContractId =
                            CommonUtils.hex(asEvmAddress(thirdChildId.getShardNum(), thirdChildId.getRealmNum(), thirdChildId.getContractNum()));
