...
public class ContractCallLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(ContractCallLoadTests.class);
    ...
    public static void main(String... args) {
        ...
        ContractCallLoadTests suite = new ContractCallLoadTests();
        suite.runSuiteSync();
    }
