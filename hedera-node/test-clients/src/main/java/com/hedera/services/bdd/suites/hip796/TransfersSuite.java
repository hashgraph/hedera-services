...
public class TransfersSuite extends HapiSuite {
    ...
    /**
     * <b>Transfer-2</b>
     * <p>As an owner of an account with a partition, I want to transfer tokens to another user that does not already have the same partition, but can have the same partition auto-associated.
     *
     * @return the HapiSpec for this HIP-796 user story
     */
    @HapiTest
