...
public class SStoreOperationLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(SStoreOperationLoadTests.class);
    ...
    public static void main(String... args) {
        ...
        SStoreOperationLoadTests suite = new SStoreOperationLoadTests();
        suite.runSuiteSync();
    }
