...
import com.hedera.node.app.spi.workflows.record.SingleTransactionStreamBuilder.ReversingBehavior;
 ...
 * behavior {@link SingleTransactionStreamBuilder.ReversingBehavior#REMOVABLE}, and whose originating savepoint was rolled back.
 * <p>
 * All other stream items are expected to be present in the record stream once created; but if they are
 * {@link SingleTransactionStreamBuilder.ReversingBehavior#REVERSIBLE}, their status may be changed from {@code SUCCESS} to
 * {@code REVERTED_SUCCESS} when their originating savepoint is rolled back.
 * <p>
 * Only {@link SingleTransactionStreamBuilder.ReversingBehavior#IRREVERSIBLE} streams items appear unchanged in the record stream no matter whether
