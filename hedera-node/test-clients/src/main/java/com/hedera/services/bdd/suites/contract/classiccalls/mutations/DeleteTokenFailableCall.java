...
public class DeleteTokenFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("deleteToken(address)", "(int64)");

    public DeleteTokenFailableCall() {
