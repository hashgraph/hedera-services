 ...
 * ContractInfo
 */
public class MixedSmartContractOpsLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(MixedSmartContractOpsLoadTests.class);

    public static void main(String... args) {
        parseArgs(args);

        MixedSmartContractOpsLoadTests suite = new MixedSmartContractOpsLoadTests();
        suite.runSuiteSync();
    }
