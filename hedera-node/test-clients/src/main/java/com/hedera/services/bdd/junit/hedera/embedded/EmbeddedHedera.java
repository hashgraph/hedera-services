...
public interface EmbeddedHedera {
    ...
    /**
     * Returns the platform state accessor of the embedded Hedera node.
     *
     * @return the platform state accessor of the embedded Hedera node
     */
    PlatformStateAccessor platformState();
