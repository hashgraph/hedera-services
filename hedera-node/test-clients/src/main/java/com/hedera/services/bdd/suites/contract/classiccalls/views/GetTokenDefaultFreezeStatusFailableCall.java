...
public class GetTokenDefaultFreezeStatusFailableCall extends AbstractFailableStaticCall {
    private static final Function SIGNATURE = new Function("getTokenDefaultFreezeStatus(address)");

    public GetTokenDefaultFreezeStatusFailableCall() {
        super(EnumSet.of(INVALID_TOKEN_ID_FAILURE));
    }

    @Override
    public String name() {
        return "getTokenDefaultFreezeStatus";
    }
