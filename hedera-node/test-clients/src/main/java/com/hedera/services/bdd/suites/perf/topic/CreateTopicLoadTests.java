...
public class CreateTopicLoadTests extends LoadTests {

    private static final Logger log = LogManager.getLogger(CreateTopicLoadTests.class);

    public static void main(String... args) {
        parseArgs(args);

        CreateTopicLoadTests suite = new CreateTopicLoadTests();
        suite.runSuiteSync();
    }
