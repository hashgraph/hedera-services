...
public class GetTokenExpiryInfoFailableCall extends AbstractFailableStaticCall {
    private static final Function SIGNATURE = new Function("getTokenExpiryInfo(address)");

    public GetTokenExpiryInfoFailableCall() {
        super(EnumSet.of(INVALID_TOKEN_ID_FAILURE));
    }

    @Override
    public String name() {
        return "getTokenExpiryInfo";
    }
