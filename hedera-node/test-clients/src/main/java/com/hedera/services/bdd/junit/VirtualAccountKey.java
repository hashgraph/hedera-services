...
public class VirtualAccountKey implements VirtualKey {
    ...
    public VirtualAccountKey() {
        this(0, 0, 0);
    }

    public VirtualAccountKey(final long realmID, final long shardID, final long accountID) {
    ...
    public boolean equals(final Object other) {
        ...
        final VirtualAccountKey that = (VirtualAccountKey) other;
