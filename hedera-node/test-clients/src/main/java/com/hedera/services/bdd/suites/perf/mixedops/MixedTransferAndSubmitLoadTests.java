...
public class MixedTransferAndSubmitLoadTests extends HapiSuite {
    private static final Logger log = LogManager.getLogger(MixedTransferAndSubmitLoadTests.class);

    public static void main(String... args) {
        MixedTransferAndSubmitLoadTests suite = new MixedTransferAndSubmitLoadTests();
        suite.runSuiteSync();
    }
