 ...
 * clear.
 */
public class QueryOnlyLoadTests extends LoadTests {
    private static final Logger log = LogManager.getLogger(QueryOnlyLoadTests.class);
    ...
    public static void main(String... args) {
        parseArgs(args);
        QueryOnlyLoadTests suite = new QueryOnlyLoadTests();
        suite.runSuiteSync();
    }
