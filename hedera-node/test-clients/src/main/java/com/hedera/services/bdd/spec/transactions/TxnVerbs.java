...
import com.hedera.services.bdd.spec.transactions.token.HapiPartitionDelete;
...
import com.hedera.services.bdd.spec.transactions.token.HapiTokenLock;
...
import com.hedera.services.bdd.spec.transactions.token.HapiTokenUnlock;
...
public class TxnVerbs {
    ...
    public static HapiCryptoTransfer moveUnitsBetweenSameUserPartitions(
            String account, String fromPartitionToken, String toPartitionToken, long amount) {
        return new HapiCryptoTransfer(account, fromPartitionToken, toPartitionToken, amount);
    }

    public static HapiCryptoTransfer moveUnitsBetweenDifferentUserPartitions(
            String fromAccount, String fromPartitionToken, String toAccount, String toPartitionToken, long amount) {
