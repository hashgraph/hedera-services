...
@HapiTestLifecycle
public class LeakyTestsWithLongTermFlagEnabledTest {
    ...
    final Stream<DynamicTest> runAllTests() {
        var allDynamicTests = extractAllTestAnnotatedMethods(ALL_TESTS, IGNORED_TESTS, LeakyHapiTest.class, Map.of());
