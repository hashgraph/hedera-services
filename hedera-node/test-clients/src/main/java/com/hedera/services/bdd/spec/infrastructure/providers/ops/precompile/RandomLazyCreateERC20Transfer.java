...
public class RandomLazyCreateERC20Transfer implements OpProvider {
    ...
    public RandomLazyCreateERC20Transfer(HapiSpecRegistry registry, EntityNameProvider<Key> keys) {
