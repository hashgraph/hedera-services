...
public class SubmitMessageLoadTests extends LoadTests {

    private static final org.apache.logging.log4j.Logger log = LogManager.getLogger(SubmitMessageLoadTests.class);
    ...
    public static void main(String... args) {
        ...
        SubmitMessageLoadTests suite = new SubmitMessageLoadTests();
        suite.runSuiteSync();
    }
