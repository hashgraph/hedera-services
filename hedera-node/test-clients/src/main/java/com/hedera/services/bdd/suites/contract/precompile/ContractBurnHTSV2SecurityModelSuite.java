...
public class ContractBurnHTSV2SecurityModelSuite extends HapiSuite {
    ...
    private static final String SIGNER_BURNS_WITH_CONTRACT_ID = "signerBurnsAndTokenSupplyKeyHasTheIntermediaryContractId";
    private static final String SIGNER_BURNS_WITH_TRESHOLD_KEY = "tokenAndSignerHaveThresholdKey";
    private static final String SIGNER_BURNS_WITH_SIGNER_PUBLIC_KEY = "signerBurnsAndTokenSupplyKeyHasTheSignerPublicKey";
                ...
                .when(
                        withOpContext((spec, opLog) -> allRunFor(
                                ...
                                contractCall(
                                        ...
                                        .payingWith(SIGNER)
                                        .signedBy(SIGNER),
                                // Assert that the token is burdned - total supply should be decreased with the amount that was burned
                                ...
                                newKeyNamed(TRESHOLD_KEY_CORRECT_CONTRACT_ID).shape(TRESHOLD_KEY_SHAPE.signedWith(sigs(ON, BURN_TOKEN))),
                                // Update the token supply key to with the created key
                                tokenUpdate(FUNGIBLE_TOKEN).supplyKey(TRESHOLD_KEY_CORRECT_CONTRACT_ID),
                                ...
                                contractCall(
                                        ...
                                        .payingWith(SIGNER)
                                        .signedBy(SIGNER),
                                // Assert that the token is burned - total supply should be decreased with the amount that was burned
    ...
    final HapiSpec V2Security004FungibleTokenBurnNegative() {
        ...
        return propertyPreservingHapiSpec("V2Security004FungibleTokenBurnNegative")
                ...
                .when(withOpContext((spec, opLog) -> allRunFor(
                        ...
                        getTxnRecord(SIGNER_AND_TOKEN_HAVE_NO_UPDATED_KEYS).andAllChildRecords().logged(),
