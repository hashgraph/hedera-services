...
public abstract class HapiSpecOperation {
    ...
    @Nullable
    protected BodyModification modification = null;
    ...
    protected Transaction finalizedTxn(
        ...
        final Transaction.Builder builder = spec.txns().getReadyToSign(netDef, spec, modification);
        ...
        if (fee.isPresent()) {
            ...
            txn = getSigned(spec, spec.txns().getReadyToSign(netDef, spec, modification), keys);
        }
