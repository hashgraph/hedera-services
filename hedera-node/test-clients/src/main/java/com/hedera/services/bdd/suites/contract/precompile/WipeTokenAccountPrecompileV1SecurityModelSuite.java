...
public class WipeTokenAccountPrecompileV1SecurityModelSuite extends HapiSuite {
    ...
    private static final Logger log = LogManager.getLogger(WipeTokenAccountPrecompileV1SecurityModelSuite.class);
    ...
    public static void main(String... args) {
        new WipeTokenAccountPrecompileV1SecurityModelSuite().runSuiteSync();
    }
    ...
    final Stream<DynamicTest> wipeFungibleTokenScenarios() {
        ...
        return propertyPreservingHapiSpec("wipeFungibleTokenScenarios")
                ...
                .given(
                        overridingTwo(
                                ...
                                "ContractCall,CryptoTransfer,TokenAssociateToAccount,TokenCreate,TokenAccountWipe",
    ...
    final Stream<DynamicTest> wipeNonFungibleTokenScenarios() {
        ...
        return propertyPreservingHapiSpec("wipeNonFungibleTokenScenarios")
                .preserving(CONTRACTS_ALLOW_SYSTEM_USE_OF_HAPI_SIGS, CONTRACTS_MAX_NUM_WITH_HAPI_SIGS_ACCESS)
                .given(
                        overridingTwo(
                                CONTRACTS_ALLOW_SYSTEM_USE_OF_HAPI_SIGS,
                                ...
                                recordWith()
                                        ...
                                        .contractCallResult(resultWith()
                                                .contractCallResult(htsPrecompileResult()
                                                        .withStatus(ACCOUNT_DOES_NOT_OWN_WIPED_NFT)))),
                        childRecordsCheck(
