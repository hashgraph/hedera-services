...
import static com.hedera.services.bdd.junit.HapiTestEnv.HapiTestNodesType.UNDEFINED;
...
public class HapiTestEngine extends HierarchicalTestEngine<HapiTestEngineExecutionContext> /* implements TestEngine */ {
    ...
    public static final int NODES_SIZE = 4;
