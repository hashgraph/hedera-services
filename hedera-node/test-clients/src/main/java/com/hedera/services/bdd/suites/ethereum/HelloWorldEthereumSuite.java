...
public class HelloWorldEthereumSuite extends HapiSuite {
        ...
        HapiSpec badRelayClient() {
                ...
                return defaultHapiSpec("badRelayClient", NONDETERMINISTIC_ETHEREUM_DATA,
                                ...
                                .given(
                                                ...
                                                cryptoCreate(RELAYER)
                                                                ...
                                                                .exposingCreatedIdTo(
                                                                                id -> relayerEvmAddress.set(
                                                                                                asHexedSolidityAddress(
                                                                                                                0, 0,
                                                                                                                id.getAccountNum()))),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS, maliciousEOA,
                                                ...
                                                withOpContext((spec, opLog) -> {
                                                        ...
                                                        final var childCreation = lookup
                                                                        .getFirstNonStakingChildRecord();
                                                        maliciousEOAId.set(
                                                                        asAccountString(childCreation.getReceipt()
                                                                                        .getAccountID()));
                                                }),
        ...
        HapiSpec depositSuccess() {
                return defaultHapiSpec("depositSuccess", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(6 * ONE_MILLION_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
                                                                SECP_256K1_SOURCE_KEY, ONE_HUNDRED_HBARS))
                                                                .via("autoAccount"),
                                ...
                                .when(
                                                ...
                                                ethereumCall(PAY_RECEIVABLE_CONTRACT, DEPOSIT,
                                                ...
                                                ethereumCall(PAY_RECEIVABLE_CONTRACT, DEPOSIT,
                                                                ...
                                                                .createCallDataFile()
                                                                .hasKnownStatus(ResponseCodeEnum.SUCCESS),
                                                withOpContext((spec, opLog) -> updateSpecFor(spec,
                                                                                                                ...
                                                                                                                resultWith()
                                                                                                                                ...
                                                                                                                                .senderId(spec.registry()
                                                                                                                                                .getAccountID(spec
                                                                                                                                                                ...
                                                                                                                                                                .getAlias()
                                                                                                                                                                .toStringUtf8())))
                                                                                                .ethereumHash(ByteString
                                                                                                                .copyFrom(
                                                                                                                                spec.registry().getBytes(
                                                                                                                                                ETH_HASH_KEY)))))),
        ...
        HapiSpec ethereumCallWithCalldataBiggerThanMaxSucceeds() {
                ...
                return defaultHapiSpec("ethereumCallWithCalldataBiggerThanMaxSucceeds", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(6 * ONE_MILLION_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
                                                                                                ...
                                                                                                .contractCallResult(
                                                                                                                resultWith()
                                                                                                                                .logs(inOrder(logWith()
                                                                                                                                                .longAtBytes(largerThanMaxCalldata.length,
                                                                                                                                                                24)
                                                                                                                                                .withTopicsInOrder(
                                                                                                                                                                List.of(eventSignatureOf(
                                                                                                                                                                                "Info(uint256)")))))
                                                                                                                                .senderId(spec.registry()
                                                                                                                                                .getAccountID(spec
                                                                                                                                                                .registry()
        ...
        HapiSpec smallContractCreate() {
                return defaultHapiSpec("smallContractCreate", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(6 * ONE_MILLION_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
        ...
        HapiSpec bigContractCreate() {
                ...
                return defaultHapiSpec("bigContractCreate", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(6 * ONE_MILLION_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
        ...
        HapiSpec contractCreateWithConstructorArgs() {
                final var contractAdminKey = "contractAdminKey";
                return defaultHapiSpec("contractCreateWithConstructorArgs", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(6 * ONE_MILLION_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
        ...
        HapiSpec topLevelBurnToZeroAddressReverts() {
                ...
                return defaultHapiSpec(
                                ...
                                .when(cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS, SECP_256K1_SOURCE_KEY,
                                                ONE_HUNDRED_HBARS)))
                ...
                return defaultHapiSpec("topLevelSendToReceiverSigRequiredAccountReverts")
                                .given(
                                                ...
                                                cryptoCreate(receiverSigAccount)
                                                                ...
                                                                .exposingCreatedIdTo(id -> receiverMirrorAddr
                                                                                .set(asSolidityAddress(id))),
                                                uploadInitCode(JUST_SEND_CONTRACT),
                                                contractCreate(JUST_SEND_CONTRACT))
                                .when(
                                                balanceSnapshot(preCallBalance, receiverSigAccount),
                                                sourcing(() -> ethereumCryptoTransferToExplicit(
                                                                receiverMirrorAddr.get(), 123)
                                                                .type(EthTxData.EthTransactionType.EIP1559)
                                                                .signingWith(SECP_256K1_SOURCE_KEY)
                                                                .payingWith(RELAYER)
                                                                .nonce(0)
                                ...
                                .then(getAccountBalance(receiverSigAccount)
                                                .hasTinyBars(changeFromSnapshot(preCallBalance, 0L)));
        }

        @HapiTest
        HapiSpec internalBurnToZeroAddressReverts() {
                return defaultHapiSpec("internalBurnToZeroAddressReverts", NONDETERMINISTIC_ETHEREUM_DATA)
                                .given(
                                                newKeyNamed(SECP_256K1_SOURCE_KEY).shape(SECP_256K1_SHAPE),
                                                cryptoCreate(RELAYER).balance(123 * ONE_HUNDRED_HBARS),
                                                cryptoTransfer(tinyBarsFromAccountToAlias(GENESIS,
                                ...
                                .then(ethereumCall(JUST_SEND_CONTRACT, SEND_TO, BigInteger.ZERO,
