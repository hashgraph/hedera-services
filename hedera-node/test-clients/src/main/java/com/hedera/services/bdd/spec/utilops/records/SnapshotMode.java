...
public enum SnapshotMode {
     ...
     */
    TAKE_FROM_HAPI_TEST_STREAMS(TargetNetworkType.SHARED_HAPI_TEST_NETWORK),
    /**
     ...
     */
    FUZZY_MATCH_AGAINST_HAPI_TEST_STREAMS(TargetNetworkType.SHARED_HAPI_TEST_NETWORK);
