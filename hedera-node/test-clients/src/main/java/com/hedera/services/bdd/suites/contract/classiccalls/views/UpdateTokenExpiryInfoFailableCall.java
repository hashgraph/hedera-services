...
public class UpdateTokenExpiryInfoFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("updateTokenExpiryInfo(address,(int64,address,int64))", "(int64)");
    ...
    public byte[] encodedCall(@NonNull final ClassicFailureMode mode, @NonNull final HapiSpec spec) {
        ...
        return SIGNATURE.encodeCallWithArgs(INVALID_TOKEN_ADDRESS, Tuple.of(1L, INVALID_TOKEN_ADDRESS, 2L)).array();
    }
}
