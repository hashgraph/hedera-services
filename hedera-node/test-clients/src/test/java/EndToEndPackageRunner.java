...
class EndToEndPackageRunner extends TestBase {
    ...
    Collection<DynamicContainer> contractTraceability() {
        return List.of(extractSpecsFromSuite(TraceabilitySuite::new));
    }
    ...
    Collection<DynamicContainer> streaming() {
        return List.of(extractSpecsFromSuite(RunTransfers::new));
    }
    ...
    Collection<DynamicContainer> utils() {
        return List.of(extractSpecsFromSuite(SubmitMessagePerfSuite::new));
    }
}
