...
import static com.hedera.services.bdd.junit.hedera.embedded.fakes.tss.PlaceholderTssLibrary.SIGNATURE_SCHEMA;
...
class FakeTssLibraryTest {
    ...
    @Test
    void sign() {
        final var fakeTssLibrary = new com.hedera.services.bdd.junit.hedera.embedded.fakes.tss.PlaceholderTssLibrary(1);
    ...
    void aggregatePrivateShares() {
        final var fakeTssLibrary = new com.hedera.services.bdd.junit.hedera.embedded.fakes.tss.PlaceholderTssLibrary(2);
    ...
    void aggregatePrivateSharesWithNotEnoughShares() {
        final var fakeTssLibrary = new com.hedera.services.bdd.junit.hedera.embedded.fakes.tss.PlaceholderTssLibrary(3);
        final var privateShares = new ArrayList<TssPrivateShare>();
    ...
    void verifySignature() {
        ...
        final var fakeTssLibrary = new com.hedera.services.bdd.junit.hedera.embedded.fakes.tss.PlaceholderTssLibrary(threshold);
