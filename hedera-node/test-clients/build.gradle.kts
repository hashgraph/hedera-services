...
dependencies {
  javaModuleDependencies {
    ...
    eetRuntimeOnly(project(":hedera-node:node-app"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-consensus"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-consensus-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-contract"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-contract-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-evm"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-evm-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-file"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-file-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-mono"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-network-admin"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-network-admin-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-schedule"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-schedule-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-token"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-token-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-util"))
    eetRuntimeOnly(project(":hedera-node:node-app-service-util-impl"))
    eetRuntimeOnly(project(":hedera-node:node-app-spi"))
  }
}
