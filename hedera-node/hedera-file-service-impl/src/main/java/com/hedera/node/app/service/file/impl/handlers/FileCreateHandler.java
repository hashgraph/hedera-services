...
public class FileCreateHandler implements TransactionHandler {
    ...
    public void handle(@NonNull final HandleContext handleContext) {
        ...
        final var fileCreateTransactionBody = handleContext.body().fileCreate();
        ...
        try {
            ...
            handleContext.recordBuilder(CreateFileRecordBuilder.class)
                            .setCreatedFile(file.fileNumber());
