...
class ExpectedCustomThrottlesTest {
  ...
  void release0160HasExpected() {
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(ConsensusCreateTopic), "Missing ConsensusCreateTopic!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(ConsensusUpdateTopic), "Missing ConsensusUpdateTopic!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(ConsensusDeleteTopic), "Missing ConsensusDeleteTopic!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(ConsensusSubmitMessage), "Missing ConsensusSubmitMessage!");
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenGetAccountNftInfos), "Missing TokenGetAccountNftInfos!");
    assertTrue(OPS_FOR_RELEASE_0160.contains(TokenGetNftInfos), "Missing TokenGetNftInfos!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenUnfreezeAccount), "Missing TokenUnfreezeAccount!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenGrantKycToAccount), "Missing TokenGrantKycToAccount!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenRevokeKycFromAccount),
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenAssociateToAccount), "Missing TokenAssociateToAccount!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenDissociateFromAccount),
        "Missing TokenDissociateFromAccount!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TokenFeeScheduleUpdate), "Missing TokenFeeScheduleUpdate!");
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(ConsensusGetTopicInfo), "Missing ConsensusGetTopicInfo!");
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(CryptoGetAccountRecords), "Missing CryptoGetAccountRecords!");
    ...
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TransactionGetReceipt), "Missing TransactionGetReceipt!");
    assertTrue(
        OPS_FOR_RELEASE_0160.contains(TransactionGetRecord), "Missing TransactionGetRecord!");
