...
class FeeBuilderTest {
    ...
    private final FeeComponents feeComponents =
    ...
    private final FeeData feeData =
            FeeData.newBuilder()
                    ...
                    .build();
    private final FeeData feeMatrices =
            FeeData.newBuilder()
                    .setNetworkdata(feeComponents)
                    .setNodedata(feeComponents)
                    .setServicedata(feeComponents)
    ...
    private final ByteString bodyBytes =
    ...
    void assertGetTinybarsFromTinyCents() {
        var exchangeRate = ExchangeRate.newBuilder().setCentEquiv(10).setHbarEquiv(100).build();
    ...
    void assertGetTransactionRecordSizeContractCall() {
        var transactionRecord =
                transactionRecordBuilder.setContractCallResult(contractFunctionResult).build();
    ...
    void assertGetTransactionRecordSizeContractCreate() {
        var contractFunctionResult =
                ContractFunctionResult.newBuilder()
                        ...
                        .build();
        var transactionRecord =
                transactionRecordBuilder.setContractCreateResult(contractFunctionResult).build();
                ...
                Key.newBuilder()
                        .setEd25519(
                                ByteString.copyFromUtf8(
                                        "a479462fba67674b5a41acfb16cb6828626b61d3f389fa611005a45754130e5c749073c0b1b791596430f4a54649cc8a3f6d28147dd4099070a5c3c4811d1771"))
                        .build();
        Key validED25519Keys =
                Key.newBuilder()
                        .setKeyList(
                                KeyList.newBuilder().addKeys(validKey).addKeys(validKey1).build())
                        .build();
        assertEquals(
                countKeyMetatData.length,
                FeeBuilder.calculateKeysMetadata(validED25519Keys, countKeyMetatData).length);
        ...
        KeyList thresholdKeyList =
                KeyList.newBuilder()
                        ...
                        .addKeys(
                                Key.newBuilder()
                                        .setEd25519(
                                                ByteString.copyFromUtf8("bbbbbbbbbbbbbbbbbbbbb"))
                                        .build())
                        .build();
        ThresholdKey thresholdKey =
                ThresholdKey.newBuilder().setKeys(thresholdKeyList).setThreshold(2).build();
