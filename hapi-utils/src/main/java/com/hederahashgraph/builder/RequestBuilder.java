...
public class RequestBuilder {
  ...
  public static Transaction getCreateAccountBuilder(
      ...
      Duration autoRenew) {
    Key keys =
        Key.newBuilder().setKeyList(KeyList.newBuilder().addAllKeys(keyList).build()).build();
  ...
  public static Query getCryptoGetInfoQuery(
    ...
    QueryHeader queryHeader =
        QueryHeader.newBuilder().setResponseType(responseType).setPayment(transaction).build();
  ...
  public static Transaction getFileDeleteBuilder(
      ...
      String memo,
      FileID fileID) {
    FileDeleteTransactionBody FileDeleteTransaction =
  ...
  public static Query getContractGetInfoQuery(
    ...
    return Query.newBuilder()
        .setContractGetInfo(
            ContractGetInfoQuery.newBuilder().setContractID(contractId).setHeader(queryHeader))
        .build();
  }
  ...
  public static Query getContractGetBytecodeQuery(
    ...
    return Query.newBuilder()
        .setContractGetBytecode(
            ContractGetBytecodeQuery.newBuilder().setContractID(contractId).setHeader(queryHeader))
        .build();
  }
  ...
  public static Query getBySolidityIDQuery(
    ...
    return Query.newBuilder()
        .setGetBySolidityID(
            GetBySolidityIDQuery.newBuilder().setSolidityID(solidityID).setHeader(queryHeader))
        .build();
  }
    ...
    return ExchangeRateSet.newBuilder()
        .setCurrentRate(
            getExchangeRateBuilder(
                currentHbarEquivalent, currentCentEquivalent, currentExpirationSeconds))
        .setNextRate(
            getExchangeRateBuilder(nextHbarEquivalent, nextCentEquivalent, nextExpirationSeconds))
        .build();
  }
}
