...
public class OverflowCheckingCalc {
   ...
   * resource types.)
   *
   * <p>The second input is a {@code FeeData} instance that has the price of each resource in units
   * of 1/1000th of a tinycent.
   *
  ...
  public FeeObject fees(
      UsageAccumulator usage, FeeData prices, ExchangeRate rate, long multiplier) {
