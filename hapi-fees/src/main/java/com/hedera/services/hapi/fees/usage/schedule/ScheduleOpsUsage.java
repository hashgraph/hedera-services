...
public class ScheduleOpsUsage {
    ...
    public FeeData scheduleCreateUsage(
        ...
        var creationCtx =
                ExtantScheduleContext.newBuilder()
                        ...
                        .setNumSigners(ScheduleEntitySizes.SCHEDULE_ENTITY_SIZES.estimatedScheduleSigs(sigUsage))
                        .setMemo(op.getMemo())
                        .setResolved(false);
        if (op.hasAdminKey()) {
        ...
        var estimate = txnEstimateFactory.get(sigUsage, scheduleCreate, SingletonEstimatorUtils.ESTIMATOR_UTILS);
    ...
    public FeeData scheduleSignUsage(
        ...
        var estimate = txnEstimateFactory.get(sigUsage, scheduleSign, SingletonEstimatorUtils.ESTIMATOR_UTILS);
        ...
        estimate.addRbs(ScheduleEntitySizes.SCHEDULE_ENTITY_SIZES.bytesUsedForSigningKeys(estNewSigners) * lifetime);

        estimate.addNetworkRbs(SCHEDULED_TXN_ID_SIZE * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    ...
    public FeeData scheduleDeleteUsage(
        ...
        var estimate = txnEstimateFactory.get(sigUsage, scheduleDelete, SingletonEstimatorUtils.ESTIMATOR_UTILS);
