 ...
 */
package com.hedera.services.hapi.fees.usage.schedule;

import static com.hedera.services.hapi.utils.fee.FeeBuilder.BASIC_ENTITY_ID_SIZE;
import static com.hedera.services.hapi.utils.fee.FeeBuilder.BASIC_RICH_INSTANT_SIZE;
import static com.hedera.services.hapi.utils.fee.FeeBuilder.BASIC_TX_ID_SIZE;
...
public class ExtantScheduleContext {
    ...
    public long nonBaseRb() {
        return METADATA_SIZE
                ...
                + ScheduleEntitySizes.SCHEDULE_ENTITY_SIZES.bytesUsedForSigningKeys(numSigners);
    }
