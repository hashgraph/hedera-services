 ...
 */
package com.hedera.services.hapi.fees.usage.state;
...
import com.hedera.services.hapi.fees.pricing.ResourceProvider;
import com.hedera.services.hapi.fees.pricing.UsableResource;
...
public class UsageAccumulator {
    ...
    public long getNetworkRbh() {
        return SingletonEstimatorUtils.ESTIMATOR_UTILS.nonDegenerateDiv(networkRbs, HRS_DIVISOR);
    }
    ...
    public long getServiceRbh() {
        return SingletonEstimatorUtils.ESTIMATOR_UTILS.nonDegenerateDiv(rbs, HRS_DIVISOR);
    }

    public long getServiceSbh() {
        return SingletonEstimatorUtils.ESTIMATOR_UTILS.nonDegenerateDiv(sbs, HRS_DIVISOR);
    }
