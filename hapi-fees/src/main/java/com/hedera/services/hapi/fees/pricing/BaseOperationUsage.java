 ...
 */
package com.hedera.services.hapi.fees.pricing;
...
import com.hedera.services.hapi.fees.usage.token.TokenOpsUsageUtils;
...
public class BaseOperationUsage {
    ...
    UsageAccumulator tokenFreezeAccount() {
        final var tokenFreezeMeta = TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenFreezeUsageFrom();
        final var into = new UsageAccumulator();
    ...
    UsageAccumulator tokenUnfreezeAccount() {
        final var tokenUnfreezeMeta = TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenUnfreezeUsageFrom();
        final var into = new UsageAccumulator();
        TOKEN_OPS_USAGE.tokenFreezeUsage(
    ...
    UsageAccumulator tokenPause() {
        final var tokenPauseMeta = TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenPauseUsageFrom();
        final var into = new UsageAccumulator();
    ...
    UsageAccumulator tokenUnpause() {
        final var tokenUnpauseMeta = TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenUnpauseUsageFrom();
        final var into = new UsageAccumulator();
    ...
    UsageAccumulator uniqueTokenBurn() {
        ...
        final var tokenBurnMeta =
                TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenBurnUsageFrom(canonicalTxn, TOKEN_NON_FUNGIBLE_UNIQUE);
        final var into = new UsageAccumulator();
    ...
    UsageAccumulator fungibleCommonTokenBurn() {
        ...
        final var tokenBurnMeta =
                TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenBurnUsageFrom(canonicalTxn, TOKEN_FUNGIBLE_COMMON);
        final var into = new UsageAccumulator();
        TOKEN_OPS_USAGE.tokenBurnUsage(
                SINGLE_SIG_USAGE, NO_MEMO_AND_NO_EXPLICIT_XFERS, tokenBurnMeta, into);
        return into;
    ...
    UsageAccumulator uniqueTokenMint() {
        ...
        final var tokenMintMeta =
                TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenMintUsageFrom(
    ...
    UsageAccumulator uniqueTokenWipe() {
        ...
        final var tokenWipeMeta =
                TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenWipeUsageFrom(canonicalTxn.getTokenWipe());
        final var into = new UsageAccumulator();
    ...
    UsageAccumulator fungibleTokenCreateWithCustomFees() {
        ...
        final var tokenCreateMeta = TokenOpsUsageUtils.TOKEN_OPS_USAGE_UTILS.tokenCreateUsageFrom(canonicalTxn);
        final var into = new UsageAccumulator();
