...
public class CryptoOpsUsage {
    ...
    private static final long LONG_ACCOUNT_AMOUNT_BYTES = SingletonUsageProperties.USAGE_PROPERTIES.accountAmountBytes();
    ...
    public void cryptoTransferUsage(
        ...
        incRb +=
                TOKEN_ENTITY_SIZES.bytesUsedToRecordTokenTransfers(
                        ...
                        weightedTokenXfers,
                        xferMeta.getNumNftOwnershipChanges());
        accumulator.addRbs(incRb * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
    ...
    public void cryptoCreateUsage(
        ...
        accumulator.addNetworkRbs(
                BASIC_ENTITY_ID_SIZE * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
