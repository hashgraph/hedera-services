...
public enum TokenEntitySizes {
    ...
    public int bytesUsedToRecordTokenTransfers(
        ...
        return numTokens * BASIC_ENTITY_ID_SIZE
                + fungibleNumTransfers * SingletonUsageProperties.USAGE_PROPERTIES.accountAmountBytes()
                + uniqueNumTransfers * SingletonUsageProperties.USAGE_PROPERTIES.nftTransferBytes();
    }
