...
import com.hedera.services.hapi.fees.usage.SingletonEstimatorUtils;
import com.hedera.services.hapi.fees.usage.SingletonUsageProperties;
...
public final class TokenOpsUsage {
    ...
    public void tokenCreateUsage(
        ...
        accumulator.addNetworkRbs(
                tokenCreateMeta.getNetworkRecordRb() * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
    ...
    public void tokenBurnUsage(
        ...
        accumulator.addNetworkRbs(
                tokenBurnMeta.getTransferRecordDb() * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
    ...
    public void tokenMintUsage(
        ...
        accumulator.addNetworkRbs(
                tokenMintMeta.getTransferRecordDb() * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
    ...
    public void tokenWipeUsage(
        ...
        accumulator.addNetworkRbs(
                tokenWipeMeta.getTransferRecordDb() * SingletonUsageProperties.USAGE_PROPERTIES.legacyReceiptStorageSecs());
    }
