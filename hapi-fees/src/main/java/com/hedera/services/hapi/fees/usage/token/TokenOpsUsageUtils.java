...
import com.hedera.services.hapi.fees.usage.EstimatorUtils;
    ...
    public TokenCreateMeta tokenCreateUsageFrom(final TransactionBody txn) {
        ...
        var lifetime =
                op.hasAutoRenewAccount()
                        ...
                        : SingletonEstimatorUtils.ESTIMATOR_UTILS.relativeLifetime(txn, op.getExpiry().getSeconds());
        lifetime = Math.min(lifetime, EstimatorUtils.MAX_ENTITY_LIFETIME);
