...
public class SigUsage {
  ...
  public boolean equals(Object o) {
    ...
    return this.numSigs == that.numSigs
        && this.sigsSize == that.sigsSize
        && this.numPayerKeys == that.numPayerKeys;
  }
  ...
  public String toString() {
    return String.format(
        "SigUsage{numSigs=%d, sigsSize=%d, numPayerKeys=%d}", numSigs, sigsSize, numPayerKeys);
  }
}
