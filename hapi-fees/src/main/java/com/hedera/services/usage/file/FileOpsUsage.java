...
public class FileOpsUsage {
  ...
  public FeeData fileCreateUsage(TransactionBody fileCreation, SigUsage sigUsage) {
    ...
    customBytes +=
        keySizeIfPresent(op, FileCreateTransactionBody::hasKeys, body -> asKey(body.getKeys()));
  ...
  public FeeData fileUpdateUsage(
    ...
    long sbsDelta =
        ESTIMATOR_UTILS.changeInBsUsage(oldCustomBytes, oldLifetime, newCustomBytes, newLifetime);
    if (sbsDelta > 0) {
