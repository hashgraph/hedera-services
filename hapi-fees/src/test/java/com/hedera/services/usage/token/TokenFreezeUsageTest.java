...
class TokenFreezeUsageTest {
  ...
  private TokenFreezeAccountTransactionBody op;
  private TransactionBody txn;

  private EstimatorFactory factory;
  private TxnUsageEstimator base;
  private TokenFreezeUsage subject;
  ...
  private void givenOp() {
    op = TokenFreezeAccountTransactionBody.newBuilder().setToken(id).build();
    setTxn();
  }
