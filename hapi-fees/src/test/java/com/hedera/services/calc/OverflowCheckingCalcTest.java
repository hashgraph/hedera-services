...
class OverflowCheckingCalcTest {
  ...
  private final ExchangeRate someRate =
  ...
  void safeAccumulateTwoWorks() {
    ...
    assertThrows(IllegalArgumentException.class, () -> subject.safeAccumulateTwo(1, 1, -1));
    assertThrows(
        IllegalArgumentException.class, () -> subject.safeAccumulateTwo(1, Long.MAX_VALUE, 1));
    assertThrows(
        IllegalArgumentException.class, () -> subject.safeAccumulateTwo(1, 1, Long.MAX_VALUE));
  ...
  void safeAccumulateThreeWorks() {
    ...
    assertThrows(IllegalArgumentException.class, () -> subject.safeAccumulateThree(1, 1, 1, -1));
    assertThrows(
        IllegalArgumentException.class, () -> subject.safeAccumulateThree(1, Long.MAX_VALUE, 1, 1));
    assertThrows(
        IllegalArgumentException.class, () -> subject.safeAccumulateThree(1, 1, Long.MAX_VALUE, 1));
    assertThrows(
        IllegalArgumentException.class, () -> subject.safeAccumulateThree(1, 1, 1, Long.MAX_VALUE));
  ...
  private final FeeComponents mockLowCeilFees =
      FeeComponents.newBuilder()
          ...
          .setSbh(4_000_000L)
          .build();
  private final FeeComponents mockHighFloorFees =
      FeeComponents.newBuilder()
  ...
  private final FeeComponents mockUsageVector =
      FeeComponents.newBuilder()
          .setConstant(one)
          .setBpt(bpt)
          .setVpt(vpt)
          ...
          .setSbpr(sbpr)
          .build();
  private final FeeData mockUsage =
