...
class ScheduleGeneratorTest {
	...
	@Test
	void canGenerateAllSupportedSchedules() {
		// expect:
		assertDoesNotThrow(() -> {
			final var allSupportedSchedules = subject.feeSchedulesFor(SUPPORTED_FUNCTIONS);
			Files.writeString(Paths.get(ALL_SUPPORTED_SCHEDULES_LOC), allSupportedSchedules);
		});
	}
	...
	static final List<Pair<HederaFunctionality, List<SubType>>> MISC_TEST_FUNCTIONS = List.of(new Pair[] {
					/* Crypto */
