...
class FeeSchedulesTest {
  ...
  private static Map<HederaFunctionality, Map<SubType, BigDecimal>> canonicalTotalPricesInUsd =
      null;
  ...
  void computesExpectedPriceForFungibleTokenCreateWithCustomFees() throws IOException {
    ...
    // then:
    assertEquals(
        expectedTotalBasePrice.doubleValue(), actualBasePrice.doubleValue(), ALLOWED_DEVIATION);
  ...
  void computesExpectedPriceForUniqueTokenMint() throws IOException {
    // setup:
    final var expectedTotalBasePrice =
        canonicalTotalPricesInUsd.get(TokenMint).get(TOKEN_NON_FUNGIBLE_UNIQUE);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
    ...
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(TokenMint, TOKEN_NON_FUNGIBLE_UNIQUE);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(TokenMint, TOKEN_NON_FUNGIBLE_UNIQUE, computedResourcePrices);
  ...
  void computesExpectedPriceForUniqueTokenWipe() throws IOException {
    // setup:
    final var expectedTotalBasePrice =
        canonicalTotalPricesInUsd.get(TokenAccountWipe).get(TOKEN_NON_FUNGIBLE_UNIQUE);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
    ...
    // and:
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(TokenAccountWipe, TOKEN_NON_FUNGIBLE_UNIQUE);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(TokenAccountWipe, TOKEN_NON_FUNGIBLE_UNIQUE, computedPrices);
  ...
  void computesExpectedPriceForUniqueTokenBurn() throws IOException {
    ...
    final var expectedTotalBasePrice =
        canonicalTotalPricesInUsd.get(TokenBurn).get(TOKEN_NON_FUNGIBLE_UNIQUE);
    ...
    // and:
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(TokenBurn, TOKEN_NON_FUNGIBLE_UNIQUE);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(TokenBurn, TOKEN_NON_FUNGIBLE_UNIQUE, computedResourcePrices);
  ...
  void computesExpectedPriceForFeeScheduleUpdate() throws IOException {
    ...
    final var expectedBasePrice =
        canonicalTotalPricesInUsd.get(TokenFeeScheduleUpdate).get(DEFAULT);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
    ...
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(TokenFeeScheduleUpdate, DEFAULT, computedPrices);
  ...
  void computedExpectedPriceForHtsTransfer() throws IOException {
    ...
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(CryptoTransfer, TOKEN_FUNGIBLE_COMMON);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(CryptoTransfer, TOKEN_FUNGIBLE_COMMON, computedPrices);
  ...
  void computedExpectedPriceForHtsTransferWithCustomFee() throws IOException {
    final var canonicalPrices = assetsLoader.loadCanonicalPrices();
    final var expectedBasePrice =
        canonicalPrices.get(CryptoTransfer).get(TOKEN_FUNGIBLE_COMMON_WITH_CUSTOM_FEES);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
            + "    \"hederaFunctionality\" : \"CryptoTransfer\",\n"
    ...
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(CryptoTransfer, TOKEN_FUNGIBLE_COMMON_WITH_CUSTOM_FEES);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(
            CryptoTransfer, TOKEN_FUNGIBLE_COMMON_WITH_CUSTOM_FEES, computedPrices);
  ...
  void computedExpectedPriceForNftTransfer() throws IOException {
    final var canonicalPrices = assetsLoader.loadCanonicalPrices();
    final var expectedBasePrice =
        canonicalPrices.get(CryptoTransfer).get(TOKEN_NON_FUNGIBLE_UNIQUE);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
            + "    \"hederaFunctionality\" : \"CryptoTransfer\",\n"
    ...
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(CryptoTransfer, TOKEN_NON_FUNGIBLE_UNIQUE);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(CryptoTransfer, TOKEN_NON_FUNGIBLE_UNIQUE, computedPrices);
  ...
  void computedExpectedPriceForNftTransferWithCustomFees() throws IOException {
    final var canonicalPrices = assetsLoader.loadCanonicalPrices();
    final var expectedBasePrice =
        canonicalPrices.get(CryptoTransfer).get(TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES);
    final var desired =
        "{\n"
            + "  \"transactionFeeSchedule\" : {\n"
            + "    \"hederaFunctionality\" : \"CryptoTransfer\",\n"
    ...
    final var canonicalUsage =
        baseOperationUsage.baseUsageFor(CryptoTransfer, TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES);
    final var jsonRepr =
        reprAsSingleFeeScheduleEntry(
            CryptoTransfer, TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES, computedPrices);
  ...
  void computesExpectedPriceForSubmitMessage() throws IOException {
    // setup:
    final var expectedBasePrice =
        canonicalTotalPricesInUsd.get(ConsensusSubmitMessage).get(DEFAULT);
