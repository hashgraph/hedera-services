...
extraJavaModuleInfo {
    ...
    automaticModule("io.grpc:grpc-protobuf", "io.grpc.protobuf")
    automaticModule("io.grpc:grpc-services", "io.grpc.services")
    ...
    automaticModule("org.hyperledger.besu:bls12-381", "org.hyperledger.besu.bls12.381")
