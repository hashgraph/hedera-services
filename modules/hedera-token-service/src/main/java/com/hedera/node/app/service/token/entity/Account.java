...
public interface Account {
     ...
     * expiration date every this many seconds. If it doesn't have enough balance, it extends
     * as long as possible. If it is empty when it expires, then it is deleted.
    ...
    /**
     * Get the num [of shard.realm.num] of account to charge for auto-renewal of this account.
     * If not set, or set to an account with zero hbar balance, the account's own hbar balance
