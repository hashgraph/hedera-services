...
public class TransactionSigner {
	...
	private static SignaturePair signAsSignaturePair(PublicKey pubKey, PrivateKey privKey,
			byte[] bodyBytes) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException,
	 ...
	 * @throws Exception
	 */
	public static Transaction signTransactionWithSignatureMap(Transaction transaction, List<PrivateKey> privKeyList,
			List<PublicKey> pubKeyList) throws Exception {
		List<List<PrivateKey>> privKeysList = new ArrayList<>();
