...
public class RequestBuilder {
	 ...
	 * 		the expiration for the file
	 * @param waclKeyList
	 * 		WACL keys, as List<ThresholdKeys>
	 */
	 ...
	 * @param fileId
	 * 		file ID or hash of the tx that created the file
	 */
	 ...
	 *
	 * @param cost
	 * 		cost of answer if type is COST_ANSWER_VALUE, total cost of answer and state proof
