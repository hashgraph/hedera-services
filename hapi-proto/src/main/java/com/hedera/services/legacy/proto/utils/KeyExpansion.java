...
public class KeyExpansion {
	 ...
	 *
	 * @param depth
	 * 		level of depth to expand, the first level should has a value of 1
	 */
	 ...
	 *
	 * @param numWaclKeys
	 * 		number of wacl keys, each key is a complex key with depth levels
	 * @param depth
	 * 		depth of the individual wacl key
