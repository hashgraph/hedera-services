...
public class SignatureGenerator {
	 ...
	 *
	 * @param x
	 * 		the x coordinate of the EC key's curve point
	 * @param y
	 * 		the y coordinate of the EC key's curve point
	 * @param namedCurve
	 * 		the name of the EC curve the public key generated on
	 * @param keyAlgorithm
	 ...
	 *
	 * @param binaryHex
	 * 		the hex string of the public key in raw binary format
	 * @return the EC public key instance
	 */
