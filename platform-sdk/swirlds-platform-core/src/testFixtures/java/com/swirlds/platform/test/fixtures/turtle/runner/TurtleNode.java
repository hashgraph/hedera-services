...
import static com.swirlds.platform.test.fixtures.turtle.runner.TurtleStateLifecycles.TURTLE_STATE_LIFECYCLES;
...
public class TurtleNode {
    ...
    TurtleNode(
        ...
        final PlatformBuilder platformBuilder = PlatformBuilder.create(
                ...
                .withConfiguration(configuration)
                .withSystemTransactionEncoderCallback(x -> Bytes.EMPTY);
