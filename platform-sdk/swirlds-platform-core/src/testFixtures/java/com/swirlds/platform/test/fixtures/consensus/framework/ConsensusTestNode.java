...
public class ConsensusTestNode {
     ...
     */
    public ConsensusTestNode(@NonNull final EventEmitter<?> eventEmitter, @NonNull final Intake intake) {
    ...
    public @NonNull ConsensusTestNode reconnect(@NonNull final PlatformContext platformContext) {
        ...
        final ConsensusTestNode consensusTestNode = new ConsensusTestNode(
                newEmitter,
                new ProdTestIntake(
                        platformContext, newEmitter.getGraphGenerator().getAddressBook()));
    ...
    public @NonNull Intake getIntake() {
        return intake;
    }
