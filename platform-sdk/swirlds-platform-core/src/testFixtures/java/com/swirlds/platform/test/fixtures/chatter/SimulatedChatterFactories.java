...
package com.swirlds.platform.test.fixtures.chatter;
...
public class SimulatedChatterFactories implements SimulatedChatterFactory {
    ...
    public SimulatedChatter build(
        ...
        final MetricKeyRegistry registry = Mockito.mock(MetricKeyRegistry.class);
        Mockito.when(registry.register(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any()))
                .thenReturn(true);
