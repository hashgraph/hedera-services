...
public class SyncNode {
    ...
    public SyncNode(
        ...
        shadowGraph = new ShadowGraph(Mockito.mock(SyncMetrics.class));
        consensus = Mockito.mock(Consensus.class);
    ...
    public ShadowGraphSynchronizer getSynchronizer() throws InterruptedException {
        ...
        final QueueThread<GossipEvent> intakeQueueThread = Mockito.mock(QueueThread.class);
        ...
        return new ShadowGraphSynchronizer(
                ...
                shadowGraph,
                numNodes,
                Mockito.mock(SyncMetrics.class),
                this::getConsensus,
                intakeQueueThread,
                syncManager,
                Mockito.mock(IntakeEventCounter.class),
                executor,
                sendRecInitBytes,
                () -> {});
    }
