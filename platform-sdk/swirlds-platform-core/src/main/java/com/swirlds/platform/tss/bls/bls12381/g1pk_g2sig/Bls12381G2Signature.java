 ...
 */
public record Bls12381G2Signature(@NonNull Bls12381Group2Element signature) implements Signature<Bls12381G1PublicKey> {
    ...
    public byte[] serialize() {
        ...
        final byte[] output = new byte[serializedSignature.length + 2];
        ...
        System.arraycopy(serializedSignature, 0, output, 2, serializedSignature.length);
