...
/**
 * A method that listens for when a signed is evicted from memory before it collects enough signatures.
 */
@DispatchModel(mode = DispatchMode.ASYNC, order = DispatchOrder.UNORDERED)
public interface StateLacksSignaturesListener extends Listener<StateLacksSignaturesNotification> {}
