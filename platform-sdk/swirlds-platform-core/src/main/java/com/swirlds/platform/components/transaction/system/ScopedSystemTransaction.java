 ...
 * by the event that the transaction is contained within. This is intentional, as it makes it impossible for a
 * transaction to lie and claim to be submitted by a node that did not actually submit it.
 *
