...
public class PlatformCoordinator {
     ...
     * @param pcesJoinWiring                         the PCES join wiring
    ...
    public PlatformCoordinator(
            ...
            @NonNull final ComponentWiring<PcesJoin, List<ConsensusRound>> pcesJoinWiring,
        ...
        this.pcesJoinWiring = Objects.requireNonNull(pcesJoinWiring);
    ...
    public void clear() {
        ...
        pcesJoinWiring.getInputWire(PcesJoin::clear).inject(NoInput.getInstance());
    }
}
