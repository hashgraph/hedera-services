...
public final class PlatformBuilder {
    ...
    public static PlatformContext buildPlatformContext(
        ...
        final FileSystemManager fileSystemManager =
                FileManagerFactory.getInstance().createFileSystemManager(configuration, metrics, selfId);
        return new DefaultPlatformContext(configuration, metrics, cryptography, Time.getCurrent(), fileSystemManager);
    }
