 ...
 */
public record HashLoggerWiring(
        @NonNull InputWire<ReservedSignedState> eventInput) {
    /**
    ...
    public static HashLoggerWiring create(@NonNull final TaskScheduler<Void> taskScheduler) {
        return new HashLoggerWiring(
                taskScheduler.buildInputWire("signed state to log"));
    }
