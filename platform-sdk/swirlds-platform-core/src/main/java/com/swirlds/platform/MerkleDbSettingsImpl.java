...
public class MerkleDbSettingsImpl extends SubSetting implements MerkleDbSettings {
    ...
    public void setSmallMergeCutoffMb(final int smallMergeCutoffMb) {
    ...
    public void setMergePeriodUnit(final String mergePeriodUnit) {
    ...
    public int getReservedBufferLengthForLeafList() {
        return reservedBufferLengthForLeafList;
    }
