 ...
 *                                            heuristic when deciding the upper bound of a new file. This value controls
 *                                            the number of recent files that are considered when computing the running
 *                                            average.
 ...
 *                                            factor. Choosing a value too large will cause unnecessary un-utilized span
 *                                            if the node crashes. Choosing a value too small may case event files to be
 *                                            smaller than the preferred size. Should be larger than the non-boostrap
 *                                            span overlap factor to allow for faster convergence on a sane file size at
 *                                            startup time.
