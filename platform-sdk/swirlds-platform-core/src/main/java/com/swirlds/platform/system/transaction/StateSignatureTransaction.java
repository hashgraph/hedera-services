...
public final class StateSignatureTransaction extends SystemTransaction {
    ...
    public StateSignatureTransaction(
        ...
        this.round = round;
        this.stateSignature = new Signature(SignatureType.RSA,Objects.requireNonNull(stateSignature, "stateSignature must not be null").toByteArray());
        this.stateHash = new Hash(Objects.requireNonNull(stateHash, "stateHash must not be null").toByteArray());
