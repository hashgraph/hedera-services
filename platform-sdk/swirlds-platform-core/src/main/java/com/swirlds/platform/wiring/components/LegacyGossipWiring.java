 ...
 */
public record LegacyGossipWiring(
        @NonNull InputWire<GossipEvent> eventInput, @NonNull OutputWire<GossipEvent> eventOutput) {

    // TODO delete

    /**
     * Create a new instance of {@link LegacyGossipWiring}.
     *
     * @param model the wiring model
     * @return the new instance
     */
    @NonNull
    public static LegacyGossipWiring create(@NonNull final WiringModel model) {
        ...
        return new LegacyGossipWiring(inputWire, outputWire);
    }
}
