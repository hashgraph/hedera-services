 ...
 * @param maxCreationRate     the maximum rate (in hz) that a node can create new events. The maximum rate for the
 *                            entire network is equal to this value times the number of nodes. A value of 0 means that
 *                            there is no limit to the number of events that can be created (as long as those events are
 *                            legal to create).
 ...
 * @param eventIntakeThrottle when the size of the event intake queue equals or exceeds this value, do not permit the
 *                            creation of new self events.
 */
