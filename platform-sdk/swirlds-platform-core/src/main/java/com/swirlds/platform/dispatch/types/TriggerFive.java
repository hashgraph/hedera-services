...
/**
 * A trigger that accepts five arguments.
 *
 * @param <A>
 ...
 */
@FunctionalInterface
public non-sealed interface TriggerFive<A, B, C, D, E> extends Trigger<TriggerFive<A, B, C, D, E>> {
     ...
     * 		the fifth argument
     */
    void dispatch(A a, B b, C c, D d, E e);
}
