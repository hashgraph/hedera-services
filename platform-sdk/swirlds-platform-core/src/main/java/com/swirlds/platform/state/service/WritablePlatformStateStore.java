...
public class WritablePlatformStateStore extends ReadablePlatformStateStore {
    ...
    public void bulkUpdate(Consumer<PlatformStateAccessor> updater) {
        final var accumulator = new PlaformStateValueAccumulator();
    ...
    private static class PlaformStateValueAccumulator implements PlatformStateAccessor {
         ...
         */
        private com.swirlds.platform.consensus.ConsensusSnapshot snapshot;
        ...
        @Override
        @Nullable
        public com.swirlds.platform.consensus.ConsensusSnapshot getSnapshot() {
            return snapshot;
        }
