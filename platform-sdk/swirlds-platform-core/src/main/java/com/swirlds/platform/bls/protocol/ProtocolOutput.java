...
public interface ProtocolOutput {
     ...
     * all parties completing a protocol. It shouldn't compare members that are secret to an
     * individual node
     *
     * @param o the object to compare this one to
     * @return true if the outputs are considered equal under the described relaxed conditions,
     *     otherwise false
     */
    boolean compareToOtherOutput(Object o);
}
