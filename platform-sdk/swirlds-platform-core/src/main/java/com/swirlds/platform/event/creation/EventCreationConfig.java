 ...
 * @param maxOtherParentCount            the maximum number of other parents that an event can have.
...
public record EventCreationConfig(
        ...
        @ConfigProperty(defaultValue = "8") int maxOtherParentCount, // TODO actually use this setting
