...
/**
 * Prevents an event from being sent unless a variable amount of time has passed since we have received
 * this event. This excludes self events which should be sent immediately.
 */
public class VariableTimeDelay implements SendCheck<GossipEvent> {
