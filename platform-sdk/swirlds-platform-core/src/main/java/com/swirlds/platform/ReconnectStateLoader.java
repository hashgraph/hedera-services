...
public class ReconnectStateLoader {
    ...
    public void loadReconnectState(@NonNull final SignedState signedState) {
        ...
        try {
            ...
            final PlatformStateAccessor readablePlatformState = platformStateFacade.readablePlatformStateOf(state);
            ...
            platformWiring.consensusSnapshotOverride(Objects.requireNonNull(readablePlatformState.getSnapshot()));
            ...
            platformWiring.updateEventWindow(new EventWindow(
                    ...
                    readablePlatformState.getAncientThreshold(),
                    readablePlatformState.getAncientThreshold(),
                    ancientMode));

            final RunningEventHashOverride runningEventHashOverride =
                    new RunningEventHashOverride(readablePlatformState.getLegacyRunningEventHash(), true);
