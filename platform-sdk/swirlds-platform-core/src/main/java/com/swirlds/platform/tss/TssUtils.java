...
import com.swirlds.platform.tss.keying.DkgMessage;
...
public class TssUtils {
    ...
    /**
     * If a threshold number of {@link BlsSignature}s by shares is provided a signature by the {@link TssDirectory}'s
     * secret private key is interpolated.
     *
     ...
     */
    BlsSignature interpolateSignatures(@NonNull final Map<TssShareId, BlsSignature> signatures) {
        throw new UnsupportedOperationException("Not implemented");
    }

    /**
     * If a threshold number of {@link BlsPublicKey}s of shares is provided a public key for the {@link TssDirectory}'s
     * secret private key is interpolated.
     *
     ...
     */
    BlsPublicKey interpolatePublicKeys(@NonNull final Map<TssShareId, BlsPublicKey> publicKeys) {
        throw new UnsupportedOperationException("Not implemented");
    }
     ...
     */
    @NonNull
    public static DkgMessage generateDkgMessage(
    ...
    /**
     * Process a threshold number of {@link DkgMessage}s to create the first {@link TssDirectory} with the given
     ...
     *                                  {@link DkgMessage}s is less than the threshold in the genesis
     *                                  {@link TssDirectory}.
     */
    @NonNull
    public static TssDirectory setup(
            @NonNull TssDirectory genesisDirectory,
            @NonNull final TssSignerId tssSigner,
            Set<TssShareId> shares,
            @NonNull final Map<TssSignerId, DkgMessage> dkgMessages) {
        // https://github.com/rsinha/groth21_dkg/blob/40d82993d1ec9ea295d56e9d9cb955af60c00ebb/src/dkg.rs#L163
        throw new UnsupportedOperationException("Not implemented");
    }

    /**
     * Process a threshold number of {@link DkgMessage}s to initialize the next {@link TssDirectory}'s shares' public
     ...
     * @throws IllegalArgumentException if the signer does not have an {@link EcdhPrivateKey} set or the number of
     *                                  {@link DkgMessage}s is less than the threshold in the previous
     *                                  {@link TssDirectory}.
     */
    @NonNull
    public static TssDirectory rekey(
