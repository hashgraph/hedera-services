...
class SyncProtocolFactoryTests {
    ...
    //    private LegacySyncPermitProvider permitProvider;
    ...
    //        permitProvider = new LegacySyncPermitProvider(2, mock(IntakeEventCounter.class));
    ...
    //        statusNexus.setCurrentStatus(PlatformStatus.BEHIND);
    //
    //        final ProtocolFactory syncProtocolFactory = new SyncProtocolFactory(
    //                platformContext,
    //                shadowGraphSynchronizer,
    ...
    //    void rethrowSyncException() throws ParallelExecutionException, IOException, SyncException,
