...
import static com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs.RANDOM_WEIGHT_DESC;
...
class ConsensusTests extends PlatformTest {
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#orderInvarianceTests")
    ...
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#reconnectSimulation")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#staleEvent")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#forkingTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#partitionTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#subQuorumPartitionTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#cliqueTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#variableRateTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#nodeUsesStaleOtherParents")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#nodeProvidesStaleOtherParents")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#quorumOfNodesGoDownTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#subQuorumOfNodesGoDownTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#ancientEventTests")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#restartWithEventsParams")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
    ...
    @ParameterizedTest
    @MethodSource("com.swirlds.platform.test.fixtures.consensus.ConsensusTestArgs#nodeRemoveTestParams")
    @Tag(TestComponentTags.PLATFORM)
    @Tag(TestComponentTags.CONSENSUS)
