...
class PlatformStatusStateMachineTests {
    ...
    //        stateMachine.submitStatusAction(new StartedReplayingEventsAction());
    //        assertEquals(PlatformStatus.REPLAYING_EVENTS, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new FreezePeriodEnteredAction(2));
    //        assertEquals(PlatformStatus.REPLAYING_EVENTS, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new StateWrittenToDiskAction(2, true));
    ...
    //        stateMachine.submitStatusAction(new StartedReplayingEventsAction());
    //        assertEquals(PlatformStatus.REPLAYING_EVENTS, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new DoneReplayingEventsAction(time.now()));
    ...
    //        stateMachine.submitStatusAction(new TimeElapsedAction(time.now()));
    ...
    //        stateMachine.submitStatusAction(new TimeElapsedAction(time.now()));
    //        assertEquals(PlatformStatus.CHECKING, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new SelfEventReachedConsensusAction(time.now()));
    ...
    //        stateMachine.submitStatusAction(new SelfEventReachedConsensusAction(time.now()));
    //        assertEquals(PlatformStatus.ACTIVE, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new FallenBehindAction());
    ...
    //
    //    @Test
    //    @DisplayName("STARTING_UP -> REPLAYING_EVENTS -> OBSERVING -> BEHIND -> RECONNECT_COMPLETE ->
    // FREEZE_COMPLETE")
    ...
    //        stateMachine.submitStatusAction(new FallenBehindAction());
    //        assertEquals(PlatformStatus.BEHIND, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new ReconnectCompleteAction(5));
    ...
    //        stateMachine.submitStatusAction(new ReconnectCompleteAction(5));
    //        assertEquals(PlatformStatus.RECONNECT_COMPLETE, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new FreezePeriodEnteredAction(10));
    //        assertEquals(PlatformStatus.RECONNECT_COMPLETE, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new StateWrittenToDiskAction(11, false));
    //        assertEquals(PlatformStatus.FREEZING, stateMachine.getCurrentStatus());
    //    }
    //
    //    @Test
    ...
    //        assertEquals(PlatformStatus.STARTING_UP, stateMachine.getCurrentStatus());
    //        stateMachine.submitStatusAction(new CatastrophicFailureAction());
