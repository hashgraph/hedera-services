...
class LegacyConfigPropertiesLoaderTests {
    ...
    void testEmptyConfig() {
        ...
        final Path path = Paths.get(
                LegacyConfigPropertiesLoaderTests.class.getResource("empty.txt").getPath());
    ...
    void testRealisticConfig() throws UnknownHostException {
        // given
        final Path path = Paths.get(
                LegacyConfigPropertiesLoaderTests.class.getResource("config.txt").getPath());
