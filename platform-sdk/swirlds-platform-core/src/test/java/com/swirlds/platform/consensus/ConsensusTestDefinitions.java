...
public final class ConsensusTestDefinitions {
    ...
    public static void ancient(@NonNull final TestInput input) {
        ...
        orchestrator.setOtherParentAffinity(
                OtherParentMatrixFactory.createShunnedNodeOtherParentAffinityMatrix(input.numberOfNodes(), dyingNode));
        orchestrator.generateEvents(0.10);
    ...
    public static void partitionTests(@NonNull final TestInput input) {
        ...
        final List<List<Double>> fullyConnected =
                OtherParentMatrixFactory.createBalancedOtherParentMatrix(input.numberOfNodes());
        final List<List<Double>> partitioned = OtherParentMatrixFactory.createPartitionedOtherParentAffinityMatrix(
    ...
    public static void subQuorumPartitionTests(@NonNull final TestInput input) {
        ...
        final List<List<Double>> partitioned = OtherParentMatrixFactory.createPartitionedOtherParentAffinityMatrix(
                input.numberOfNodes(), partitionedNodes);
    ...
    public static void cliqueTests(@NonNull final TestInput input) {
        ...
        final List<List<Double>> affinity =
                OtherParentMatrixFactory.createCliqueOtherParentMatrix(numberOfNodes, cliques);
    ...
    public static void stale(@NonNull final TestInput input) {
        ...
        orchestrator.setOtherParentAffinity(
                OtherParentMatrixFactory.createShunnedNodeOtherParentAffinityMatrix(input.numberOfNodes(), 0));
