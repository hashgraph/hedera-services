...
public class SavedStateLoaderTests {
    ...
    //        assertTrue(emergencyRecoveryManager.isEmergencyStateRequired(), "an emergency state should still be
    // required");
    //    }
    //
    //    /**
    ...
    //        assertEquals(0, shutdownCount.get(), "no shutdown request should have been dispatched");
    //        assertFalse(
    //                emergencyRecoveryManager.isEmergencyStateRequired(), "an emergency state should not still be
    // required");
    //    }
    //
