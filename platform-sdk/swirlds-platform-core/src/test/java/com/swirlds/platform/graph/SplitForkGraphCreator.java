...
import com.swirlds.platform.sync.SyncTestParams;
...
public class SplitForkGraphCreator {
    ...
    private static void forceNextOtherParent(
        ...
        final List<List<Double>> forcedOtherParentMatrix =
                OtherParentMatrixFactory.createForcedOtherParentMatrix(numSources, nextOtherParent);

        final List<List<Double>> shunnedOtherParentMatrix =
                OtherParentMatrixFactory.createShunnedNodeOtherParentAffinityMatrix(numSources, creatorToShun);
