...
class StateManagementComponentTests {
    ...
    //    private final TestSignedStateWrapperConsumer newLatestCompleteStateConsumer = new
    // TestSignedStateWrapperConsumer();
    ...
    //
    //    /**
    //     * Verify that when the component is provided a new signed state from transactions, it submits a state
    // signature
    //     * system transaction.
    //     */
    //    @Test
    ...
    //
    //    /**
    //     * Verify that when the component is provided a complete signed state to load, it is returned when asked for
    // the
    ...
    //                    "The new latest complete state consumer should not be invoked for states that are older than
    // the "
    ...
    //        }
    //        assertEquals(
    //                expectedSignedState.getRound(), component.getLastCompleteRound(), "Incorrect latest complete
    // round");
    //    }
    //
    ...
    //        assertEquals(signedState, lastCompleteSignedState, "Incorrect new latest signed state provided to
    // consumer");
    //
    //        // 1 for being the latest complete signed state
    //        // 1 for being the latest signed state
    ...
    //        assertEquals(
    //                attempt.signedState(), signedState, "The state saved to disk should be the same as the state
    // loaded.");
