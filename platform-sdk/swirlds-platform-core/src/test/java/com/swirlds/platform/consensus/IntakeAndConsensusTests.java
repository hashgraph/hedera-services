...
import com.swirlds.platform.test.fixtures.consensus.Intake;
import com.swirlds.platform.test.fixtures.consensus.ProdTestIntake;
...
class IntakeAndConsensusTests {
    ...
    void nonAncientEventWithMissingParents() {
        ...
        final Intake node1 = new ProdTestIntake(platformContext, generator.getAddressBook());
        final Intake node2 = new ProdTestIntake(platformContext, generator.getAddressBook());
    ...
    private static void assertConsensusEvents(final Intake node1, final Intake node2) {
    ...
    private static void printGenerations(final Intake node, final int nodeNum) {
    ...
    private static class GeneratorWithConsensus implements GraphGenerator<GeneratorWithConsensus> {
        ...
        public GeneratorWithConsensus(
            ...
            intake = new ProdTestIntake(platformContext, generator.getAddressBook());
        }
