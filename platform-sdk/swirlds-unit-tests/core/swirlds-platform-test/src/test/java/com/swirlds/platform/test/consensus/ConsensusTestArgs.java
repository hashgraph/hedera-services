...
public class ConsensusTestArgs {
    ...
    static Stream<Arguments> orderInvarianceTests() {
        return Stream.of(
                ...
                Arguments.of(new ConsensusTestParams(
                        9, ONE_THIRD_ZERO_WEIGHT, ONE_THIRD_NODES_ZERO_WEIGHT_DESC)),
                Arguments.of(
    ...
    static Stream<Arguments> reconnectSimulation() {
        return Stream.of(
                ...
                Arguments.of(new ConsensusTestParams(
                        4, INCREMENTING, INCREMENTAL_NODE_WEIGHT_DESC)),
                Arguments.of(new ConsensusTestParams(
                        4, ONE_THIRD_ZERO_WEIGHT, ONE_THIRD_NODES_ZERO_WEIGHT_DESC)),
                Arguments.of(
                ...
                Arguments.of(new ConsensusTestParams(
                        10, ONE_THIRD_ZERO_WEIGHT, ONE_THIRD_NODES_ZERO_WEIGHT_DESC)),
                Arguments.of(
    ...
    static Stream<Arguments> staleEvent() {
        return Stream.of(
                ...
                Arguments.of(new ConsensusTestParams(
                        6, ONE_THIRD_ZERO_WEIGHT, ONE_THIRD_NODES_ZERO_WEIGHT_DESC)));
    }
    ...
    public static Stream<Arguments> nodeRemoveTestParams() {
        return Stream.of(
                Arguments.of(new ConsensusTestParams(4, RANDOM, RANDOM_WEIGHT_DESC)));
    }
}
