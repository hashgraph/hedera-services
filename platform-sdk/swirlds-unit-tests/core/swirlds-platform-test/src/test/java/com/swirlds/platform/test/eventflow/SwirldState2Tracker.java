...
/**
 * An implementation of {@link SwirldState2} that tracks transactions passed to it and
 * keeps other information important for testing.
 */
public class SwirldState2Tracker extends DummySwirldState2 implements TransactionTracker, SwirldState2 {
    ...
    public SwirldState2Tracker() {
        super();
        selfId = 0L;
    }

    public SwirldState2Tracker(final long selfId) {
        this.selfId = selfId;
    }

    public SwirldState2Tracker waitForMetadata(final boolean waitForMetadata) {
        this.checkForMetadata = waitForMetadata;
        return this;
    }

    public SwirldState2Tracker(final SwirldState2Tracker that) {
    ...
    @Override
    public SwirldState2Tracker copy() {
        throwIfImmutable();
        return new SwirldState2Tracker(this);
    }
    ...
    @Override
    public SwirldState2Tracker getSwirldState() {
        return this;
    }
}
