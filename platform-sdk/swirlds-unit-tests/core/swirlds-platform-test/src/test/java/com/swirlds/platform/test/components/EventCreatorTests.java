...
class EventCreatorTests {
    ...
    //            GraphGenerations.FIRST_GENERATION, GraphGenerations.FIRST_GENERATION,
    ...
    //    }
    //
    //    private EventMapper mockMapper(final Map<Long, EventImpl> recentEvents, final GossipEvent recentSelfEvent) {
    ...
    //
    //        assertEquals(otherParentHashed.getHash(), event.getOtherParentHash(), "expected other parent hash to
    // match");
    //
