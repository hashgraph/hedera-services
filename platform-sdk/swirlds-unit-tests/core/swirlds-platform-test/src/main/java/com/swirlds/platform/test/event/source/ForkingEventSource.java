 ...
 */
public class ForkingEventSource extends AbstractEventSource<ForkingEventSource> {
    ...
    public ForkingEventSource() {
        this(true, DEFAULT_TRANSACTION_GENERATOR, DEFAULT_STAKE);
    }
    ...
    public ForkingEventSource(final long stake) {
