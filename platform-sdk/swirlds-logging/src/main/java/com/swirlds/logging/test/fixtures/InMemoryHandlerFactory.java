...
public class InMemoryHandlerFactory implements LogHandlerFactory {

    /**
     */
    private static final String HANDLER_TYPE = "inMemory";
    ...
    public LogHandler create(@NonNull final String handlerName, @NonNull final Configuration configuration) {
        return new InMemoryHandler(handlerName, configuration);
    }
