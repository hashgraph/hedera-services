...
public class LogLikeHellLog4J implements Runnable {
    ...
    private String user1 = UUID.randomUUID().toString();
    private String user2 = UUID.randomUUID().toString();
    private String user3 = UUID.randomUUID().toString();
    private String user4 = UUID.randomUUID().toString();
    ...
    public void run() {
        ...
        ThreadContext.put("user-id", user1);
        logger.log(Level.INFO, "L6, Hello world!");
        ThreadContext.clearAll();

        ThreadContext.put("user-id", user2);
        logger.log(Level.INFO, "L7, Hello {}, {}, {}, {}, {}, {}, {}, {}, {}!", 1, 2, 3, 4, 5, 6, 7, 8, 9);
        ThreadContext.clearAll();

        ThreadContext.put("key", "value");
        ThreadContext.put("user-id", user4);
