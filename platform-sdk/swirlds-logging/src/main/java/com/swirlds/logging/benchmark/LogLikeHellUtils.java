...
public class LogLikeHellUtils {
    ...
    public final static String USER_1 = UUID.randomUUID().toString();
    public final static String USER_2 = UUID.randomUUID().toString();
    public final static String USER_3 = UUID.randomUUID().toString();
