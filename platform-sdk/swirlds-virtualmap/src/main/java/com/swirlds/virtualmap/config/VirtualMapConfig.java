 ...
 * @param reconnectPullResponse
 *      If {@code true}, virtual maps will use pull/response mechanism during reconnects, when the learner
 *      sends requests to the teacher. If {@code false}, push/receive mechanism is used, when the teacher
 *      sends requests to the learner.
...
public record VirtualMapConfig(
        ...
        @ConfigProperty(defaultValue = "true") boolean reconnectPullResponse,
