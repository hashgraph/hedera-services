...
numberOfInstancesPerRegion=(3 3 3) 
totalInstances=0
...
delayList=(0)
bytesPerTransList=(100 512 1024 4096)
transPerEventList=(-1)
transPerSecList=(50000 250000 500000)
syncCallersList=(1 2 4 8)
useTLSList=(1)
...
additionalSettings=(
  ...
  "maxTransactionBytesPerEvent, 254760"
...
# AWS AMI to use
awsAmi="Hashgraph Java 10 Haveged"
