...
startWithInstanceNumber=5

# the script to run on the remote node
testScriptToRun="runAddNodeTests.sh"
# the time in seconds that takes the above script to finish
scriptRunningTime=$(( ($totalInstances - $startWithInstanceNumber + 1) * 120 ))
