...
regionList=("us-east-2"  "us-east-1"  "us-west-2"  "ap-northeast-1")
numberOfRegions=${#regionList[@]}
#numberOfInstancesPerRegion=(4 4 4 4 4 4 4 4)
numberOfInstancesPerRegion=(3 3 2 2 )
totalInstances=0
...
desc="${totalInstances} mem, ${numberOfRegions} region test 256 byte trans 60K CPUBatch 4.10xlrg"
...
additionalSettings=(
  ...
  "cpuVerifierBatchSize, 60000"
  "cpuDigestBatchSize, 60000"
  "cpuVerifierThreadRatio, 2.00"
