...
desc="${totalInstances} mem, ${numberOfRegions} region test 256 byte trans 40K CPUBatch 4.10xlrg"
...
additionalSettings=(
  ...
  "cpuVerifierBatchSize, 40000"
  "cpuDigestBatchSize, 40000"
