...
desc="${totalInstances} mem, ${numberOfRegions} region"
...
bytesPerTransList=( 256 512 1024 2048 4096)
transPerEventList=(-1)
transPerSecList=(20000 )
syncCallersList=( 3)
useTLSList=(1)
