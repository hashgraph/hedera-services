...
additionalSettings=(
  ...
  "cpuVerifierThreadRatio, 1.00"
  "cpuDigestThreadRatio, 0.10"
...
STREAM_CLIENT_SERVER=2  #stream server on the same machine as node, how many stream server runing
