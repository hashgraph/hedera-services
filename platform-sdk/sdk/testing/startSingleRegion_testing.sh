...
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestStatsExperiments.sh  1>> "${logDir}/stats ${logFile}" 2>> "${logDir}/stats ${errFile}")
# (./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestGpuStats.sh  1>> "${logDir}/gpu ${logFile}" 2>> "${logDir}/gpu ${errFile}")
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestCpuStats.sh  1>> "${logDir}/cpu ${logFile}" 2>> "${logDir}/cpu ${errFile}")
...
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest100TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 100 ${logFile}" 2>> "${logDir}/cpu 100 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest256TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 256 ${logFile}" 2>> "${logDir}/cpu 256 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest512TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 512 ${logFile}" 2>> "${logDir}/cpu 512 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest1024TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 1024 ${logFile}" 2>> "${logDir}/cpu 1024 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest2048TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 2048 ${logFile}" 2>> "${logDir}/cpu 2048 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest4096TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 4096 ${logFile}" 2>> "${logDir}/cpu 4096 ${errFile}")
sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTest6144TranSizeStats.sh $testFolder  1>> "${logDir}/cpu 6144 ${logFile}" 2>> "${logDir}/cpu 6144 ${errFile}")
sleep 5m

#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCM1K.sh $testFolder FCM1K.json 1>> "${logDir}/platform test - fcm 1k ${logFile}" 2>> "${logDir}/platform test - fcm 1k ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCM1M.sh $testFolder FCM1M.json 1>> "${logDir}/platform test - fcm 1m ${logFile}" 2>> "${logDir}/platform test - fcm 1m ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCMOnly.sh $testFolder FCMOnly.json 1>> "${logDir}/platform test - fcm only ${logFile}" 2>> "${logDir}/platform test - fcm only ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCMOnlyV2.sh $testFolder FCMOnly2.json 1>> "${logDir}/platform test - fcm only v2 ${logFile}" 2>> "${logDir}/platform test - fcm only v2 ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCFSOnly.sh $testFolder FileOnly.json 1>> "${logDir}/platform test - fcfs only ${logFile}" 2>> "${logDir}/platform test - fcfs only ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCFSNarrow.sh $testFolder FileOnlyNarrowDeep.json 1>> "${logDir}/platform test - fcfs narrow ${logFile}" 2>> "${logDir}/platform test - fcfs narrow ${errFile}")
#sleep 5m
#(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestPlatformFCFSWide.sh $testFolder FileOnlyWideShallow.json 1>> "${logDir}/platform test - fcfs wide ${logFile}" 2>> "${logDir}/platform test - fcfs wide ${errFile}")
#sleep 5m
(./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestRestart.sh $testFolder  1>> "${logDir}/restart ${logFile}" 2>> "${logDir}/restart ${errFile}")

echo starting graphing
(java -Duser.dir=/home/ubuntu/git/platform-swirlds/sdk/testing -Dswirlds.diagnostic.graphs.enabled=true -jar graphing-cli-0.10.4-BETA.jar  1>> "${logDir}/graphing cli ${logFile}" 2>> "${logDir}/graphing cli ${errFile}")
(./consolidateNodeLogs.sh results/$testFolder swirlds.log)
(./consolidateNodeLogs.sh results/$testFolder output.log)
# sleep 10m
# (./startAwsInstancesAndRunTests.sh ./singleRegionTests/_nightlyTestRestart.sh $testFolder  1>> "${logDir}/restart ${logFile}" 2>> "${logDir}/restart ${errFile}")
echo zipping and cloning to google drive
