...
/**
 * Supports parameterized testing of {@link VirtualDataSourceJasperDB} with
...
public enum TestType {
    ...
    public static class DataTypeConfig<K extends VirtualKey, V extends VirtualValue> {
        ...
        private final SelfSerializableSupplier<? extends ExampleByteArrayVirtualValue> valueSerializer;
        ...
        public SelfSerializableSupplier<? extends ExampleByteArrayVirtualValue> getValueSerializer() {
        ...
        private SelfSerializableSupplier<? extends ExampleByteArrayVirtualValue> createValueSerializer() {
            switch (testType) {
                default:
                case fixed_fixed:
                case fixedComplex_fixed:
        ...
        public VirtualDataSourceJasperDB<VirtualLongKey, ExampleByteArrayVirtualValue> createDataSource(
                final Path dbPath,
                final String name,
                final int size,
            ...
            return new JasperDbBuilder<VirtualLongKey, ExampleByteArrayVirtualValue>()
                    .storageDir(dbPath)
                    .keySerializer((KeySerializer<VirtualLongKey>) keySerializer)
                    .maxNumOfKeys(size * 10L)
                    ...
                    .virtualLeafRecordSerializer(new VirtualLeafRecordSerializer<>(
                            ...
                            (SelfSerializableSupplier) keySerializer,
                            (short) getValueSerializer().getVersion(),
                            DataFileCommon.VARIABLE_DATA_SIZE,
                            valueSerializer,
                            false))
                    .build(name, enableMerging);
        }
