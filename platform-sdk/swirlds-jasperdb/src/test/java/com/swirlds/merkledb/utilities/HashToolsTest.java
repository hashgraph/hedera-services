...
class HashToolsTest {
    ...
    void constructsExpectedBuffer() {
        ...
        assertArrayEquals(hash.getBytes().toByteArray(), buffer.array(), "Hash digest should match created buffer");
    }
    ...
    void putsDigestAsExpected() {
        ...
        assertArrayEquals(hash.getBytes().toByteArray(), buffer.array(), "Hash digest should matched filled buffer");
    }
