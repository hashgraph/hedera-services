...
/**
 * Adapter that synchronizes a {@link com.swirlds.metrics.Counter}
...
public class CounterAdapter extends AbstractMetricAdapter {
     ...
     * @param metric
     * 		The {@link com.swirlds.metrics.Counter} which value should be reported to Prometheus
     * @param adapterType
     * 		Scope of the {@link com.swirlds.metrics.Counter},
