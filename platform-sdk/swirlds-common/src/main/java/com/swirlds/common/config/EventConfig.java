 ...
 * @param useLegacyPrehandle                if true then use the old strategy for prehandling transactions, if true then
 *                                          use the new wiring model strategy. If legacy intake is disabled then the
 *                                          setting is ignored and legacy prehandling is used.
...
public record EventConfig(
        ...
        @ConfigProperty(defaultValue = "false") boolean useLegacyPrehandle,
