 ...
 * @param eventPreprocessingThreadPoolSize  The size of the thread pool used to preprocess events
 * @param eventIntakeQueueSize              The size of the event intake queue and the preprocess queue. Use
...
public record EventConfig(
        ...
        @ConfigProperty(defaultValue = "8") int eventPreprocessingThreadPoolSize,
