 ...
 */
public class NoOpPlatformStatsBuffered implements StatsBuffered {

    private static final class InstanceHolder {
        private static final StatsBuffered INSTANCE = new NoOpPlatformStatsBuffered();
    }

    public NoOpPlatformStatsBuffered() {}
    ...
    public static StatsBuffered getInstance() {
