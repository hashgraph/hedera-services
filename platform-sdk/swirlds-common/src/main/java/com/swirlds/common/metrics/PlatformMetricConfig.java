...
public abstract class PlatformMetricConfig<T extends Metric, C extends MetricConfig<T, C>> extends MetricConfig<T, C> {
    protected PlatformMetricConfig(String category, String name, String description, String unit,
            String format) {
        super(category, name, description, unit, format);
    }

    protected PlatformMetricConfig(String category, String name, String defaultFormat) {
        super(category, name, defaultFormat);
    }

    public abstract T create(final PlatformMetricsFactory factory);

    @Override
    public final T create(MetricsFactory factory) {
