...
class WireTransformersTests {
    ...
    void wireFilterTest() {
        ...
        final Wire<Void> wireB = Wire.builder("B").build().cast();
        final InputChannel<Integer, Void> inB = wireB.buildInputChannel();
    ...
    void wireTransformerTest() {
        ...
        final Wire<TestData> wireA = Wire.builder("A").build().cast();
        final InputChannel<TestData, TestData> inA = wireA.buildInputChannel();

        final Wire<Void> wireB = Wire.builder("B").build().cast();
        final InputChannel<TestData, Void> inB = wireB.buildInputChannel();

        final Wire<Void> wireC = Wire.builder("C").build().cast();
        final InputChannel<Integer, Void> inC = wireC.buildInputChannel();

        final Wire<Void> wireD = Wire.builder("D").build().cast();
        final InputChannel<Boolean, Void> inD = wireD.buildInputChannel();
