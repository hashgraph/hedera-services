...
class MultiObjectCounterTests {
    ...
    void attemptOnRampTest() {
        ...
        final ObjectCounter counterA = new BackpressureObjectCounter(10, Duration.ofSeconds(1));
        final ObjectCounter counterB = new BackpressureObjectCounter(5, Duration.ofSeconds(1));
        final ObjectCounter counterC = new StandardObjectCounter(Duration.ofSeconds(1));
