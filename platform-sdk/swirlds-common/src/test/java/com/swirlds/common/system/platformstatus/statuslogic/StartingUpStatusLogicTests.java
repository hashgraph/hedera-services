...
class StartingUpStatusLogicTests {
    ...
    void setup() {
        ...
        logic = new StartingUpStatusLogic(time, configuration.getConfigData(PlatformStatusConfig.class));
    }
    ...
    void toReplayingEvents() {
        triggerActionAndAssertTransition(
                logic, PlatformStatusAction.STARTED_REPLAYING_EVENTS, PlatformStatus.REPLAYING_EVENTS);
    }
