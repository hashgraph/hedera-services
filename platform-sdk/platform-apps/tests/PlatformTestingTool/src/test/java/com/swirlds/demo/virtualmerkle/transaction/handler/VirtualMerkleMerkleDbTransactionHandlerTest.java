...
public class VirtualMerkleMerkleDbTransactionHandlerTest {
    ...
    public static void beforeAll() {
        ...
        final SmartContractMapKeySerializerMerkleDb keySerializer = new SmartContractMapKeySerializerMerkleDb();
        final SmartContractMapValueSerializerMerkleDb valueSerializer = new SmartContractMapValueSerializerMerkleDb();
        ...
        final SmartContractByteCodeMapKeySerializerMerkleDb keySerializer2 =
                new SmartContractByteCodeMapKeySerializerMerkleDb();
        final SmartContractByteCodeMapValueSerializerMerkleDb valueSerializer2 =
