...
public class BreakableDataSourceJPDB extends BreakableDataSource {

    public BreakableDataSourceJPDB(final BrokenBuilder builder, final VirtualDataSource<TestKey, TestValue> delegate) {
