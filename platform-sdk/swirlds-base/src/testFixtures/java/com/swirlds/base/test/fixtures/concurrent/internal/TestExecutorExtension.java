...
/**
 * The TestExecutorExtension is a JUnit 5 extension designed to facilitate the integration of
 * a {@link TestExecutor} into your test classes. It serves as both an {@link InvocationInterceptor} and a
 * {@link ParameterResolver}, enabling seamless injection of a {@code TestExecutor} instance and supporting its
 * use within your test methods.
 * <p>
 * When applied, this extension injects a {@code TestExecutor} instance into the test class, allowing
 * you to execute tests in a controlled manner, such as concurrently or with customized behaviors.
 *
 * @see TestExecutor
...
public class TestExecutorExtension implements InvocationInterceptor, ParameterResolver {
    ...
    /**
     * Intercept the execution of a test method and inject a TestExecutor instance into the
