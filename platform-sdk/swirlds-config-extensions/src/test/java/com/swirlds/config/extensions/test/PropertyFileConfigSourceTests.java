...
class PropertyFileConfigSourceTests {

    @Test
    void testConfig2HigherOrdinal() {
        // given
        final int ordinal1 = 100;
        final Path configFile1 = Path.of(PropertyFileConfigSourceTests.class
                .getClassLoader()
        ...
        final Path configFile2 = Path.of(PropertyFileConfigSourceTests.class
                .getClassLoader()
    ...
    void testConfigDefaultOrdinal() {
        ...
        final Path configFile3 = Path.of(PropertyFileConfigSourceTests.class
                .getClassLoader()
