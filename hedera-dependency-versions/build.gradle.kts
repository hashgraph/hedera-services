...
moduleInfo {
    ...
    version("software.amazon.awssdk.services.s3", "2.25.13")
    version("software.amazon.awssdk.http.urlconnection", "2.17.55")
    version("software.amazon.awssdk.http.apache", "2.25.13")
    version("software.amazon.awssdk.http.nio.netty", "2.25.13")
    version("software.amazon.awssdk.protocols.xml", "2.25.13")
    version("software.amazon.awssdk.protocols.core", "2.25.13")
    version("software.amazon.awssdk.arns", "2.25.13")
    version("software.amazon.awssdk.profiles", "2.25.13")
    version("software.amazon.awssdk.crtcore", "2.25.13")
    version("software.amazon.awssdk.http.auth", "2.25.13")
    version("software.amazon.awssdk.identity.spi", "2.25.13")
    version("software.amazon.awssdk.http.auth.spi", "2.25.13")
    version("software.amazon.awssdk.http.auth.aws", "2.25.13")
    version("software.amazon.awssdk.checksums", "2.25.13")
    version("software.amazon.awssdk.checksums.spi", "2.25.13")
    version("software.amazon.awssdk.core", "2.25.13")
    version("software.amazon.awssdk.auth", "2.25.13")
    version("software.amazon.awssdk.http", "2.25.13")
    version("software.amazon.awssdk.regions", "2.25.13")
    version("software.amazon.awssdk.annotations", "2.25.13")
    version("software.amazon.awssdk.utils", "2.25.13")
    version("software.amazon.awssdk.awscore", "2.25.13")
    version("software.amazon.awssdk.metrics", "2.25.13")
    version("software.amazon.awssdk.protocols.jsoncore", "2.25.13")
    version("software.amazon.awssdk.endpoints", "2.25.13")
    version("software.amazon.awssdk.protocols.query", "2.25.13")
    version("software.amazon.eventstream", "1.0.1")
    version("software.amazon.awssdk.thirdparty.jackson.core", "2.25.13")
    version("org.reactivestreams", "1.0.4")
    version("org.apache.httpcomponents.httpclient", "4.5.13")
    version("org.apache.commons.logging", "1.1.1")
    version("org.apache.httpcomponents.httpcore", "4.4.13")
}
